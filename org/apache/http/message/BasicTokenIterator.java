...
public class BasicTokenIterator implements TokenIterator {
    ...
    public int findTokenEnd(int i) {
        ...
        throw new IllegalArgumentException(wn6.h(i, "Token start position must not be negative: "));
    }
    ...
    public int findTokenSeparator(int i) {
        if (i >= 0) {
            ...
            while (!z && i < length) {
                ...
                if (isTokenSeparator(charAt)) {
                    ...
                    StringBuilder m = me4.m(i, "Tokens without separator (pos ", "): ");
                    m.append(this.currentHeader);
                    throw new ParseException(m.toString());
                } else {
                    StringBuilder m2 = me4.m(i, "Invalid character after token (pos ", "): ");
        ...
        throw new IllegalArgumentException(wn6.h(i, "Search position must not be negative: "));
    }
            ...
            while (!z) {
                ...
                while (!z && i < length) {
                    ...
                    if (isTokenSeparator(charAt) || isWhitespace(charAt)) {
                        ...
                        StringBuilder m = me4.m(i, "Invalid character before token (pos ", "): ");
                        m.append(this.currentHeader);
                        throw new ParseException(m.toString());
                    }
                }
