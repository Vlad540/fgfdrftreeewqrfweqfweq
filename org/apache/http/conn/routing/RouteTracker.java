...
public final class RouteTracker implements RouteInfo, Cloneable {
    ...
    public final HttpHost getHopTarget(int i) {
        if (i >= 0) {
            ...
            throw new IllegalArgumentException(rf0.g("Hop index ", i, " exceeds tracked route length ", hopCount, "."));
        }
        throw new IllegalArgumentException(wn6.h(i, "Hop index must not be negative: "));
    }
