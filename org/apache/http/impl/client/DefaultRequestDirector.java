...
public class DefaultRequestDirector implements RequestDirector {
    ...
    public HttpRoute determineRoute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws HttpException {
        ...
        StringBuilder j = c3d.j("Target host must not be null, or set in parameters. scheme=", str2, ", host=", str, ", path=");
        j.append(str3);
        ...
        do {
            ...
            switch (nextStep) {
                ...
                case 5:
                    ...
                    continue;
                default:
                    throw new IllegalStateException(rf0.f(nextStep, "Unknown step indicator ", " from RouteDirector."));
            }
        } while (nextStep > 0);
    }
    ...
    public RoutedRequest handleResponse(RoutedRequest routedRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        throw new RedirectException(wn6.j(new StringBuilder("Maximum redirects ("), this.maxRedirects, ") exceeded"));
    }
