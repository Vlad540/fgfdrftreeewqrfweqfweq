...
public class DigestScheme extends RFC2617Scheme {
        ...
        if (parameter == null) {
            ...
            if (this.qopVariant != 1) {
                ...
                if (parameter5.equalsIgnoreCase("MD5-sess")) {
                    ...
                    throw new AuthenticationException(wn6.i("Unhandled algorithm ", parameter5, " requested"));
                }
    ...
    private static MessageDigest createMessageDigest(String str) throws UnsupportedDigestAlgorithmException {
        try {
            ...
            throw new UnsupportedDigestAlgorithmException(rf0.h("Unsupported algorithm in HTTP Digest authentication: ", str));
        }
    }
