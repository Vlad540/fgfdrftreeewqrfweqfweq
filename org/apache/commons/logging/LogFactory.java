...
public abstract class LogFactory {
    ...
    private static final java.util.Properties getConfigurationFile(java.lang.ClassLoader r13, java.lang.String r14) {
        ...
        L_0x00d5:
            ...
            java.lang.String r13 = defpackage.wn6.i(r13, r14, r1)
            logDiagnostic(r13)
            goto L_0x0107
        L_0x00e9:
    ...
    public static org.apache.commons.logging.LogFactory getFactory() throws org.apache.commons.logging.LogConfigurationException {
        ...
        L_0x017f:
            ...
            java.lang.String r2 = "'"
            java.lang.String r1 = defpackage.wn6.i(r1, r0, r2)
            logDiagnostic(r1)
        L_0x0196:
    ...
    private static void initDiagnostics() {
        ...
        L_0x003e:
            ...
            java.lang.String r2 = "] "
            java.lang.String r0 = defpackage.wn6.i(r1, r0, r2)
            diagnosticPrefix = r0
        L_0x0048:
            return
        */
    ...
    private static void logClassLoaderEnvironment(Class cls) {
        if (isDiagnosticsEnabled()) {
            ...
            try {
                ...
                StringBuilder m = hr1.m("[ENV] Class ", name, " was loaded via classloader ");
                m.append(objectId(classLoader));
                logDiagnostic(m.toString());
                logHierarchy(wn6.i("[ENV] Ancestry of classloader which loaded ", name, " is "), classLoader);
    ...
    private static void logHierarchy(String str, ClassLoader classLoader) {
        if (isDiagnosticsEnabled()) {
            ...
            try {
                ...
                if (classLoader != null) {
                    StringBuffer stringBuffer = new StringBuffer(hr1.g(str, "ClassLoader tree:"));
                    do {
                ...
                logDiagnostic(hr1.g(str, "Security forbids determining the system classloader."));
            }
        }
    }
