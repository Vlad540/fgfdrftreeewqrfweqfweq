...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private void updateSurfaceSize() {
        ...
        StringBuilder i7 = rf0.i("updateSurfaceSize. Layout size: ", width2, "x", height, ", frame size: ");
        th2.l(i7, i3, "x", i4, ", requested surface size: ");
        th2.l(i7, min, "x", min2, ", old surface size: ");
        i7.append(i5);
        i7.append("x");
        i7.append(i6);
        logD(i7.toString());
    ...
    public void onMeasure(int i, int i2) {
        ...
        logD(me4.g("onMeasure(). New size: ", measure.x, measure.y, "x"));
    }
