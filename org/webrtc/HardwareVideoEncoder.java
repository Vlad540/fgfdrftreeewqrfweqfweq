...
public class HardwareVideoEncoder implements VideoEncoder {
    ...
    public void deliverEncodedImage() {
        ...
        L_0x0107:
            ...
            n30 r9 = new n30     // Catch:{ IllegalStateException -> 0x0026 }
            r3 = 10
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback2) {
        ...
        sb.append(" width: ");
        th2.l(sb, i3, " height: ", i4, " framerate_fps: ");
        th2.l(sb, i5, " bitrate_kbps: ", i6, " surface mode: ");
        sb.append(z);
    ...
    public boolean isSemiPlanar(int i) {
        ...
        throw new IllegalArgumentException(wn6.h(i, "Unsupported colorFormat: "));
    }
