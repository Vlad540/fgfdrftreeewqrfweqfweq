...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    public void switchCameraInternal(CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        ...
        if (!Arrays.asList(this.cameraEnumerator.getDeviceNames()).contains(str)) {
            reportCameraSwitchError(rf0.h("Attempted to switch to unknown camera device ", str), cameraSwitchHandler);
            return;
        }
    ...
    public void changeCaptureFormat(int i, int i2, int i3) {
        StringBuilder i4 = rf0.i("changeCaptureFormat: ", i, "x", i2, "@");
        i4.append(i3);
        Logging.d(TAG, i4.toString());
        synchronized (this.stateLock) {
            stopCapture();
    ...
    public void startCapture(int i, int i2, int i3) {
        StringBuilder i4 = rf0.i("startCapture: ", i, "x", i2, "@");
        i4.append(i3);
        Logging.d(TAG, i4.toString());
    ...
    public CameraCapturer(String str, CameraVideoCapturer.CameraEventsHandler cameraEventsHandler, CameraEnumerator cameraEnumerator2, CameraVideoCapturer.CaptureFormatHelper captureFormatHelper2) {
        ...
        if (asList.isEmpty()) {
            ...
            throw new IllegalArgumentException(wn6.i("Camera name ", this.cameraName, " does not match any known camera device."));
        }
    }
