...
class EglBase14Impl implements EglBase14 {
    ...
    public static class EglConnection implements EglBase14.EglConnection {
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            this.refCountDelegate = new RefCountDelegate(new oc4(8, this));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new lc(8));
        }
    }
    ...
    public static EGLContext createEglContext(EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i) {
        ...
        if (eGLContext == null || eGLContext != EGL14.EGL_NO_CONTEXT) {
            ...
            throw new GLException(EGL14.eglGetError(), rf0.h("Failed to create EGL context: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
        ...
        if ((obj instanceof Surface) || (obj instanceof SurfaceTexture)) {
            ...
            if (this.eglSurface == EGL14.EGL_NO_SURFACE) {
                ...
                if (eglCreateWindowSurface == EGL14.EGL_NO_SURFACE) {
                    throw new GLException(EGL14.eglGetError(), rf0.h("Failed to create window surface: 0x", Integer.toHexString(EGL14.eglGetError())));
                }
                return;
            }
    ...
    public static EGLConfig getEglConfig(EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!EGL14.eglChooseConfig(eGLDisplay, iArr, 0, eGLConfigArr, 0, 1, iArr2, 0)) {
            throw new GLException(EGL14.eglGetError(), rf0.h("eglChooseConfig failed: 0x", Integer.toHexString(EGL14.eglGetError())));
        } else if (iArr2[0] > 0) {
    ...
    public static EGLDisplay getEglDisplay() {
        ...
        if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
            ...
            throw new GLException(EGL14.eglGetError(), rf0.h("Unable to initialize EGL14: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
        throw new GLException(EGL14.eglGetError(), rf0.h("Unable to get EGL14 display: 0x", Integer.toHexString(EGL14.eglGetError())));
    }
    ...
    public void createPbufferSurface(int i, int i2) {
        ...
        if (this.eglSurface == EGL14.EGL_NO_SURFACE) {
            ...
            if (eglCreatePbufferSurface == EGL14.EGL_NO_SURFACE) {
                int eglGetError = EGL14.eglGetError();
                String hexString = Integer.toHexString(EGL14.eglGetError());
                StringBuilder i3 = rf0.i("Failed to create pixel buffer surface with size ", i, "x", i2, ": 0x");
                i3.append(hexString);
                throw new GLException(eglGetError, i3.toString());
            }
            return;
        }
        throw new RuntimeException("Already has an EGLSurface");
