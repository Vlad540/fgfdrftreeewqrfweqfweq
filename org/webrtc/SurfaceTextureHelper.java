...
public class SurfaceTextureHelper {
    ...
    public void returnTextureFrame() {
        this.handler.post(new z4e(this, 2));
    }
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, (Runnable) new z4e(this, 1));
    }

    public void forceFrame() {
        this.handler.post(new z4e(this, 3));
    }
    ...
    public void setFrameRotation(int i) {
        this.handler.post(new n30(i, 17, this));
    }

    public void setTextureSize(int i, int i2) {
        if (i <= 0) {
            throw new IllegalArgumentException(wn6.h(i, "Texture width must be positive, but was "));
        } else if (i2 > 0) {
            this.surfaceTexture.setDefaultBufferSize(i, i2);
            this.handler.post(new as0(this, i, i2, 6));
        } else {
            throw new IllegalArgumentException(wn6.h(i2, "Texture height must be positive, but was "));
        }
    }
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, (Runnable) new z4e(this, 0));
    }
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler2, boolean z, YuvConverter yuvConverter2, FrameRefMonitor frameRefMonitor2, FrameGeometryAdjuster frameGeometryAdjuster) {
        ...
        if (handler2.getLooper().getThread() == Thread.currentThread()) {
            ...
            try {
                ...
                surfaceTexture2.setOnFrameAvailableListener(new nlc(1, this), handler2);
