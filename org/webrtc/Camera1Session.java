...
class Camera1Session implements CameraSession {
    ...
    private void startCapturing() {
        ...
        this.camera.setErrorCallback(new Camera.ErrorCallback() {
            public void onError(int i, Camera camera) {
                String h = i == 100 ? "Camera server died!" : wn6.h(i, "Camera error: ");
                Logging.e(Camera1Session.TAG, h);
                Camera1Session.this.stopInternal(rf0.h("error: ", h));
                if (i == 2) {
    ...
    public void stopInternal(String str) {
        ...
        try {
            ...
            this.events.onCameraError(this, me4.j("Error on camera.release(", str, "): ", e.getMessage()));
        }
    }
