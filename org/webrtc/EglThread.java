...
public class EglThread implements RenderSynchronizer.Listener {
    ...
    public static EglThread create(ReleaseMonitor releaseMonitor2, EglBase.Context context, int[] iArr, RenderSynchronizer renderSynchronizer2) {
        ...
        EglBase.EglConnection eglConnection2 = (EglBase.EglConnection) ThreadUtils.invokeAtFrontUninterruptibly((Handler) handlerWithExceptionCallbacks, new rz3(context, 2, iArr));
        if (releaseMonitor2 == null) {
            releaseMonitor2 = new i74(10);
        }
    ...
    public void onRenderWindowClose() {
        this.handler.post(new us4(this, 1));
    }

    public void onRenderWindowOpen() {
        this.handler.post(new us4(this, 0));
    }
    ...
    public void release() {
        if (this.releaseMonitor.onRelease(this)) {
            ...
            handlerWithExceptionCallbacks.post(new oc4(10, eglConnection2));
