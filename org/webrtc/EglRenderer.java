...
public class EglRenderer implements VideoSink {
    ...
    private void swapBuffersOnRenderThread(VideoFrame videoFrame, long j) {
        synchronized (this.threadLock) {
            try {
                EglThread eglThread2 = this.eglThread;
                if (eglThread2 != null) {
                    eglThread2.scheduleRenderUpdate(new ts4(this, videoFrame, j));
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        synchronized (this.threadLock) {
            try {
                if (this.eglThread == null) {
                    ...
                    eglThread2.getHandler().postDelayed(this.logStatisticsRunnable, TimeUnit.SECONDS.toMillis(LOG_INTERVAL_SEC));
                } else {
    ...
    public void onFrame(org.webrtc.VideoFrame r7) {
        ...
        L_0x002c:
            ...
            oc4 r3 = new oc4     // Catch:{ all -> 0x002a }
            r5 = 9
    ...
    public void release() {
        ...
        L_0x001b:
            ...
            org.webrtc.EglThread r2 = r5.eglThread     // Catch:{ all -> 0x0019 }
            android.os.Handler r2 = r2.getHandler()     // Catch:{ all -> 0x0019 }
            ii4 r3 = new ii4     // Catch:{ all -> 0x0019 }
            r4 = 6
        ...
        synchronized (this.threadLock) {
            try {
                ...
                if (eglThread2 != null) {
                    ...
                    this.eglThread.getHandler().postAtFrontOfQueue(new ii4((Object) this, 5, (Object) runnable));
                    return;
                }
                runnable.run();
            } catch (Throwable th) {
            ...
            try {
                if (this.eglThread != null) {
                    if (Thread.currentThread() != this.eglThread.getHandler().getLooper().getThread()) {
                        postToRenderThread(new g5((Object) this, (Object) countDownLatch, (Object) frameListener, 26));
    ...
    public void clearImage(float f, float f2, float f3, float f4) {
        synchronized (this.threadLock) {
            try {
                EglThread eglThread2 = this.eglThread;
                if (eglThread2 != null) {
                    eglThread2.getHandler().postAtFrontOfQueue(new ss4(this, f, f2, f3, f4));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void addFrameListener(FrameListener frameListener, float f, RendererCommon.GlDrawer glDrawer, boolean z) {
        postToRenderThread(new rs4(this, glDrawer, frameListener, f, z));
    }
