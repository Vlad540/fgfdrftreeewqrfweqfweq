...
class EglBase10Impl implements EglBase10 {
    ...
    public static class EglConnection implements EglBase10.EglConnection {
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            this.refCountDelegate = new RefCountDelegate(new oc4(7, this));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new lc(7));
        }
    }
    ...
    public static EGLContext createEglContext(EGL10 egl10, EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i) {
        ...
        if (eGLContext == null || eGLContext != EGL10.EGL_NO_CONTEXT) {
            ...
            throw new GLException(egl10.eglGetError(), rf0.h("Failed to create EGL context: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        ...
        if ((obj instanceof SurfaceHolder) || (obj instanceof SurfaceTexture)) {
            ...
            if (eGLSurface == eGLSurface2) {
                ...
                if (eglCreateWindowSurface == eGLSurface2) {
                    throw new GLException(egl.eglGetError(), rf0.h("Failed to create window surface: 0x", Integer.toHexString(egl.eglGetError())));
                }
                return;
            }
    ...
    public static EGLConfig getEglConfig(EGL10 egl10, EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!egl10.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            throw new GLException(egl10.eglGetError(), rf0.h("eglChooseConfig failed: 0x", Integer.toHexString(egl10.eglGetError())));
        } else if (iArr2[0] > 0) {
    ...
    public static EGLDisplay getEglDisplay(EGL10 egl10) {
        ...
        if (eglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            throw new GLException(egl10.eglGetError(), rf0.h("Unable to get EGL10 display: 0x", Integer.toHexString(egl10.eglGetError())));
        } else if (egl10.eglInitialize(eglGetDisplay, new int[2])) {
            return eglGetDisplay;
        } else {
            throw new GLException(egl10.eglGetError(), rf0.h("Unable to initialize EGL10: 0x", Integer.toHexString(egl10.eglGetError())));
        }
    }
