...
class WebRtcSilenceProvider {
    ...
    public static class Statistics {
        ...
        public void trackRead(long j, long j2, long j3) {
            ...
            if (j5 > j6) {
                ...
                StringBuilder k = hr1.k(j6, "Log interval: ", "ns, log delta: ");
                k.append(j5);
                k.append("ns, reads: ");
                k.append(i2);
                hr1.s(k, ", read time: ", millis, "ms, suspend time: ");
                k.append(j7);
                k.append("ms");
    ...
    public WebRtcSilenceProvider(int i, int i2, int i3, int i4, int i5, byte[] bArr) {
        ...
        StringBuilder i6 = rf0.i("Silence provider initialized, sampleRate=", i2, ", framesPerBuffer=", i4, ", bufferDuration=");
        i6.append(millis);
        i6.append("ms, bufferCapacity=");
        i6.append(length);
        Logging.d(TAG, i6.toString());
    }
