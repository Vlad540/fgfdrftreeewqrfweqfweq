...
enum LZ4UnsafeUtils {
    ...
    public static int commonBytes(byte[] bArr, int i, int i2, int i3) {
        ...
        int i5 = 0;
        while (i2 <= i3 - 8) {
            if (cve.d(i2, bArr) == cve.d(i, bArr)) {
                i5 += 8;
                i += 8;
                i2 += 8;
            } else {
                if (pze.a == ByteOrder.BIG_ENDIAN) {
                    i4 = Long.numberOfLeadingZeros(cve.d(i, bArr) ^ cve.d(i2, bArr));
                } else {
                    i4 = Long.numberOfTrailingZeros(cve.d(i, bArr) ^ cve.d(i2, bArr));
                }
                return i5 + (i4 >>> 3);
            }
        }
    ...
    public static void safeArraycopy(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            cve.g(bArr2, i2 + i4 + i6, cve.a(i + i4 + i6, bArr));
        }
    }
    ...
    public static void wildIncrementalCopy(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i4 < 4) {
            ...
            for (int i6 = 0; i6 < 4; i6++) {
                cve.g(bArr, i2 + i6, cve.a(i + i6, bArr));
            }
            int i7 = i2 + 4;
            int i8 = i + 4;
            int i9 = i7 - i8;
            ...
            cve.i(i7, bArr, cve.b(i8, bArr));
            i2 += 8;
            i = i8 - i5;
        } else if (i4 < 8) {
            cve.j(i2, bArr, cve.d(i, bArr));
            i2 += i4;
        }
        while (i2 < i3) {
            cve.j(i2, bArr, cve.d(i, bArr));
    ...
    public static int writeLen(int i, byte[] bArr, int i2) {
        while (i >= 255) {
            cve.g(bArr, i2, (byte) 255);
            i -= 255;
            i2++;
        }
        int i3 = i2 + 1;
        cve.g(bArr, i2, (byte) i);
        return i3;
    }
