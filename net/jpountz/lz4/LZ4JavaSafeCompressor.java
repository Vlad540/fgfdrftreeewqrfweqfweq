...
final class LZ4JavaSafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00b4, code lost:
        r9 = r8 - 2;
        r2[net.jpountz.lz4.LZ4Utils.hash64k(defpackage.njc.c(r9, r0))] = (short) (r9 - r1);
        r9 = net.jpountz.lz4.LZ4Utils.hash64k(defpackage.njc.c(r8, r0));
        r15 = r1 + (r2[r9] & 65535);
        r2[r9] = (short) (r8 - r1);
     */
    ...
    public static int compress64k(byte[] r18, int r19, int r20, byte[] r21, int r22, int r23) {
        ...
        L_0x0022:
            ...
            goto L_0x0100
        L_0x002d:
            int r14 = defpackage.njc.c(r8, r0)
        ...
        L_0x00b4:
            int r9 = r8 + -2
            int r11 = defpackage.njc.c(r9, r0)
            int r11 = net.jpountz.lz4.LZ4Utils.hash64k(r11)
            int r9 = r9 - r1
            short r9 = (short) r9
            r2[r11] = r9
            int r9 = defpackage.njc.c(r8, r0)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x00dc, code lost:
        r10 = r1 - 2;
        r9[net.jpountz.lz4.LZ4Utils.hash(defpackage.njc.c(r10, r0))] = r10;
        r10 = net.jpountz.lz4.LZ4Utils.hash(defpackage.njc.c(r1, r0));
        r12 = r9[r10];
        r9[r10] = r1;
        r10 = r1 - r12;
     */
    ...
    public int compress(byte[] r19, int r20, int r21, byte[] r22, int r23, int r24) {
        ...
        L_0x0046:
            ...
            goto L_0x00d1
        L_0x0049:
            int r15 = defpackage.njc.c(r8, r0)
        ...
        L_0x00dc:
            int r10 = r1 + -2
            int r12 = defpackage.njc.c(r10, r0)
            int r12 = net.jpountz.lz4.LZ4Utils.hash(r12)
            r9[r12] = r10
            int r10 = defpackage.njc.c(r1, r0)
