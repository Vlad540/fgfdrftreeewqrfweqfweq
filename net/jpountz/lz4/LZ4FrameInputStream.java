...
public class LZ4FrameInputStream extends FilterInputStream {
    ...
    private void readBlock() throws IOException {
        ...
        if (i != 0) {
            ...
            throw new IOException(me4.g("Block size ", i, this.maxBlockSize, " exceeded max: "));
    ...
    public LZ4FrameInputStream(InputStream inputStream, LZ4SafeDecompressor lZ4SafeDecompressor, fvf fvf) throws IOException {
        this(inputStream, lZ4SafeDecompressor, fvf, false);
    }

    public LZ4FrameInputStream(InputStream inputStream, LZ4SafeDecompressor lZ4SafeDecompressor, fvf fvf, boolean z) throws IOException {
        super(inputStream);
