...
final class LZ4JavaUnsafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0060, code lost:
        defpackage.cve.g(r3, r10, (byte) 240);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x006d, code lost:
        defpackage.cve.g(r3, r10, (byte) (r11 << 4));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0077, code lost:
        r9 = (short) (r8 - r15);
        defpackage.cve.g(r3, r12, (byte) r9);
        defpackage.cve.g(r3, r12 + 1, (byte) (r9 >>> 8));
        r9 = r12 + 2;
        r8 = r8 + 4;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x009c, code lost:
        defpackage.cve.g(r3, r10, (byte) (defpackage.cve.a(r10, r3) | 15));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x00ad, code lost:
        defpackage.cve.g(r3, r10, (byte) (r11 | defpackage.cve.a(r10, r3)));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00bb, code lost:
        r9 = r8 - 2;
        defpackage.cve.l(r2, net.jpountz.lz4.LZ4Utils.hash64k(defpackage.cve.b(r9, r0)), r9 - r1);
        r9 = net.jpountz.lz4.LZ4Utils.hash64k(defpackage.cve.b(r8, r0));
        r15 = defpackage.cve.e(r2, r9) + r1;
        defpackage.cve.l(r2, r9, r8 - r1);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00eb, code lost:
        defpackage.cve.g(r3, r10, (byte) 0);
        r12 = r10 + 1;
     */
    ...
    public static int compress64k(byte[] r17, int r18, int r19, byte[] r20, int r21, int r22) {
        ...
        L_0x0022:
            ...
            goto L_0x0108
        L_0x002d:
            int r14 = defpackage.cve.b(r8, r0)
            int r14 = net.jpountz.lz4.LZ4Utils.hash64k(r14)
            int r15 = defpackage.cve.e(r2, r14)
            int r15 = r15 + r1
            r19 = r11
            int r11 = r8 - r1
            defpackage.cve.l(r2, r14, r11)
        ...
        L_0x0077:
            ...
            short r9 = (short) r9
            byte r11 = (byte) r9
            defpackage.cve.g(r3, r12, r11)
            int r11 = r12 + 1
            int r9 = r9 >>> 8
            byte r9 = (byte) r9
            defpackage.cve.g(r3, r11, r9)
            int r9 = r12 + 2
            int r8 = r8 + 4
            int r15 = r15 + 4
            ...
            byte r13 = defpackage.cve.a(r10, r3)
            r13 = r13 | r12
            byte r13 = (byte) r13
            defpackage.cve.g(r3, r10, r13)
            int r11 = r11 + -15
        ...
        L_0x00bb:
            int r9 = r8 + -2
            int r11 = defpackage.cve.b(r9, r0)
            int r11 = net.jpountz.lz4.LZ4Utils.hash64k(r11)
            int r9 = r9 - r1
            defpackage.cve.l(r2, r11, r9)
            int r9 = defpackage.cve.b(r8, r0)
            int r9 = net.jpountz.lz4.LZ4Utils.hash64k(r9)
            int r11 = defpackage.cve.e(r2, r9)
            int r15 = r11 + r1
            int r11 = r8 - r1
            defpackage.cve.l(r2, r9, r11)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0089, code lost:
        defpackage.cve.g(r3, r13, (byte) 240);
        r16 = r10;
        r5 = net.jpountz.lz4.LZ4UnsafeUtils.writeLen(r15 - 15, r3, r5);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x009a, code lost:
        r16 = r10;
        defpackage.cve.g(r3, r13, (byte) (r15 << 4));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x00aa, code lost:
        defpackage.cve.g(r3, r5, (byte) r14);
        defpackage.cve.g(r3, r5 + 1, (byte) (r14 >>> 8));
        r12 = r5 + 2;
        r10 = r10 + 4;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00cd, code lost:
        defpackage.cve.g(r3, r13, (byte) (defpackage.cve.a(r13, r3) | 15));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x00dd, code lost:
        defpackage.cve.g(r3, r13, (byte) (r1 | defpackage.cve.a(r13, r3)));
        r13 = r12;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x00f8, code lost:
        r1 = r10 - 2;
        defpackage.cve.h(net.jpountz.lz4.LZ4Utils.hash(defpackage.cve.b(r1, r0)), r1, r11);
        r1 = net.jpountz.lz4.LZ4Utils.hash(defpackage.cve.b(r10, r0));
        r12 = defpackage.cve.c(r1, r11);
        defpackage.cve.h(r1, r10, r11);
        r14 = r10 - r12;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0123, code lost:
        defpackage.cve.g(r3, r13, (byte) 0);
        r1 = r12;
        r5 = r13 + 1;
     */
    ...
    public int compress(byte[] r20, int r21, int r22, byte[] r23, int r24, int r25) {
        /*
            ...
            r4 = r25
            r7 = 1
            sun.misc.Unsafe r8 = defpackage.cve.a
            defpackage.njc.b(r1, r0, r2)
            defpackage.njc.b(r6, r3, r4)
            int r8 = r6 + r4
        ...
        L_0x004b:
            ...
            goto L_0x00ec
        L_0x004e:
            int r17 = defpackage.cve.b(r10, r0)
            int r5 = net.jpountz.lz4.LZ4Utils.hash(r17)
            int r7 = defpackage.cve.c(r5, r11)
            r22 = r14
            int r14 = r10 - r7
            defpackage.cve.h(r5, r10, r11)
        ...
        L_0x00aa:
            byte r12 = (byte) r14
            defpackage.cve.g(r3, r5, r12)
            r12 = 1
            int r15 = r5 + 1
            int r12 = r14 >>> 8
            byte r12 = (byte) r12
            defpackage.cve.g(r3, r15, r12)
            int r12 = r5 + 2
            int r10 = r10 + 4
            int r1 = r1 + 4
            ...
            byte r14 = defpackage.cve.a(r13, r3)
            r14 = r14 | r5
            byte r14 = (byte) r14
            defpackage.cve.g(r3, r13, r14)
            int r1 = r1 - r5
        ...
        L_0x00f8:
            int r1 = r10 + -2
            int r12 = defpackage.cve.b(r1, r0)
            int r12 = net.jpountz.lz4.LZ4Utils.hash(r12)
            defpackage.cve.h(r12, r1, r11)
            int r1 = defpackage.cve.b(r10, r0)
            int r1 = net.jpountz.lz4.LZ4Utils.hash(r1)
            int r12 = defpackage.cve.c(r1, r11)
            defpackage.cve.h(r1, r10, r11)
            int r14 = r10 - r12
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0077, code lost:
        defpackage.nu0.e(r3, r12, (short) (r8 - r15));
        r9 = r12 + 2;
        r8 = r8 + 4;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00b2, code lost:
        r9 = r8 - 2;
        defpackage.cve.l(r2, net.jpountz.lz4.LZ4Utils.hash64k(r0.getInt(r9)), r9 - r1);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0111, code lost:
        r9 = r1 - 2;
        defpackage.cve.h(net.jpountz.lz4.LZ4Utils.hash(r5.getInt(r9)), r9, r7);
        r9 = net.jpountz.lz4.LZ4Utils.hash(r5.getInt(r1));
        r12 = defpackage.cve.c(r9, r7);
        defpackage.cve.h(r9, r1, r7);
        r9 = r1 - r12;
     */
    ...
    public int compress(java.nio.ByteBuffer r19, int r20, int r21, java.nio.ByteBuffer r22, int r23, int r24) {
        /*
            ...
            return r0
        L_0x0037:
            java.nio.ByteBuffer r5 = defpackage.nu0.c(r19)
            java.nio.ByteBuffer r8 = defpackage.nu0.c(r22)
            defpackage.nu0.b(r5, r1, r3)
            defpackage.nu0.b(r8, r4, r6)
            int r10 = r4 + r6
        ...
        L_0x007c:
            ...
            r18 = r12
            int r12 = defpackage.cve.c(r15, r7)
            r19 = r13
            int r13 = r6 - r12
            defpackage.cve.h(r15, r6, r7)
        ...
        L_0x0111:
            ...
            int r12 = net.jpountz.lz4.LZ4Utils.hash(r12)
            defpackage.cve.h(r12, r9, r7)
            int r9 = r5.getInt(r1)
            int r9 = net.jpountz.lz4.LZ4Utils.hash(r9)
            int r12 = defpackage.cve.c(r9, r7)
            defpackage.cve.h(r9, r1, r7)
            int r9 = r1 - r12
