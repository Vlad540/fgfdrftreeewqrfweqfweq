...
final class LZ4HCJavaUnsafeCompressor extends LZ4Compressor {
    ...
    public int compress(byte[] r22, int r23, int r24, byte[] r25, int r26, int r27) {
        /*
            ...
            r9 = r26
            r2 = r27
            sun.misc.Unsafe r3 = defpackage.cve.a
            defpackage.njc.b(r0, r8, r1)
            r10 = r25
            defpackage.njc.b(r9, r10, r2)
            int r11 = r0 + r1
            int r12 = r9 + r2
            int r13 = r11 + -12
            int r14 = r11 + -5
    ...
    public class HashTable {
        ...
        private int hashPointer(byte[] bArr, int i) {
            return hashPointer(cve.b(i, bArr));
        }
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, LZ4Utils.Match match) {
            ...
            if (i3 != 0) {
                ...
                do {
                    this.chainTable[i & MASK] = (short) i4;
                    this.hashTable[LZ4Utils.hashHC(cve.b(i, bArr))] = i;
                    i++;
                } while (i < i6);
    ...
    public int compress(java.nio.ByteBuffer r23, int r24, int r25, java.nio.ByteBuffer r26, int r27, int r28) {
        /*
            ...
            return r0
        L_0x0036:
            java.nio.ByteBuffer r10 = defpackage.nu0.c(r23)
            java.nio.ByteBuffer r11 = defpackage.nu0.c(r26)
            defpackage.nu0.b(r10, r0, r3)
            defpackage.nu0.b(r11, r1, r6)
            int r12 = r0 + r3
            int r13 = r1 + r6
            int r14 = r12 + -12
            int r15 = r12 + -5
