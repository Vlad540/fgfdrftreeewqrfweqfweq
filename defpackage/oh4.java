...
public class oh4 extends ild {
    public final File a;
    public final int b;
    public final List c = Arrays.asList(new String[0]);

    public oh4(File file, int i) {
        this.a = file;
        this.b = i;
    }
    ...
    /* JADX WARNING: type inference failed for: r8v7, types: [at4, bt4, java.lang.Object] */
