...
public final class egc extends Drawable {
    public float a;
    ...
    public egc(ColorStateList colorStateList, float f2) {
        this.a = f2;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil((double) fgc.a(this.e, this.a, this.g)), (int) Math.ceil((double) fgc.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
    ...
    public final boolean isStateful() {
        ...
        L_0x001d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.egc.isStateful():boolean");
    }
