...
public final class ulc extends AtomicReferenceArray implements Runnable, Callable, xi4 {
    ...
    public ulc(Runnable runnable, yi4 yi4) {
        super(3);
        this.a = runnable;
        lazySet(0, yi4);
    }
    ...
    public final void f() {
        ...
        L_0x0049:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ulc.f():void");
    }
    ...
    public final String toString() {
        ...
        return ulc.class.getSimpleName() + "[" + str + "]";
    }
}
