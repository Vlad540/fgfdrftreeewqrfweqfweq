    ...
    public final boolean a(int i) {
        ...
        switch (this.a) {
            case 0:
                ...
                this.h = i13;
                if (i3 == 3) {
                    int i14 = i2 == 3 ? iu7.f[i4 - 1] : iu7.g[i4 - 1];
                    this.g = i14;
                    this.d = (((i14 * 12) / this.e) + i12) * 4;
                } else {
                    int i15 = 144;
                    if (i2 == 3) {
                        int i16 = i3 == 2 ? iu7.h[i4 - 1] : iu7.i[i4 - 1];
                        this.g = i16;
            ...
            default:
                ...
                this.h = i21;
                if (i7 == 3) {
                    int i22 = i6 == 3 ? ek8.o[i8 - 1] : ek8.X[i8 - 1];
                    this.g = i22;
                    this.d = (((i22 * 12) / this.e) + i20) * 4;
                } else {
                    int i23 = 144;
                    if (i6 == 3) {
                        int i24 = i7 == 2 ? ek8.Y[i8 - 1] : ek8.Z[i8 - 1];
                        this.g = i24;
