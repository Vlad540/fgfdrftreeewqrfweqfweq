...
public final class dy {
    ...
    public dy(File file, lk9 lk9) {
        this.b = lk9 == null ? cy.f : lk9;
        this.c = file;
    ...
    public final void a(FileOutputStream fileOutputStream) {
        ...
        cy cyVar = this.b;
        if (!z) {
            cyVar.d(str + ": Failed to sync file output stream", (Throwable) null);
        }
        try {
            fileOutputStream.close();
        } catch (IOException e2) {
            cyVar.d(str + ": Failed to close file output stream", e2);
        }
        File file = this.d;
        if (!file.delete()) {
            cyVar.d(str + ": Failed to delete new file " + file, (Throwable) null);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x000c, code lost:
        r3.b.d(defpackage.wn6.l(new java.lang.StringBuilder(), r3.a, ": Failed to close file output stream"), r4);
     */
    ...
    public final void b(java.io.FileOutputStream r4) {
        ...
        L_0x000b:
            ...
            java.lang.String r0 = defpackage.wn6.l(r0, r1, r2)
            cy r1 = r3.b
            r1.d(r0, r4)
        L_0x001e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dy.b(java.io.FileOutputStream):void");
    }
    ...
    public final FileInputStream c() {
        ...
        if (exists2 && file2.exists() && !file3.delete()) {
            cyVar.d(str + ": Failed to delete outdated new file " + file3, (Throwable) null);
        }
        try {
            if (file2.canRead()) {
            ...
            cyVar.d(str + ": Fail to create FileInputStream for file " + file2, th);
        }
        return null;
    }
    ...
    public final void e(File file, File file2) {
        ...
        if (isDirectory && !file2.delete()) {
            cyVar.d(str + ": Failed to delete file which is a directory " + file2, (Throwable) null);
        }
        if (!file.renameTo(file2)) {
            cyVar.d(str + ": Failed to rename " + file + " to " + file2, (Throwable) null);
        }
    }
    ...
    public final java.io.FileOutputStream f() {
        ...
        L_0x0065:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dy.f():java.io.FileOutputStream");
    }
}
