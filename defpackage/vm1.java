...
public final class vm1 {
    ...
    public vm1(String str, ke keVar) {
        this.a = str;
        this.b = keVar;
        this.e = "CallOpenGL_stat_".concat(str);
    }

    public final void a(xwb xwb) {
        ...
        if (j2 > 0) {
            ...
            if (!booleanValue || atomicInteger2.get() != 0) {
                ...
                xwb.log(this.e, this.a + " -> Duration: " + millis + " ms. received: " + i2 + ", dropped: " + i3 + ", rendered: " + i4 + ", fps: " + format + ",avg render time: " + str + ", avg swapBuffer time: " + str2 + ".");
                this.g = j;
                this.f = 0;
                this.h = 0;
                this.i = 0;
