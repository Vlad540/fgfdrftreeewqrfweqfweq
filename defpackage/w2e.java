...
public final class w2e extends dx3 implements View.OnClickListener {
    ...
    public w2e(Context context, tsc tsc, SearchableInfo searchableInfo, WeakHashMap weakHashMap) {
        int suggestionRowLayout = tsc.getSuggestionRowLayout();
        this.b = true;
        this.c = null;
        this.a = false;
        this.o = -1;
        this.X = new bx3((dx3) this);
        this.Y = new cx3(0, this);
        this.x0 = suggestionRowLayout;
        this.w0 = suggestionRowLayout;
        this.y0 = (LayoutInflater) context.getSystemService("layout_inflater");
        this.z0 = tsc;
        this.A0 = searchableInfo;
        this.D0 = tsc.getSuggestionCommitIconResId();
        this.B0 = context;
        this.C0 = weakHashMap;
    }
    ...
    public final void a(android.view.View r22, android.database.Cursor r23) {
        ...
        L_0x0062:
            ...
            android.content.res.ColorStateList r14 = r1.F0
            r16 = 0
            r19 = 0
            r17 = 0
            r18 = 0
        ...
        L_0x0191:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.w2e.a(android.view.View, android.database.Cursor):void");
    }
    ...
    public final View d(ViewGroup viewGroup) {
        View inflate = this.y0.inflate(this.w0, viewGroup, false);
        inflate.setTag(new t2e(inflate));
        ((ImageView) inflate.findViewById(pob.edit_query)).setImageResource(this.D0);
        return inflate;
    }
    ...
    public final android.graphics.drawable.Drawable f(java.lang.String r9) {
        /*
            r8 = this;
            java.util.WeakHashMap r0 = r8.C0
        ...
        L_0x0043:
            ...
            return r5
        L_0x0046:
            android.graphics.drawable.Drawable r4 = defpackage.gq3.b(r1, r4)     // Catch:{ NumberFormatException -> 0x0055, NotFoundException -> 0x0054 }
        ...
        L_0x00d4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.w2e.f(java.lang.String):android.graphics.drawable.Drawable");
    }
    ...
    public final Cursor g(SearchableInfo searchableInfo, String str) {
        ...
        return this.B0.getContentResolver().query(fragment.build(), (String[]) null, suggestSelection, strArr2, (String) null);
    }
    ...
    public final View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.y0.inflate(this.x0, viewGroup, false);
            if (inflate != null) {
                ((t2e) inflate.getTag()).a.setText(e.toString());
            }
            return inflate;
        }
    }
    ...
    public final View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View d = d(viewGroup);
            ((t2e) d.getTag()).a.setText(e.toString());
            return d;
        }
    }
    ...
    public final void onClick(View view) {
        ...
        if (tag instanceof CharSequence) {
            this.z0.onQueryRefine((CharSequence) tag);
        }
    }
}
