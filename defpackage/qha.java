...
public final class qha extends ii0 {
    public final Uri c;
    public final Context d;

    public qha(Context context, Uri uri) {
        this.c = uri;
        this.d = context;
    }

    public final ov0 b() {
        return new ngd(String.valueOf(this.c.hashCode()));
    }
    ...
    public final void c(android.graphics.Bitmap r17) {
        /*
            ...
            int r7 = at7.z0     // Catch:{ IOException -> 0x0082 }
            v25 r7 = new v25     // Catch:{ IOException -> 0x0082 }
            r7.<init>(r6)     // Catch:{ IOException -> 0x0082 }
            ...
            android.graphics.Point r7 = at7.q(r7, r6)     // Catch:{ IOException -> 0x0082 }
            r5.close()     // Catch:{ IOException -> 0x0082 }
            ...
            int r7 = at7.v(r7, r9, r9)     // Catch:{ IOException -> 0x0082 }
            ...
            r5.close()     // Catch:{ IOException -> 0x0082 }
            int r2 = at7.w(r6)     // Catch:{ IOException -> 0x0082 }
        ...
        L_0x0088:
            ...
            udd.R(r6, r4, r1, r0)     // Catch:{ all -> 0x00ac }
        L_0x00aa:
            r0 = r4
            goto L_0x0059
        L_0x00ac:
        ...
        L_0x00b8:
            ...
            udd.S(r6, r1, r0)     // Catch:{ all -> 0x007f }
            goto L_0x00aa
        L_0x00be:
        ...
        L_0x00e3:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qha.c(android.graphics.Bitmap):void");
    }
}
