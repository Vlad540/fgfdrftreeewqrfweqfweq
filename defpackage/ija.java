...
public final class ija {
    ...
    public static final gt6 f = gt6.i(5, f22.a, f22.c, f22.f, f22.d, f22.e);
    public byte[] a;
    public int b;
    public int c;
        ...
        if (i2 != 0) {
            while (i < i2) {
                ...
                if ((b2 & 192) == 128) {
                    ...
                    throw new NumberFormatException(us8.i(j, "Invalid UTF-8 sequence continuation byte: "));
                }
            }
            this.b += i2;
            return j;
        }
        throw new NumberFormatException(us8.i(j, "Invalid UTF-8 sequence first byte: "));
    }
    ...
    public final char c(Charset charset) {
        ...
        oyb.c("Unsupported charset: " + charset, contains);
    ...
    public final int d(Charset charset) {
        ...
        byte b4;
        boolean z = false;
        if ((charset.equals(f22.c) || charset.equals(f22.a)) && a() >= 1) {
            long j = (long) (this.a[this.b] & 255);
            char c2 = (char) ((int) j);
            a06.j(j, "Out of range: %s", ((long) c2) == j);
            b2 = (byte) c2;
            i = 1;
        } else {
            i = 2;
            if ((charset.equals(f22.f) || charset.equals(f22.d)) && a() >= 2) {
                byte[] bArr = this.a;
                int i2 = this.b;
                b3 = bArr[i2];
                b4 = bArr[i2 + 1];
            } else if (!charset.equals(f22.e) || a() < 2) {
                return 0;
            } else {
                byte[] bArr2 = this.a;
                int i3 = this.b;
    ...
    public final String h(Charset charset) {
        ...
        if (charset.equals(f22.c) || charset.equals(charset2)) {
            i = 1;
        } else if (charset.equals(f22.f) || charset.equals(f22.e) || charset.equals(f22.d)) {
            i = 2;
        } else {
        ...
        while (true) {
            ...
            if (i2 >= i3 - (i - 1)) {
                i2 = i3;
                break;
            } else if ((charset.equals(f22.c) || charset.equals(f22.a)) && oze.N(this.a[i2])) {
                break;
            } else {
                if (charset.equals(f22.f) || charset.equals(f22.d)) {
                    byte[] bArr = this.a;
                    if (bArr[i2] == 0 && oze.N(bArr[i2 + 1])) {
                        break;
                    }
                }
                if (charset.equals(f22.e)) {
                    byte[] bArr2 = this.a;
                    if (bArr2[i2 + 1] == 0 && oze.N(bArr2[i2])) {
                        break;
                    }
                }
                i2 += i;
    ...
    public final int m() {
        ...
        throw new IllegalStateException(wn6.h(i, "Top bit not zero: "));
    }
    ...
    public final String p() {
        ...
        int i2 = this.b;
        int i3 = oze.a;
        String str = new String(bArr, i2, i - i2, f22.c);
        this.b = i;
        if (i < this.c) {
            this.b = i + 1;
        }
    ...
    public final String q(int i) {
        ...
        byte[] bArr = this.a;
        int i5 = oze.a;
        String str = new String(bArr, i2, i4, f22.c);
        this.b += i;
        return str;
    }
    ...
    public final int y() {
        ...
        throw new IllegalStateException(wn6.h(g, "Top bit not zero: "));
    }
    ...
    public final long z() {
        ...
        throw new IllegalStateException(us8.i(o, "Top bit not zero: "));
    }
    ...
    public ija(byte[] bArr) {
        this.a = bArr;
        this.c = bArr.length;
    }

    public ija(int i, byte[] bArr) {
        this.a = bArr;
        this.c = i;
    }
}
