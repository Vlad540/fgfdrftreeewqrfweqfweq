...
public final class px1 {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            while (size >= 0) {
                nx1 nx1 = (nx1) arrayList.get(size);
                int i = nx1.c;
                if (i == length) {
                    nx1.c = i - 1;
                    size--;
    ...
    public final uw3 c(int i) {
        ...
        return new uw3(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, (Layout.Alignment) null, (Bitmap) null, (float) i6, 1, Integer.MIN_VALUE, f2, i5, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
    }
    ...
    public final SpannableString d() {
        ...
        while (true) {
            ...
            int i8 = nx1.c;
            i5++;
            if (i8 != (i5 < arrayList.size() ? ((nx1) arrayList.get(i5)).c : length)) {
                if (i != -1 && !z2) {
