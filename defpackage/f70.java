...
public final class f70 extends f3 {
    public final void b() {
        LinkedHashMap m = m();
        super.b();
        o(m);
    ...
    public final LinkedHashMap m() {
        ...
        if (f != null) {
            ...
            try {
                ...
                udd.s(this.e, "getStringMap: failed", e);
            }
        }
    ...
    public final void n(Account account, String str, boolean z) {
        ...
        if (z) {
            ...
            if (f == null || f.length() == 0 || str.length() == 0) {
                udd.s(this.e, "cacheExternalToken: rejected", (Throwable) null);
                return;
            }
            LinkedHashMap m = m();
            m.put(f, str);
    ...
    public final void o(LinkedHashMap linkedHashMap) {
        ...
        try {
            ...
            udd.s(this.e, "putStringMap: failed", e);
        }
    }
}
