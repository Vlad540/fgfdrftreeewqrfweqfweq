...
public final class xb8 {
    ...
    public xb8(wb8 wb8, String str, String str2) {
        this.a = wb8;
        this.b = str;
        this.c = str2;
    }
    ...
    public static mb8 a() {
        yb8.b();
        nb8 nb8 = yb8.c().s;
        if (nb8 instanceof mb8) {
            return (mb8) nb8;
        }
        return null;
    }

    public final x3a b(xb8 xb8) {
        if (xb8 != null) {
            yr yrVar = this.v;
            if (yrVar == null) {
                return null;
            ...
            String str = xb8.c;
            if (yrVar.containsKey(str)) {
                return new x3a(19, (Object) (lb8) this.v.get(str));
            }
            return null;
        }
    ...
    public final boolean h(qb8 qb8) {
        if (qb8 != null) {
            yb8.b();
    ...
    public final int i(defpackage.ta8 r15) {
        /*
            r14 = this;
            ta8 r0 = r14.t
            r1 = 0
        ...
        L_0x0250:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xb8.i(ta8):int");
    }
    ...
    public final void j(int i2) {
        ...
        if (this != c2.r || (nb82 = c2.s) == null) {
            HashMap hashMap = c2.v;
            if (!hashMap.isEmpty() && (nb8 = (nb8) hashMap.get(this.c)) != null) {
                nb8.f(min);
                return;
            }
            return;
    ...
    /* JADX WARNING: type inference failed for: r0v9, types: [kgd, yr] */
