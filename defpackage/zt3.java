...
public final class zt3 implements List, RandomAccess, Cloneable, Serializable {
    public final transient ReentrantLock a = new ReentrantLock();
    public volatile transient Object[] b = new Object[0];

    public static void a(zt3 zt3, int i, int i2) {
