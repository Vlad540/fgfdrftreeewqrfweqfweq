...
public final class je0 extends uue {
    public final File e;
    public final String f = "^lib/([^/]+)/([^/]+\\.so)$";
    public final int g = 1;

    public je0(Context context, File file, String str) {
        super(context, str);
        this.e = file;
    }
    ...
    public final byte[] e() {
        ...
        L_0x008d:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.je0.e():byte[]");
    }
