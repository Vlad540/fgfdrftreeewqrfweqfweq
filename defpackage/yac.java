...
public final class yac implements Parcelable {
    public static final Parcelable.Creator<yac> CREATOR = new x3b(13);
    public final int a;
    ...
    public final int a(android.content.Context r10) {
        ...
        L_0x00ca:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.yac.a(android.content.Context):int");
    }
