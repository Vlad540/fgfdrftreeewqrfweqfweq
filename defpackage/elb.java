...
public abstract class elb implements t26 {
    public static alb a(Context context, Bundle bundle) {
        ...
        Arrays.toString(b);
        Arrays.toString(b2);
        return new alb(z, new HashSet(c(b)), new HashSet(c(b2)));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x0015, code lost:
        if (defpackage.zkb.class.isAssignableFrom(r3) != false) goto L_0x0019;
     */
    ...
    public static java.util.HashSet c(java.lang.String[] r5) {
        ...
        L_0x0007:
            ...
            java.lang.Class<zkb> r4 = defpackage.zkb.class
        ...
        L_0x0021:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.elb.c(java.lang.String[]):java.util.HashSet");
    }
}
