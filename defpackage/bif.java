...
public final class bif extends l5e implements i26 {
    public int X;
    public /* synthetic */ Object Y;
    public final /* synthetic */ nff Z;
    public final /* synthetic */ gif w0;
    public final /* synthetic */ phf x0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public bif(nff nff, phf phf, gif gif, Continuation continuation) {
    ...
    public final Continuation n(Object obj, Continuation continuation) {
        gif gif = this.w0;
        bif bif = new bif(this.Z, this.x0, gif, continuation);
        bif.Y = obj;
        return bif;
    }
