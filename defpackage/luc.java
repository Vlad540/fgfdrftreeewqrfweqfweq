...
public abstract class luc extends vuc {
    public final long d;
    public final long e;
    public final List f;
    public final long g;
    ...
    public luc(mxb mxb, long j, long j2, long j3, long j4, List list, long j5, long j6, long j7) {
        super(mxb, j, j2);
        this.d = j3;
        this.e = j4;
        this.f = list;
    ...
    public final long f(long j, long j2) {
        ...
        List list = this.f;
        if (list != null) {
            return (((ruc) list.get((int) (j - j4))).b * 1000000) / j3;
        }
        long e2 = e(j2);
    ...
    public final long h(long j) {
        long j2 = this.d;
        List list = this.f;
        return mze.J(list != null ? ((ruc) list.get((int) (j - j2))).a - this.b : (j - j2) * this.e, 1000000, this.a);
    }

    public abstract mxb i(long j, jac jac);
