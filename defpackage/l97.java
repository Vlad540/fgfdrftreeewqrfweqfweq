...
public final class l97 implements xs4 {
    ...
    public l97(String str) {
        this.a = str;
        yze yze = new yze((int) LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
        this.b = yze;
        byte[] bArr = yze.a;
        this.c = new wx1(bArr, bArr.length, 1, (byte) 0);
    }
    ...
    public final void g(defpackage.yze r24) {
        /*
            r23 = this;
            r0 = r23
            ape r1 = r0.d
        ...
        L_0x0258:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l97.g(yze):void");
    }
