...
public final class old {
    ...
    public old(int i2, int i3, float f2, float f3, int i4, int i5) {
        this.a = i5;
        switch (i5) {
            case 1:
                this.b = i2;
    ...
    public final void g() {
        ...
        L_0x048d:
            ...
            goto L_0x028e
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.old.g():void");
    }
}
