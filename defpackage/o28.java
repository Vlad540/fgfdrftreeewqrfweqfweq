...
public final class o28 {
    ...
    public o28(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
        str.getClass();
        this.a = str;
        this.b = str2;
        this.c = str3;
    ...
    public static boolean a(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d2) {
        ...
        Point point = new Point(mze.g(i, widthAlignment) * widthAlignment, mze.g(i2, heightAlignment) * heightAlignment);
        int i3 = point.x;
        int i4 = point.y;
    ...
    public static defpackage.o28 g(java.lang.String r8, java.lang.String r9, java.lang.String r10, android.media.MediaCodecInfo.CodecCapabilities r11, boolean r12, boolean r13, boolean r14, boolean r15) {
        /*
            o28 r13 = new o28
            r14 = 0
            r0 = 1
        ...
        L_0x0060:
            ...
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.o28.g(java.lang.String, java.lang.String, java.lang.String, android.media.MediaCodecInfo$CodecCapabilities, boolean, boolean, boolean, boolean):o28");
    }

    public final p24 b(vu5 vu5, vu5 vu52) {
        int i = !mze.a(vu5.A0, vu52.A0) ? 8 : 0;
        if (this.h) {
            if (vu5.I0 != vu52.I0) {
                i |= LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY;
            }
            if (!this.e && !(vu5.F0 == vu52.F0 && vu5.G0 == vu52.G0)) {
                i |= 512;
            }
            if (!mze.a(vu5.M0, vu52.M0)) {
                i |= 2048;
            }
            if (mze.d.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(this.a) && !vu5.c(vu52)) {
                i |= 2;
            }
            if (i == 0) {
                return new p24(this.a, vu5, vu52, vu5.c(vu52) ? 3 : 2, 0);
            }
        } else {
            if (vu5.N0 != vu52.N0) {
                i |= 4096;
            ...
            if (i == 0 && "audio/mp4a-latm".equals(str)) {
                ...
                if (!(d2 == null || d3 == null)) {
                    ...
                    if (intValue == 42 && intValue2 == 42) {
                        return new p24(this.a, vu5, vu52, 3, 0);
                    }
                }
            }
            if (!vu5.c(vu52)) {
            ...
            if (i == 0) {
                return new p24(this.a, vu5, vu52, 1, 0);
            }
        }
        return new p24(this.a, vu5, vu52, 0, i);
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean c(defpackage.vu5 r15) {
        /*
            r14 = this;
            java.lang.String r0 = r15.A0
            java.lang.String r1 = r14.b
            boolean r0 = r1.equals(r0)
            r2 = 0
            if (r0 != 0) goto L_0x0017
            java.lang.String r0 = defpackage.f38.b(r15)
            boolean r0 = r1.equals(r0)
        ...
        L_0x0017:
            ...
            r4 = 16
            boolean r5 = r14.h
            java.lang.String r6 = r15.x0
            if (r6 != 0) goto L_0x0024
            goto L_0x00fe
        L_0x0024:
            android.util.Pair r7 = defpackage.f38.d(r15)
        ...
        L_0x0242:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.o28.c(vu5):boolean");
    }

    public final boolean d(vu5 vu5) {
        if (this.h) {
            return this.e;
        }
        Pair d2 = f38.d(vu5);
    ...
    public final boolean e(int i, int i2, double d2) {
        ...
        if (videoCapabilities == null) {
            ...
            if (i < i2) {
                String str = this.a;
                if ((!"OMX.MTK.VIDEO.DECODER.HEVC".equals(str) || !"mcv5a".equals(mze.b)) && a(videoCapabilities, i2, i, d2)) {
                    ...
                    new StringBuilder(me4.e(me4.e(me4.e(me4.e(25, sb2), str), this.b), mze.e));
                    return true;
                }
            }
    ...
    public final void f(String str) {
        new StringBuilder(me4.e(me4.e(me4.e(me4.e(20, str), this.a), this.b), mze.e));
    }
