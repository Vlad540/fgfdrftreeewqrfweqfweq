...
public final class b93 implements X509TrustManager {
    public final X509TrustManager[] a;
    public final ArrayList b;

    public b93(X509TrustManager[] x509TrustManagerArr) {
    ...
    public final X509Certificate[] getAcceptedIssuers() {
        ...
        for (X509TrustManager acceptedIssuers : this.a) {
            u23.K(cs.g0(acceptedIssuers.getAcceptedIssuers()), arrayList);
        }
