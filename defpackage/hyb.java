...
public final class hyb extends eh0 {
    public final Resources X;
    public final String Y;
    public Uri Z;
    public AssetFileDescriptor w0;
    public FileInputStream x0;
    public long y0;
    public boolean z0;
    ...
    public final long N(defpackage.xz3 r20) {
        ...
        L_0x00e9:
            ...
            r0.y0 = r9     // Catch:{ RawResourceDataSource$RawResourceDataSourceException -> 0x00e6, IOException -> 0x00e3 }
            goto L_0x012b
        L_0x010d:
            long r4 = r2.size()     // Catch:{ RawResourceDataSource$RawResourceDataSourceException -> 0x00e6, IOException -> 0x00e3 }
            long r15 = r2.position()     // Catch:{ RawResourceDataSource$RawResourceDataSourceException -> 0x00e6, IOException -> 0x00e3 }
            long r4 = r4 - r15
            r0.y0 = r4     // Catch:{ RawResourceDataSource$RawResourceDataSourceException -> 0x00e6, IOException -> 0x00e3 }
        ...
        L_0x0123:
            long r5 = r17 - r4
            r0.y0 = r5     // Catch:{ RawResourceDataSource$RawResourceDataSourceException -> 0x00e6, IOException -> 0x00e3 }
        ...
        L_0x018a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hyb.N(xz3):long");
    }

    public final void close() {
        this.Z = null;
        try {
            FileInputStream fileInputStream = this.x0;
            if (fileInputStream != null) {
                fileInputStream.close();
            }
            this.x0 = null;
            try {
                AssetFileDescriptor assetFileDescriptor = this.w0;
            ...
            this.x0 = null;
            try {
                AssetFileDescriptor assetFileDescriptor2 = this.w0;
