...
public final class r3 implements d75 {
    public final t3 a = new t3((String) null, 0);
    public final yze b = new yze(2786);
    public boolean c;
    ...
    public final int i(f75 f75, le4 le4) {
        yze yze = this.b;
        int read = ((q74) f75).read(yze.a, 0, 2786);
        if (read == -1) {
            return -1;
        }
        yze.H(0);
