...
public final class ggd extends rg0 {
    ...
    public final void h() {
        if (isActive()) {
            ...
            int i2 = h50.b * 2;
            this.n = i2;
            int i3 = ((((int) ((this.l * ((long) h50.a)) / 1000000)) / 2) / i2) * i2 * 2;
            if (this.s.length != i3) {
                this.s = new byte[i3];
                this.v = new byte[i3];
            }
    ...
    public final void m(boolean z) {
        ...
        if (i4 == bArr.length || z) {
            ...
            oyb.j("bytesConsumed is not aligned to frame size: %s" + i2, i2 % this.n == 0);
            if (i4 >= i3) {
                z2 = true;
            }
            oyb.k(z2);
    ...
    public final void n(int i2, int i3) {
        if (i2 != 0) {
            ...
            oyb.c("sizeToOutput is not aligned to frame size: " + i2, i2 % this.n == 0);
            oyb.k(this.t < this.s.length);
            byte[] bArr3 = this.v;
            if (i2 % this.n != 0) {
                z = false;
            }
            oyb.c("byteOutput size is not aligned to frame size " + i2, z);
            if (i3 != 3) {
