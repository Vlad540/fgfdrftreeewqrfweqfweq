...
public final class gnd {
    ...
    /* JADX WARNING: type inference failed for: r0v5, types: [java.lang.Object, wq4] */
    public gnd() {
    ...
    public final wq4 c(double d2, double d3, long j2) {
        double d4;
        double d5;
        if (!this.c) {
        ...
        wq4 wq4 = this.j;
        wq4.a = (float) (d4 + this.i);
        wq4.b = (float) d5;
        return wq4;
    }

    /* JADX WARNING: type inference failed for: r0v4, types: [java.lang.Object, wq4] */
    public gnd(float f2) {
        this.a = Math.sqrt(1500.0d);
        this.b = 0.5d;
        this.c = false;
