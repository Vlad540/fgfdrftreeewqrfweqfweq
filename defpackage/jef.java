...
public final class jef {
    ...
    public jef(Context context) {
        ...
        a24.l("wake:com.google.firebase.iid.WakeLockHolder", "WakeLock: wakeLockName must not be empty");
        ...
        if (powerManager != null) {
            ...
            synchronized (wtf.class) {
                ...
                if (bool != null) {
                    ...
                    z = d8.d(context, "android.permission.UPDATE_DEVICE_STATS") == 0;
                    wtf.e = Boolean.valueOf(z);
                }
            }
            if (z) {
                int i2 = g0e.a;
                ...
                if (!(context.getPackageManager() == null || packageName == null)) {
                    try {
                        ApplicationInfo applicationInfo = ((Context) suf.a(context).b).getPackageManager().getApplicationInfo(packageName, 0);
                        if (applicationInfo == null) {
                            "Could not get applicationInfo from package: ".concat(packageName);
                        } else {
                            int i3 = applicationInfo.uid;
                            workSource = new WorkSource();
                            wtf.a(workSource, i3, packageName);
                        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v7, resolved type: v1g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v14, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v18, resolved type: v1g} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v19, resolved type: v1g} */
    ...
    public final void a(long r9) {
        ...
        L_0x004b:
            ...
            v1g r10 = (defpackage.v1g) r10     // Catch:{ all -> 0x003b }
            if (r10 != 0) goto L_0x005f
            v1g r10 = new v1g     // Catch:{ all -> 0x003b }
        ...
        L_0x0086:
            ...
            lde r2 = new lde     // Catch:{ all -> 0x003b }
            r3 = 16
        ...
        L_0x0099:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.jef.a(long):void");
    }
        ...
        synchronized (this.a) {
            try {
                ...
                if (this.k.containsKey((Object) null)) {
                    v1g v1g = (v1g) this.k.get((Object) null);
                    if (v1g != null) {
                        int i2 = v1g.a - 1;
                        v1g.a = i2;
                        if (i2 == 0) {
    ...
    public final void e() {
        ...
        L_0x002d:
            ...
            v1g r3 = (defpackage.v1g) r3     // Catch:{ all -> 0x000b }
        ...
        L_0x0099:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.jef.e():void");
    }
}
