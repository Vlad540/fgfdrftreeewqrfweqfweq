...
public abstract class hfb {
    public static final lbc a = new Object();
    public static final Object b = new Object();
    public static jk9 c = null;

    public static long a(Context context) {
        PackageManager packageManager = context.getApplicationContext().getPackageManager();
        return Build.VERSION.SDK_INT >= 33 ? ffb.a(packageManager, context).lastUpdateTime : packageManager.getPackageInfo(context.getPackageName(), 0).lastUpdateTime;
    }

    /* JADX WARNING: type inference failed for: r0v0, types: [jk9, java.lang.Object] */
    public static jk9 b() {
        ? obj = new Object();
        c = obj;
        a.i(obj);
    ...
    public static void c(android.content.Context r18, boolean r19) {
        ...
        L_0x006a:
            ...
            gfb r8 = defpackage.gfb.a(r6)     // Catch:{ IOException -> 0x0084 }
            goto L_0x008a
        L_0x0084:
            b()     // Catch:{ all -> 0x0012 }
            monitor-exit(r1)     // Catch:{ all -> 0x0012 }
        ...
        L_0x00b9:
            r13 = r4
        L_0x00ba:
            gfb r0 = new gfb     // Catch:{ all -> 0x0012 }
            r12 = 1
            r11 = r0
        ...
        L_0x00d6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hfb.c(android.content.Context, boolean):void");
    }
}
