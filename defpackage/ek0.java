...
public final class ek0 extends cf3 {
    public final an Y = new an(3, this);
    public final /* synthetic */ int Z;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ek0(Context context, duf duf, int i) {
        super(context, duf);
        this.Z = i;
    }
    ...
    public final java.lang.Object i() {
        ...
        L_0x0047:
            ...
            a24 r4 = defpackage.a24.B()
            java.lang.String r0 = defpackage.gk0.a
        ...
        L_0x008e:
            ...
            a24 r4 = defpackage.a24.B()
            java.lang.String r0 = defpackage.fk0.a
            java.lang.String r1 = "getInitialState - null intent received"
            r4.x(r0, r1)
            java.lang.Boolean r4 = java.lang.Boolean.FALSE
            goto L_0x00c3
        ...
        L_0x00c3:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ek0.i():java.lang.Object");
    }

    public final void r() {
        a24.B().t(tq0.a, getClass().getSimpleName().concat(": registering receiver"));
        ((Context) this.b).registerReceiver(this.Y, u());
    }

    public final void s() {
        a24.B().t(tq0.a, getClass().getSimpleName().concat(": unregistering receiver"));
    ...
    public final void v(Intent intent) {
        switch (this.Z) {
            case 0:
                ...
                if (action != null) {
                    a24.B().t(fk0.a, "Received ".concat(action));
            ...
            case 1:
                if (intent.getAction() != null) {
                    a24 B = a24.B();
                    String str = gk0.a;
                    B.t(str, "Received " + intent.getAction());
            ...
            default:
                if (intent.getAction() != null) {
                    a24 B2 = a24.B();
                    String str2 = czd.a;
                    B2.t(str2, "Received " + intent.getAction());
