...
public final class xtd {
    ...
    public xtd(defpackage.vtd r4) {
        ...
        L_0x0044:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xtd.<init>(vtd):void");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        xtd xtd = (xtd) obj;
        if (this.a != xtd.a || this.d != xtd.d || this.e != xtd.e || this.f != xtd.f || this.i != xtd.i) {
            return false;
        }
        String str = xtd.b;
        String str2 = this.b;
        ...
        if (!this.g.equals(xtd.g)) {
            return false;
        }
        return this.h.equals(xtd.h);
    }
    ...
    public final int hashCode() {
        ...
        long j4 = this.e;
        long j5 = this.f;
        return ((this.h.hashCode() + me4.d((((((((hashCode + i3) * 31) + ((int) (j3 ^ (j3 >>> 32)))) * 31) + ((int) (j4 ^ (j4 >>> 32)))) * 31) + ((int) (j5 ^ (j5 >>> 32)))) * 31, 31, this.g)) * 31) + (this.i ? 1 : 0);
    }
