...
public final class uw3 {
    ...
    static {
        new uw3(BuildConfig.FLAVOR, (Layout.Alignment) null, (Layout.Alignment) null, (Bitmap) null, -3.4028235E38f, Integer.MIN_VALUE, Integer.MIN_VALUE, -3.4028235E38f, Integer.MIN_VALUE, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
        int i2 = oze.a;
    }

    public uw3(CharSequence charSequence, Layout.Alignment alignment, Layout.Alignment alignment2, Bitmap bitmap, float f2, int i2, int i3, float f3, int i4, int i5, float f4, float f5, float f6, boolean z2, int i6, int i7, float f7) {
    ...
    public static defpackage.uw3 a(android.os.Bundle r29) {
        /*
            r0 = r29
        ...
        L_0x001c:
            ...
            java.lang.String r6 = defpackage.mx3.a
            int r6 = r5.getInt(r6)
            java.lang.String r7 = defpackage.mx3.b
            int r7 = r5.getInt(r7)
            java.lang.String r8 = defpackage.mx3.c
            int r8 = r5.getInt(r8)
            java.lang.String r9 = defpackage.mx3.d
            r10 = -1
            int r9 = r5.getInt(r9, r10)
            java.lang.String r10 = defpackage.mx3.e
        ...
        L_0x0059:
            r5.getClass()
            mfe r9 = new mfe
            java.lang.String r10 = defpackage.mfe.d
            int r10 = r5.getInt(r10)
            java.lang.String r11 = defpackage.mfe.e
            int r11 = r5.getInt(r11)
            java.lang.String r12 = defpackage.mfe.f
        ...
        L_0x0077:
            r5.getClass()
            gic r9 = new gic
            java.lang.String r10 = defpackage.gic.c
            java.lang.String r10 = r5.getString(r10)
            r10.getClass()
            java.lang.String r11 = defpackage.gic.d
        ...
        L_0x01a9:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.uw3.a(android.os.Bundle):uw3");
    }
    ...
    public final Bundle b() {
        ...
        if (charSequence != null) {
            ...
            if (charSequence instanceof Spanned) {
                ...
                for (gic gic : (gic[]) spanned.getSpans(0, spanned.length(), gic.class)) {
                    gic.getClass();
                    Bundle bundle2 = new Bundle();
                    bundle2.putString(gic.c, gic.a);
                    bundle2.putInt(gic.d, gic.b);
                    arrayList.add(mx3.a(spanned, gic, 1, bundle2));
                }
                for (mfe mfe : (mfe[]) spanned.getSpans(0, spanned.length(), mfe.class)) {
                    mfe.getClass();
                    Bundle bundle3 = new Bundle();
                    bundle3.putInt(mfe.d, mfe.a);
                    bundle3.putInt(mfe.e, mfe.b);
                    bundle3.putInt(mfe.f, mfe.c);
                    arrayList.add(mx3.a(spanned, mfe, 2, bundle3));
                }
                for (zj6 a2 : (zj6[]) spanned.getSpans(0, spanned.length(), zj6.class)) {
                    arrayList.add(mx3.a(spanned, a2, 3, (Bundle) null));
                }
    ...
    public final boolean equals(Object obj) {
        ...
        uw3 uw3 = (uw3) obj;
        if (TextUtils.equals(this.a, uw3.a) && this.b == uw3.b && this.c == uw3.c) {
            Bitmap bitmap = uw3.d;
            Bitmap bitmap2 = this.d;
            if (bitmap2 != null ? !(bitmap == null || !bitmap2.sameAs(bitmap)) : bitmap == null) {
                if (this.e == uw3.e && this.f == uw3.f && this.g == uw3.g && this.h == uw3.h && this.i == uw3.i && this.j == uw3.j && this.k == uw3.k && this.l == uw3.l && this.m == uw3.m && this.n == uw3.n && this.o == uw3.o && this.p == uw3.p && this.q == uw3.q) {
                    return true;
                }
            }
        }
