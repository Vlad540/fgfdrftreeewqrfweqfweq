...
public abstract class rqf {
    ...
    public static void a(java.lang.String r18, defpackage.mqf r19, java.util.List r20, android.text.SpannableStringBuilder r21, java.util.List r22) {
        /*
            r0 = r18
            r1 = r19
            r2 = r21
        ...
        L_0x0242:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rqf.a(java.lang.String, mqf, java.util.List, android.text.SpannableStringBuilder, java.util.List):void");
    }

    public static ArrayList b(List list, String str, mqf mqf) {
        int i;
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < list.size(); i2++) {
            gqf gqf = (gqf) list.get(i2);
            String str2 = mqf.a;
            if (!gqf.a.isEmpty() || !gqf.b.isEmpty() || !gqf.c.isEmpty() || !gqf.d.isEmpty()) {
                int a2 = gqf.a(gqf.d, gqf.a(gqf.b, gqf.a(gqf.a, 0, 1073741824, str), 2, str2), 4, mqf.c);
                if (a2 != -1) {
                    if (mqf.d.containsAll(gqf.c)) {
                        i = a2 + (gqf.c.size() * 4);
                    }
                }
                i = 0;
    ...
    public static int c(List list, String str, mqf mqf) {
        ArrayList b2 = b(list, str, mqf);
        for (int i = 0; i < b2.size(); i++) {
            int i2 = ((oqf) b2.get(i)).b.p;
            if (i2 != -1) {
                return i2;
            }
        }
    ...
    public static iqf d(String str, Matcher matcher, yze yze, ArrayList arrayList) {
        qqf qqf = new qqf();
        try {
            ...
            return new iqf(qqf.a().a(), qqf.a, qqf.b);
    ...
    public static void e(java.lang.String r18, defpackage.qqf r19) {
        ...
        L_0x0116:
            float r5 = defpackage.wqf.b(r14)     // Catch:{ NumberFormatException -> 0x016d }
        ...
        L_0x0182:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rqf.e(java.lang.String, qqf):void");
    }
    ...
    public static android.text.SpannedString f(java.lang.String r16, java.lang.String r17, java.util.List r18) {
        ...
        L_0x0217:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rqf.f(java.lang.String, java.lang.String, java.util.List):android.text.SpannedString");
    }
