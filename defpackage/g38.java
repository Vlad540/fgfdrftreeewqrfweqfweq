...
public abstract class g38 {
    ...
    public static void a(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (oze.a < 26 && oze.b.equals("R9") && arrayList.size() == 1 && ((p28) arrayList.get(0)).a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                arrayList.add(p28.h("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false));
            }
            Collections.sort(arrayList, new i63(4, new j67(20)));
        }
        int i = oze.a;
        if (i < 21 && arrayList.size() > 1) {
            String str2 = ((p28) arrayList.get(0)).a;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                Collections.sort(arrayList, new i63(4, new j67(22)));
            }
        }
        if (i < 32 && arrayList.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((p28) arrayList.get(0)).a)) {
            arrayList.add((p28) arrayList.remove(0));
        }
    }

    public static String b(xu5 xu5) {
        Pair d;
        if ("audio/eac3-joc".equals(xu5.n)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(xu5.n) || (d = d(xu5)) == null) {
            return null;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:343:0x0557, code lost:
        switch(r17) {
            ...
            case one.me.common.drawable.SavedMessagesIconDrawable.SMALL_ICON_SIZE :int: goto L_0x057c;
    ...
    public static android.util.Pair d(defpackage.xu5 r32) {
        /*
            r0 = r32
        ...
        L_0x0351:
            ...
            java.lang.String r0 = defpackage.c49.d(r0)     // Catch:{ NumberFormatException -> 0x03ac }
        ...
        L_0x06d5:
            ...
            defpackage.ez3.j0(r0)     // Catch:{ NumberFormatException -> 0x06e5 }
            goto L_0x06e8
        L_0x06e5:
            c3d.o(r1, r14)
        L_0x06e8:
        ...
        L_0x07a0:
            return r18
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g38.d(xu5):android.util.Pair");
    }

    public static synchronized List e(String str, boolean z, boolean z2) {
        synchronized (g38.class) {
            try {
                z28 z28 = new z28(str, z, z2);
                HashMap hashMap = b;
                List list = (List) hashMap.get(z28);
                if (list != null) {
                    return list;
                }
                int i = oze.a;
                ArrayList f = f(z28, i >= 21 ? new c38(1, z, z2) : new gf6(13));
                if (z && f.isEmpty() && 21 <= i && i <= 23) {
                    f = f(z28, new gf6(13));
                    if (!f.isEmpty()) {
                        ez3.j0("MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((p28) f.get(0)).a);
                    }
                }
                a(str, f);
                ws6 j = ws6.j(f);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList f(defpackage.z28 r23, defpackage.b38 r24) {
        /*
            r1 = r23
            r2 = r24
            ...
            int r15 = r24.d()     // Catch:{ Exception -> 0x014e }
            boolean r13 = r24.e()     // Catch:{ Exception -> 0x014e }
            r16 = 0
            r12 = r16
        L_0x001b:
            if (r12 >= r15) goto L_0x0174
            android.media.MediaCodecInfo r0 = r2.a(r12)     // Catch:{ Exception -> 0x014e }
            int r6 = defpackage.oze.a     // Catch:{ Exception -> 0x014e }
            r7 = 29
        ...
        L_0x0045:
            ...
            boolean r8 = r2.b(r4, r10, r9)     // Catch:{ Exception -> 0x0117 }
            boolean r17 = r2.c(r4, r9)     // Catch:{ Exception -> 0x0117 }
        ...
        L_0x0057:
            ...
            goto L_0x002d
        L_0x005c:
            boolean r7 = r2.b(r3, r10, r9)     // Catch:{ Exception -> 0x0117 }
            boolean r8 = r2.c(r3, r9)     // Catch:{ Exception -> 0x0117 }
            boolean r2 = r1.b
        ...
        L_0x0093:
            ...
            java.lang.String r0 = defpackage.fja.A(r0)     // Catch:{ Exception -> 0x0117 }
        ...
        L_0x00c1:
            ...
            r22 = r13
            r13 = r2
            p28 r0 = defpackage.p28.h(r6, r7, r8, r9, r10, r11, r12, r13)     // Catch:{ Exception -> 0x00dc }
        ...
        L_0x00e0:
            ...
            r1 = r13
            r13 = r2
            p28 r0 = defpackage.p28.h(r6, r7, r8, r9, r10, r11, r12, r13)     // Catch:{ Exception -> 0x0112 }
        ...
        L_0x0117:
            ...
            r22 = r13
        L_0x011f:
            int r2 = defpackage.oze.a     // Catch:{ Exception -> 0x014e }
            r6 = 23
            ...
            defpackage.ez3.A(r0)     // Catch:{ Exception -> 0x014e }
        L_0x0144:
            int r12 = r18 + 1
            r1 = r23
            r2 = r24
        ...
        L_0x0150:
            ...
            defpackage.ez3.A(r1)     // Catch:{ Exception -> 0x014e }
        ...
        L_0x0175:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g38.f(z28, b38):java.util.ArrayList");
    }

    public static e8c g(pv0 pv0, xu5 xu5, boolean z, boolean z2) {
        Iterable iterable;
        String str = xu5.n;
        pv0.getClass();
        List e = e(str, z, z2);
    ...
    public static ArrayList h(xu5 xu5, List list) {
        ArrayList arrayList = new ArrayList(list);
        Collections.sort(arrayList, new i63(4, new hy5(18, xu5)));
        return arrayList;
    }
    ...
    public static boolean i(MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (i < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(oze.c))) {
            String str3 = oze.b;
            if (str3.startsWith("zeroflte") || str3.startsWith("zerolte") || str3.startsWith("zenlte") || "SC-05G".equals(str3) || "marinelteatt".equals(str3) || "404SC".equals(str3) || "SC-04G".equals(str3) || "SCV31".equals(str3)) {
                return false;
            }
        }
        if (i == 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(oze.c)) {
            String str4 = oze.b;
            if (str4.startsWith("d2") || str4.startsWith("serrano") || str4.startsWith("jflte") || str4.startsWith("santos") || str4.startsWith("t0")) {
                return false;
            }
        }
        if (i != 19 || !oze.b.startsWith("jflte") || !"OMX.qcom.video.decoder.vp8".equals(str)) {
    ...
    public static boolean j(MediaCodecInfo mediaCodecInfo, String str) {
        ...
        String A = fja.A(mediaCodecInfo.getName());
        if (A.startsWith("arc.")) {
            return false;
        }
        ...
        if ((!A.startsWith("omx.sec.") || !A.contains(".sw.")) && !A.equals("omx.qcom.video.decoder.hevcswvdec") && !A.startsWith("c2.android.") && !A.startsWith("c2.google.")) {
            return !A.startsWith("omx.") && !A.startsWith("c2.");
        }
        return true;
    }
    ...
    public static int k() {
        ...
        if (c == -1) {
            ...
            if (p28 != null) {
                ...
                i2 = Math.max(i3, oze.a >= 21 ? 345600 : 172800);
            }
            c = i2;
        }
        return c;
