...
public final class md3 {
    ...
    public md3(String str, int i2, Bundle bundle) {
        this(1004001300, 6, str, i2, new Bundle(bundle));
    }

    public static md3 a(Bundle bundle) {
        int i2 = bundle.getInt(f, 0);
        int i3 = bundle.getInt(j, 0);
        String string = bundle.getString(g);
        string.getClass();
        String str = h;
        oyb.d(bundle.containsKey(str));
        int i4 = bundle.getInt(str);
        Bundle bundle2 = bundle.getBundle(i);
        if (bundle2 == null) {
            bundle2 = Bundle.EMPTY;
        }
        return new md3(i2, i3, string, i4, bundle2);
    }
    ...
    public md3(int i2, int i3, String str, int i4, Bundle bundle) {
        this.a = i2;
        this.b = i3;
        this.c = str;
        this.d = i4;
