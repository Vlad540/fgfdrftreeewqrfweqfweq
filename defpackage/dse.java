...
public final class dse extends rg0 {
    public int i;
    public int j;
    public boolean k;
    public int l;
    ...
    public final void b(ByteBuffer byteBuffer) {
        ...
        if (i2 != 0) {
            ...
            if (this.l <= 0) {
                ...
                int j2 = oze.j(length, 0, this.n);
                k2.put(this.m, 0, j2);
                int j3 = oze.j(length - j2, 0, i3);
    ...
    public final long f(long j2) {
        return j2 - oze.Y(this.b.a, (long) (this.j + this.i));
    }

    public final h50 g(h50 h50) {
        if (h50.c == 2) {
            this.k = true;
            return (this.i == 0 && this.j == 0) ? h50.e : h50;
        }
