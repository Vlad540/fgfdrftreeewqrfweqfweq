...
public final class ox1 {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            while (size >= 0) {
                mx1 mx1 = (mx1) arrayList.get(size);
                int i = mx1.c;
                if (i == length) {
                    mx1.c = i - 1;
                    size--;
    ...
    public final tw3 c(int i) {
        ...
        return new tw3(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, (Layout.Alignment) null, (Bitmap) null, (float) i10, 1, Integer.MIN_VALUE, f3, i9, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
    }
    ...
    public final SpannableString d() {
        ...
        while (true) {
            ...
            int i8 = mx1.c;
            i5++;
            if (i8 != (i5 < arrayList.size() ? ((mx1) arrayList.get(i5)).c : length)) {
                if (i != -1 && !z2) {
