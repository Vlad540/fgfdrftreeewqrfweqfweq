...
public final class sse extends ahd {
    public static final Pattern C0 = Pattern.compile("^([0-9][0-9]+):([0-9][0-9]):([0-9][0-9])(?:(\\.[0-9]+)|:([0-9][0-9])(?:\\.([0-9]+))?)?$");
    public static final Pattern D0 = Pattern.compile("^([0-9]+(?:\\.[0-9]+)?)(h|m|s|ms|f|t)$");
    public static final Pattern E0 = Pattern.compile("^(([0-9]*.)?[0-9]+)(px|em|%)$");
    public static final Pattern F0 = Pattern.compile("^([-+]?\\d+\\.?\\d*?)%$");
    public static final Pattern G0 = Pattern.compile("^(\\d+\\.?\\d*?)% (\\d+\\.?\\d*?)%$");
    public static final Pattern H0 = Pattern.compile("^(\\d+\\.?\\d*?)px (\\d+\\.?\\d*?)px$");
    public static final Pattern I0 = Pattern.compile("^(\\d+) (\\d+)$");
    public static final cpc J0 = new cpc(1, 30.0f, 1);
    public static final ii5 K0 = new ii5(15, 12);
    public final XmlPullParserFactory B0;
    ...
    public static yse g(yse yse) {
        return yse == null ? new yse() : yse;
    }
    ...
    public static ii5 i(XmlPullParser xmlPullParser, ii5 ii5) {
        String attributeValue = xmlPullParser.getAttributeValue("http://www.w3.org/ns/ttml#parameter", "cellResolution");
        if (attributeValue == null) {
            return ii5;
        }
        Matcher matcher = I0.matcher(attributeValue);
        if (!matcher.matches()) {
    ...
    public static void j(String str, yse yse) {
        Matcher matcher;
        char c = 65535;
        int i = mze.a;
    ...
    public static cpc k(XmlPullParser xmlPullParser) {
        float f;
    ...
    public static void m(org.xmlpull.v1.XmlPullParser r20, java.util.HashMap r21, defpackage.ii5 r22, defpackage.ms r23, java.util.HashMap r24, java.util.HashMap r25) {
        /*
            r0 = r20
            r1 = r21
            r2 = r23
        ...
        L_0x000a:
            ...
            boolean r8 = defpackage.n06.v(r0, r7)
            if (r8 == 0) goto L_0x0057
            java.lang.String r7 = defpackage.n06.n(r0, r7)
            yse r8 = new yse
            r8.<init>()
            yse r8 = o(r0, r8)
        ...
        L_0x0057:
            ...
            java.lang.String r10 = defpackage.n06.n(r0, r8)
            r7 = 0
            if (r10 != 0) goto L_0x006a
            goto L_0x0219
        L_0x006a:
            java.lang.String r8 = "origin"
            java.lang.String r8 = defpackage.n06.n(r0, r8)
            if (r8 == 0) goto L_0x0219
            java.util.regex.Pattern r9 = G0
            java.util.regex.Matcher r11 = r9.matcher(r8)
            java.util.regex.Pattern r12 = H0
        ...
        L_0x00e5:
            ...
            java.lang.String r13 = defpackage.n06.n(r0, r13)
        ...
        L_0x0224:
            ...
            boolean r7 = defpackage.n06.v(r0, r4)
        ...
        L_0x022e:
            ...
            java.lang.String r7 = defpackage.n06.n(r0, r8)
            if (r7 == 0) goto L_0x0249
        ...
        L_0x0249:
            r11 = r25
        L_0x024b:
            boolean r7 = defpackage.n06.t(r0, r4)
            if (r7 == 0) goto L_0x022e
        L_0x0251:
            java.lang.String r4 = "head"
            boolean r4 = defpackage.n06.t(r0, r4)
        ...
        L_0x025a:
            ...
            goto L_0x000a
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sse.m(org.xmlpull.v1.XmlPullParser, java.util.HashMap, ii5, ms, java.util.HashMap, java.util.HashMap):void");
    }

    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.tse n(org.xmlpull.v1.XmlPullParser r21, defpackage.tse r22, java.util.HashMap r23, defpackage.cpc r24) {
        /*
            r0 = r21
            r11 = r22
            r1 = r24
        ...
        L_0x00fd:
            ...
            return r17
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sse.n(org.xmlpull.v1.XmlPullParser, tse, java.util.HashMap, cpc):tse");
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v54, resolved type: jfe} */
    ...
    /* JADX WARNING: type inference failed for: r12v15, types: [jfe] */
    /* JADX WARNING: type inference failed for: r11v69, types: [jfe] */
    /* JADX WARNING: type inference failed for: r12v20, types: [jfe] */
    /* JADX WARNING: Can't fix incorrect switch cases order */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.yse o(org.xmlpull.v1.XmlPullParser r19, defpackage.yse r20) {
        /*
            r1 = r19
        ...
        L_0x014b:
            yse r0 = g(r0)
            int r13 = defpackage.a33.a(r12, r11)     // Catch:{ IllegalArgumentException -> 0x0159 }
        ...
        L_0x018d:
            yse r0 = g(r0)
            java.util.regex.Pattern r13 = defpackage.jfe.d
        ...
        L_0x0253:
            r13 = 0
            gt6 r11 = defpackage.jfe.g
            v3d r11 = gp0.x(r11, r12)
            gt6 r15 = defpackage.jfe.f
        ...
        L_0x02f4:
            r18 = r3
            yse r0 = g(r0)     // Catch:{ SubtitleDecoderException -> 0x02fe }
        ...
        L_0x0393:
            ...
            yse r0 = g(r0)
            r1 = 0
            int r3 = defpackage.a33.a(r12, r1)     // Catch:{ IllegalArgumentException -> 0x03a5 }
        ...
        L_0x054c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sse.o(org.xmlpull.v1.XmlPullParser, yse):yse");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static long p(java.lang.String r13, defpackage.cpc r14) {
        /*
            r0 = 4
            r1 = 3
            java.util.regex.Pattern r2 = C0
        ...
        L_0x010f:
            ...
            throw r14
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sse.p(java.lang.String, cpc):long");
    }

    public static ms q(XmlPullParser xmlPullParser) {
        String n = n06.n(xmlPullParser, "extent");
        if (n == null) {
            return null;
        }
        Matcher matcher = H0.matcher(n);
        if (!matcher.matches()) {
            if (n.length() != 0) {
                "Ignoring non-pixel tts extent: ".concat(n);
            }
            return null;
        }
        try {
            ...
            String group2 = matcher.group(2);
            group2.getClass();
            return new ms(parseInt, Integer.parseInt(group2), 10);
        } catch (NumberFormatException unused) {
            if (n.length() != 0) {
                "Ignoring malformed tts extent: ".concat(n);
            }
            return null;
        }
    }
    ...
    public final g1e b(int i, byte[] bArr, boolean z) {
        cpc cpc;
        try {
            XmlPullParser newPullParser = this.B0.newPullParser();
            HashMap hashMap = new HashMap();
            HashMap hashMap2 = new HashMap();
            HashMap hashMap3 = new HashMap();
            hashMap2.put(BuildConfig.FLAVOR, new wse(BuildConfig.FLAVOR, -3.4028235E38f, -3.4028235E38f, Integer.MIN_VALUE, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, Integer.MIN_VALUE, -3.4028235E38f, Integer.MIN_VALUE));
            ms msVar = null;
            ...
            for (int eventType = newPullParser.getEventType(); eventType != 1; eventType = newPullParser.getEventType()) {
                tse tse = (tse) arrayDeque.peek();
                if (i2 == 0) {
                    String name = newPullParser.getName();
                    if (eventType == 2) {
                        if ("tt".equals(name)) {
                            cpc2 = k(newPullParser);
                            ii52 = i(newPullParser, ii5);
                            msVar = q(newPullParser);
                        }
                        ii5 ii53 = ii52;
                        ms msVar2 = msVar;
                        cpc cpc3 = cpc2;
                        if (!h(name)) {
                            ...
                            if ("head".equals(name)) {
                                cpc = cpc3;
                                m(newPullParser, hashMap, ii53, msVar2, hashMap2, hashMap3);
                            } else {
                                cpc = cpc3;
                                try {
                                    tse n = n(newPullParser, tse, hashMap2, cpc);
                                    arrayDeque.push(n);
                                    if (tse != null) {
                                        if (tse.m == null) {
                                            tse.m = new ArrayList();
                                    ...
                                    oyb.b("Suppressing parser error", e);
                                    i2++;
                                }
                            }
                            cpc2 = cpc;
                        ...
                        tse.getClass();
                        tse a = tse.a(newPullParser.getText());
                        if (tse.m == null) {
                            tse.m = new ArrayList();
                        }
                        tse.m.add(a);
                        ...
                        if (newPullParser.getName().equals("tt")) {
                            tse tse2 = (tse) arrayDeque.peek();
                            tse2.getClass();
                            ez2 = new ez2(tse2, hashMap, hashMap2, hashMap3);
                        }
                        arrayDeque.pop();
                    }
                } else if (eventType == 2) {
