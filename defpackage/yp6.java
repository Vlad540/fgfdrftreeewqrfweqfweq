...
public final class yp6 {
    ...
    public yp6(Context context) {
        this.a = new r7e(new cc3(context, 10));
    }
    ...
    public final Bitmap a(Bitmap bitmap, int i) {
        ...
        try {
            ...
            udd.s("yp6", "blur: failed to blur image with renderscript, try with old blur", th);
    ...
    public final void b(Bitmap bitmap, int i) {
        ...
        udd.p("yp6", "checkRsSpeedAndForceOldBlur: time for old blur %d, tempWidth=%d", new Object[]{Long.valueOf(abs), Integer.valueOf(c2.getWidth())});
        long nanoTime2 = System.nanoTime();
        d(bitmap, i);
        long abs2 = Math.abs(System.nanoTime() - nanoTime2);
        udd.p("yp6", "checkRsSpeedAndForceOldBlur: time for rs blur %d", new Object[]{Long.valueOf(abs2)});
        if (abs2 > abs * 3) {
            c = true;
        }
    }
    ...
    public final void d(android.graphics.Bitmap r6, int r7) {
        ...
        L_0x0061:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.yp6.d(android.graphics.Bitmap, int):void");
    }
}
