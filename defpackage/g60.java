...
public final class g60 implements e60 {
    ...
    public g60(defpackage.m80 r10, android.content.Context r11) {
        /*
            r9 = this;
            r9.<init>()
        ...
        L_0x006f:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g60.<init>(m80, android.content.Context):void");
    }

    public static AudioRecord c(int i2, m80 m80, Context context) {
        int i3 = Build.VERSION.SDK_INT;
        AudioFormat build = new AudioFormat.Builder().setSampleRate(m80.b).setChannelMask(m80.c == 1 ? 16 : 12).setEncoding(m80.d).build();
        AudioRecord.Builder builder = new AudioRecord.Builder();
        if (i3 >= 31 && context != null) {
            sk.c(builder, context);
        }
        builder.setAudioSource(m80.a);
    ...
    public final void a(nfc nfc, ryc ryc) {
        e07.p("AudioStream can not be started when setCallback.", !this.d.get());
        b();
        this.h = nfc;
        this.i = ryc;
        f60 f60 = this.k;
        if (f60 != null) {
            this.a.unregisterAudioRecordingCallback(f60);
        }
        if (this.k == null) {
            this.k = new f60(this);
        }
        this.a.registerAudioRecordingCallback(ryc, this.k);
    }

    public final void b() {
        e07.p("AudioStream has been released.", !this.c.get());
    }

    public final void d(boolean z) {
        Executor executor = this.i;
        nfc nfc = this.h;
        if (executor != null && nfc != null && !Objects.equals(this.e.getAndSet(Boolean.valueOf(z)), Boolean.valueOf(z))) {
            executor.execute(new t50((Object) nfc, z, 3));
        }
    }

    /* JADX WARNING: Removed duplicated region for block: B:22:0x0076  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final defpackage.p80 read(java.nio.ByteBuffer r14) {
        /*
            r13 = this;
            r13.b()
        ...
        L_0x004a:
            ...
            long r7 = r7 - r11
            long r5 = defpackage.r1g.j(r5, r7)
        ...
        L_0x007a:
            ...
            long r5 = (long) r0
            int r14 = r13.g
            long r5 = defpackage.r1g.D(r14, r5)
            long r5 = r5 + r3
            r13.j = r5
        L_0x0086:
            p80 r13 = new p80
            ...
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g60.read(java.nio.ByteBuffer):p80");
    }
    ...
    public final void start() {
        ...
        if (!atomicBoolean.getAndSet(true)) {
            if (xf4.a.j(AudioTimestampFramePositionIncorrectQuirk.class) != null) {
