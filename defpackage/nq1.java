...
public final class nq1 {
    ...
    public nq1(float f2, float f3, float f4, float f5, float f6, float f7) {
        this.a = f2;
        this.b = f3;
        this.c = f4;
        this.d = f5;
    ...
    public static nq1 a(int i) {
        vcf vcf = vcf.k;
        float w = wx3.w(Color.red(i));
        float w2 = wx3.w(Color.green(i));
        float w3 = wx3.w(Color.blue(i));
        float[][] fArr = wx3.d;
        float[] fArr2 = fArr[0];
        ...
        float f22 = vcf.a;
        float f23 = vcf.d;
        float pow4 = ((float) Math.pow((double) (f21 / f22), (double) (vcf.j * f23))) * 100.0f;
        Math.sqrt((double) (pow4 / 100.0f));
        float f24 = f22 + 4.0f;
        float pow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, (double) vcf.f), 0.73d)) * ((float) Math.pow((double) ((((((((float) (Math.cos(((((double) (((double) f19) < 20.14d ? 360.0f + f19 : f19)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * vcf.e) * vcf.c) * ((float) Math.sqrt((double) ((f15 * f15) + (f14 * f14))))) / (f17 + 0.305f)), 0.9d));
        float sqrt = pow5 * ((float) Math.sqrt(((double) pow4) / 100.0d));
        Math.sqrt((double) ((pow5 * f23) / f24));
        float f25 = (1.7f * pow4) / ((0.007f * pow4) + 1.0f);
        float log = ((float) Math.log((double) ((vcf.i * sqrt * 0.0228f) + 1.0f))) * 43.85965f;
        double d3 = (double) f20;
        return new nq1(f19, sqrt, pow4, f25, log * ((float) Math.cos(d3)), log * ((float) Math.sin(d3)));
    }

    public static nq1 b(float f2, float f3, float f4) {
        vcf vcf = vcf.k;
        float f5 = vcf.d;
        double d2 = ((double) f2) / 100.0d;
        Math.sqrt(d2);
        Math.sqrt((double) (((f3 / ((float) Math.sqrt(d2))) * vcf.d) / (vcf.a + 4.0f)));
        float f6 = (1.7f * f2) / ((0.007f * f2) + 1.0f);
        float log = ((float) Math.log((((double) (vcf.i * f3)) * 0.0228d) + 1.0d)) * 43.85965f;
        double d3 = (double) ((3.1415927f * f4) / 180.0f);
        return new nq1(f4, f3, f2, f6, log * ((float) Math.cos(d3)), log * ((float) Math.sin(d3)));
    }

    public final int c(vcf vcf) {
        float f2;
        vcf vcf2 = vcf;
        float f3 = this.b;
        ...
        if (i != 0) {
            ...
            if (d2 != 0.0d) {
                ...
                float pow = (float) Math.pow(((double) f2) / Math.pow(1.64d - Math.pow(0.29d, (double) vcf2.f), 0.73d), 1.1111111111111112d);
                double d3 = (double) ((this.a * 3.1415927f) / 180.0f);
                float pow2 = vcf2.a * ((float) Math.pow(((double) f4) / 100.0d, (1.0d / ((double) vcf2.d)) / ((double) vcf2.j)));
                float cos = ((float) (Math.cos(2.0d + d3) + 3.8d)) * 0.25f * 3846.1538f * vcf2.e * vcf2.c;
                float f5 = pow2 / vcf2.b;
                ...
                return j33.b((double) f19, (double) (f21 + f20 + (fArr4[0] * f15)), (double) ((f17 * fArr5[2]) + (f16 * fArr5[1]) + f22));
            }
        }
        f2 = 0.0f;
        float pow4 = (float) Math.pow(((double) f2) / Math.pow(1.64d - Math.pow(0.29d, (double) vcf2.f), 0.73d), 1.1111111111111112d);
        double d32 = (double) ((this.a * 3.1415927f) / 180.0f);
        float pow22 = vcf2.a * ((float) Math.pow(((double) f4) / 100.0d, (1.0d / ((double) vcf2.d)) / ((double) vcf2.j)));
        float cos3 = ((float) (Math.cos(2.0d + d32) + 3.8d)) * 0.25f * 3846.1538f * vcf2.e * vcf2.c;
        float f52 = pow22 / vcf2.b;
        ...
        return j33.b((double) f192, (double) (f212 + f202 + (fArr42[0] * f152)), (double) ((f172 * fArr52[2]) + (f162 * fArr52[1]) + f222));
    }
}
