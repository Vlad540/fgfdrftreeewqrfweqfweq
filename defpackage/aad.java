...
public final class aad implements GLSurfaceView.Renderer {
    ...
    public static int a(int i, String str) {
        ...
        throw new RuntimeException(rf0.h("Error compiling shader: ", glGetShaderInfoLog));
    }

    public final void onDrawFrame(GL10 gl10) {
        GLES20.glClear(16384);
        GLES20.glUniform1f(this.b, ((float) (System.currentTimeMillis() - this.Y)) / 1000.0f);
        GLES20.glUniform2f(this.c, (float) this.Z, (float) this.w0);
    ...
    public final void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
        ...
        throw new RuntimeException(rf0.h("Error linking program: ", glGetProgramInfoLog));
    }
}
