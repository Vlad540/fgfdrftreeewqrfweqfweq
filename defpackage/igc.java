...
public final class igc extends Drawable {
    ...
    public igc(Resources resources, Bitmap bitmap) {
        if (resources != null) {
    ...
    public final int getOpacity() {
        ...
        L_0x001c:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.igc.getOpacity():int");
    }
