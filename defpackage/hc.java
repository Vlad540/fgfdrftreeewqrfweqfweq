...
public final class hc implements ys4 {
    public static final byte[] w = {73, 68, 51};
    public final boolean a;
    public final wx1 b = new wx1(new byte[7], 7, 2, (byte) 0);
    public final ija c = new ija(Arrays.copyOf(w, 10));
    ...
    public hc(boolean z, String str, int i2) {
        this.a = z;
        this.d = str;
        this.e = i2;
    }
    ...
    /* JADX WARNING: type inference failed for: r4v1, types: [int, boolean, byte] */
    ...
    public final void f(defpackage.ija r22) {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
        ...
        L_0x0328:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hc.f(ija):void");
    }
