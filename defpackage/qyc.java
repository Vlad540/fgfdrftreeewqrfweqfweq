...
public final class qyc implements Executor {
    public static final Logger Y = Logger.getLogger(qyc.class.getName());
    public final p36 X = new p36(this);
    public final Executor a;
    public final ArrayDeque b = new ArrayDeque();
    public int c = 1;
    public long o = 0;

    public qyc(Executor executor) {
        a24.o(executor);
        this.a = executor;
    }
    ...
    public final void execute(java.lang.Runnable r8) {
        ...
        L_0x000f:
            ...
            kjc r1 = new kjc     // Catch:{ all -> 0x0064 }
            r5 = 1
            ...
            p36 r5 = r7.X     // Catch:{ Error | RuntimeException -> 0x0042 }
        ...
        L_0x006d:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qyc.execute(java.lang.Runnable):void");
    }
