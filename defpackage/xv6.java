...
public final class xv6 {
    ...
    public xv6(TextInputLayout textInputLayout) {
        Context context = textInputLayout.getContext();
        this.g = context;
        this.h = textInputLayout;
        this.m = (float) context.getResources().getDimensionPixelSize(vmb.design_textinput_caption_translate_y);
        this.a = ct0.H(wlb.motionDurationShort4, 217, context);
        this.b = ct0.H(wlb.motionDurationMedium4, 167, context);
        this.c = ct0.H(wlb.motionDurationShort4, 167, context);
        this.d = ct0.I(context, wlb.motionEasingEmphasizedDecelerateInterpolator, og.d);
        int i2 = wlb.motionEasingEmphasizedDecelerateInterpolator;
        LinearInterpolator linearInterpolator = og.a;
        this.e = ct0.I(context, i2, linearInterpolator);
        this.f = ct0.I(context, wlb.motionEasingLinearInterpolator, linearInterpolator);
    }
    ...
    public final void b() {
        if (this.i != null) {
            ...
            if (textInputLayout.getEditText() != null) {
                ...
                Context context = this.g;
                boolean u2 = wx3.u(context);
                LinearLayout linearLayout = this.i;
                int i2 = vmb.material_helper_text_font_1_3_padding_horizontal;
                WeakHashMap weakHashMap = eaf.a;
                int paddingStart = editText.getPaddingStart();
                if (u2) {
                    paddingStart = context.getResources().getDimensionPixelSize(i2);
                }
                int i3 = vmb.material_helper_text_font_1_3_padding_top;
                int dimensionPixelSize = context.getResources().getDimensionPixelSize(vmb.material_helper_text_default_padding_top);
                if (u2) {
                    dimensionPixelSize = context.getResources().getDimensionPixelSize(i3);
                }
                int i4 = vmb.material_helper_text_font_1_3_padding_horizontal;
    ...
    public final void f() {
        ...
        i(this.n, this.o, h(this.r, BuildConfig.FLAVOR));
    }
    ...
    public final void i(int i2, int i3, boolean z2) {
        ...
        if (i4 != i5) {
            if (z3) {
                ...
                wx3.B(animatorSet, arrayList);
                animatorSet.addListener(new vv6(this, i3, e(i2), i2, e(i5)));
                animatorSet.start();
            } else if (i4 != i5) {
