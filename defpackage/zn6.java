...
public abstract class zn6 {
    public static IconCompat a(Icon icon) {
        ...
        int c = bo6.c(icon);
        if (c == 2) {
            return IconCompat.d((Resources) null, bo6.b(icon), bo6.a(icon));
        }
        if (c == 4) {
            Uri b = b(icon);
    ...
    public static android.graphics.drawable.Icon d(androidx.core.graphics.drawable.IconCompat r3, android.content.Context r4) {
        ...
        L_0x000d:
            ...
            android.graphics.drawable.Icon r4 = defpackage.co6.a(r4)
            goto L_0x00c5
        L_0x001d:
        ...
        L_0x0058:
            ...
            android.graphics.drawable.Icon r4 = defpackage.ao6.b(r4)
            goto L_0x00c5
        L_0x0063:
        ...
        L_0x00d6:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zn6.d(androidx.core.graphics.drawable.IconCompat, android.content.Context):android.graphics.drawable.Icon");
    }
}
