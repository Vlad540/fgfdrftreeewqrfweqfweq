...
public abstract class vk6 {
    ...
    static {
        uu0 uu0 = new uu0("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n".getBytes(e22.a));
        uu0.b = "PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n";
        a = uu0;
        String[] strArr = new String[256];
        for (int i = 0; i < 256; i++) {
            strArr[i] = nze.h("%8s", Integer.toBinaryString(i)).replace(' ', '0');
        }
        d = strArr;
        String[] strArr2 = c;
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            ...
            sb.append("|");
            strArr3[i6 | 8] = wn6.l(sb, strArr3[i4], "|PADDED");
        }
        int length = c.length;
    ...
    public static String a(boolean z, int i, int i2, int i3, int i4) {
        String str;
        String[] strArr = b;
        String h = i3 < strArr.length ? strArr[i3] : nze.h("0x%02x", Integer.valueOf(i3));
        if (i4 == 0) {
            ...
            if (!(i3 == 2 || i3 == 3)) {
                if (i3 == 4 || i3 == 6) {
                    ...
                    str = (i3 != 5 || (i4 & 4) == 0) ? (i3 != 0 || (i4 & 32) == 0) ? str2 : p0e.P(str2, "PRIORITY", "COMPRESSED") : p0e.P(str2, "HEADERS", "PUSH_PROMISE");
                }
            }
            str = strArr2[i4];
        }
        return nze.h("%s 0x%08x %5d %-13s %s", z ? "<<" : ">>", Integer.valueOf(i), Integer.valueOf(i2), h, str);
    }
}
