...
public final class rn9 extends io9 {
    public IconCompat e;
    public IconCompat f;
    public boolean g;
    ...
    public final void b(b0d b0d) {
        Bitmap bitmap;
        b0d b0d2 = b0d;
        Notification.BigPictureStyle bigContentTitle = new Notification.BigPictureStyle((Notification.Builder) b0d2.c).setBigContentTitle((CharSequence) this.c);
        IconCompat iconCompat = this.e;
        Context context = (Context) b0d2.b;
        if (iconCompat != null) {
            if (Build.VERSION.SDK_INT >= 31) {
                qn9.a(bigContentTitle, zn6.d(iconCompat, context));
            } else {
                int i = iconCompat.a;
                if (i == -1) {
                    i = bo6.c(iconCompat.b);
                }
                if (i == 1) {
        ...
        if (this.g) {
            ...
            if (iconCompat3 == null) {
                ...
                pn9.a(bigContentTitle, zn6.d(iconCompat3, context));
            }
        }
        if (this.a) {
        ...
        if (Build.VERSION.SDK_INT >= 31) {
            qn9.c(bigContentTitle, false);
            qn9.b(bigContentTitle, (CharSequence) null);
        }
    }
