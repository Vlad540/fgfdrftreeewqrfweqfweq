...
public final class jjf extends l5e implements i26 {
    public int X;
    ...
    public jjf(pjf pjf, sjf sjf, Continuation continuation) {
    ...
    public final Continuation n(Object obj, Continuation continuation) {
        jjf jjf = new jjf(this.w0, this.Z, continuation);
        jjf.Y = obj;
        return jjf;
    }
    ...
    public final Object o(Object obj) {
        ...
        if (i == 0) {
            wx3.H(obj);
            yif yif = (yif) this.Y;
            if (ijf.$EnumSwitchMapping$0[yif.ordinal()] == 1) {
                y76 y76 = fjf.a;
                udd.q("DownloadFromWebApp", "processDownloadFile complete");
                vjf vjf = new vjf(this.Z.a, yif.a);
                us0 us0 = pjf.f;
                r57 r57 = pjf.a;
                r57.getClass();
