...
public final class qj5 extends qf6 {
    public int A0;
    public sj0 B0;
    public ghb C0;
    public int D0;
    ...
    public final int T(ff3 ff3, int i) {
        if (ff3 == null) {
            return 0;
        }
        int[] iArr = ff3.p0;
        if (iArr[1] == 3) {
            ...
            if (i2 == 2) {
                int i3 = (int) (ff3.z * ((float) i));
                if (i3 != ff3.k()) {
                    ff3.g = true;
                    W(iArr[0], ff3.q(), 1, i3, ff3);
                }
                return i3;
            } else if (i2 == 1) {
                return ff3.k();
                ...
                if (i2 == 3) {
                    return (int) ((((float) ff3.q()) * ff3.W) + 0.5f);
                }
            }
        }
        return ff3.k();
    ...
    public final int U(ff3 ff3, int i) {
        if (ff3 == null) {
            return 0;
        }
        int[] iArr = ff3.p0;
        if (iArr[0] == 3) {
            ...
            if (i2 == 2) {
                int i3 = (int) (ff3.w * ((float) i));
                if (i3 != ff3.q()) {
                    ff3.g = true;
                    W(1, i3, iArr[1], ff3.k(), ff3);
                }
                return i3;
            } else if (i2 == 1) {
                return ff3.q();
                ...
                if (i2 == 3) {
                    return (int) ((((float) ff3.k()) * ff3.W) + 0.5f);
                }
            }
        }
        return ff3.q();
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r10v2, resolved type: oj5} */
    ...
    public final void V(int r40, int r41, int r42, int r43) {
        ...
        L_0x0026:
            ...
            goto L_0x0075
        L_0x0031:
            boolean r4 = r3 instanceof defpackage.bd6
        ...
        L_0x02a1:
            ...
            oj5 r15 = (defpackage.oj5) r15
            if (r36 != 0) goto L_0x02ff
            int r5 = r0 + -1
            if (r7 >= r5) goto L_0x02c0
            int r5 = r7 + 1
            java.lang.Object r5 = r14.get(r5)
            oj5 r5 = (defpackage.oj5) r5
            ff3 r5 = r5.b
            me3 r5 = r5.J
            r12 = r5
            r38 = r14
        ...
        L_0x07a5:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qj5.V(int, int, int, int):void");
    }

    public final void W(int i, int i2, int i3, int i4, ff3 ff3) {
        ghb ghb;
        ff3 ff32;
        while (true) {
            ghb = this.C0;
            if (ghb != null || (ff32 = this.T) == null) {
                sj0 sj0 = this.B0;
                sj0.b = i;
                sj0.d = i3;
                sj0.e = i2;
    ...
    public final void b(id7 id7, boolean z) {
        ...
        super.b(id7, z);
        ff3 ff32 = this.T;
        boolean z2 = ff32 != null && ((gf3) ff32).v0;
        int i2 = this.T0;
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                ...
                int i3 = 0;
                while (i3 < size) {
                    ((oj5) arrayList.get(i3)).b(i3, z2, i3 == size + -1);
                    i3++;
                }
            } else if (i2 != 2) {
                if (i2 == 3) {
                    ...
                    int i4 = 0;
                    while (i4 < size2) {
                        ((oj5) arrayList.get(i4)).b(i4, z2, i4 == size2 + -1);
                        i4++;
                    }
                }
                ...
                while (i8 < i6) {
                    ...
                    ff3 ff34 = this.Y0[i];
                    if (!(ff34 == null || ff34.g0 == 8)) {
                        me3 me3 = ff34.I;
                        if (i8 == 0) {
                            ff34.f(me3, this.I, this.w0);
                            ff34.i0 = this.D0;
                            ff34.d0 = f;
                        }
                        if (i8 == i6 - 1) {
                            ff34.f(ff34.K, this.K, this.x0);
                        }
                        if (i8 > 0 && ff33 != null) {
                            int i9 = this.P0;
                            me3 me32 = ff33.K;
                ...
                for (int i10 = 0; i10 < i7; i10++) {
                    ff3 ff35 = this.X0[i10];
                    if (!(ff35 == null || ff35.g0 == 8)) {
                        me3 me33 = ff35.J;
                        if (i10 == 0) {
                            ff35.f(me33, this.J, this.s0);
                            ff35.j0 = this.E0;
                            ff35.e0 = this.K0;
                        }
                        if (i10 == i7 - 1) {
                            ff35.f(ff35.L, this.L, this.t0);
                        }
                        if (i10 > 0 && ff33 != null) {
                            int i11 = this.Q0;
                            me3 me34 = ff33.L;
                            ff35.f(me33, me34, i11);
                            ff33.f(me34, me33, 0);
                        }
                        ff33 = ff35;
                    }
                ...
                for (int i12 = 0; i12 < i6; i12++) {
                    for (int i13 = 0; i13 < i7; i13++) {
                        ...
                        ff3[] ff3Arr = this.a1;
                        if (!(i14 >= ff3Arr.length || (ff3 = ff3Arr[i14]) == null || ff3.g0 == 8)) {
                            ff3 ff36 = this.Y0[i12];
                            ff3 ff37 = this.X0[i13];
                            if (ff3 != ff36) {
                                ff3.f(ff3.I, ff36.I, 0);
                                ff3.f(ff3.K, ff36.K, 0);
                            }
                            if (ff3 != ff37) {
                                ff3.f(ff3.J, ff37.J, 0);
                                ff3.f(ff3.L, ff37.L, 0);
                            }
                        }
                    }
                }
            ...
            ((oj5) arrayList.get(0)).b(0, z2, true);
        }
        this.y0 = false;
    }
}
