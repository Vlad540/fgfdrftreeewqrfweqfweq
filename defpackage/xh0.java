...
public abstract class xh0 implements u98 {
    ...
    public xh0(Context context, wu4 wu4, bf5 bf5, xzc xzc, zz9 zz9, g15 g15) {
        this.a = context;
        this.d = wu4;
        this.b = bf5;
        this.c = xzc;
        this.e = new ydc(context, zz9, g15, 1);
    }
    ...
    public final java.lang.String a(java.lang.String r7, java.lang.String r8) {
        ...
        L_0x0038:
            ...
            ete.E(r8, r6)     // Catch:{ Exception -> 0x0072 }
        ...
        L_0x0078:
            ...
            udd.t(r5, r1, r7)     // Catch:{ all -> 0x006f }
        ...
        L_0x0090:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xh0.a(java.lang.String, java.lang.String):java.lang.String");
    }
    ...
    public final void b(File file, File file2) {
        ...
        if (frameAtTime != null) {
            at7.O(file2.toString(), frameAtTime, this.c);
            frameAtTime.recycle();
            try {
                mediaMetadataRetriever.release();
            } catch (Throwable th) {
                udd.s("xh0", "fail to release", th);
            }
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final defpackage.eq3 c(java.lang.String r14) {
        /*
            r13 = this;
            android.content.Context r0 = r13.a
            wu4 r13 = r13.d
            int r1 = js.d
            boolean r1 = r1g.p(r14)
            r2 = 0
        ...
        L_0x0016:
            ...
            java.lang.String r13 = js.t(r0, r1, r13)     // Catch:{ Exception -> 0x0072 }
            boolean r6 = r1g.p(r13)     // Catch:{ Exception -> 0x0072 }
            if (r6 != 0) goto L_0x0084
            java.io.File r4 = new java.io.File     // Catch:{ Exception -> 0x0072 }
            r4.<init>(r13)     // Catch:{ Exception -> 0x0072 }
            boolean r6 = lp.n(r4)     // Catch:{ Exception -> 0x0072 }
            if (r6 == 0) goto L_0x0074
            java.lang.String r5 = r4.getName()     // Catch:{ Exception -> 0x0072 }
            java.lang.String r6 = js.s(r5)     // Catch:{ Exception -> 0x0072 }
            boolean r7 = r1g.p(r6)     // Catch:{ Exception -> 0x0072 }
        ...
        L_0x005b:
            eq3 r7 = new eq3     // Catch:{ Exception -> 0x0072 }
            ...
            eq3 r13 = new eq3     // Catch:{ Exception -> 0x0072 }
        ...
        L_0x0074:
            ...
            udd.r(r3, r13)     // Catch:{ Exception -> 0x0072 }
            goto L_0x00a9
        L_0x0084:
            java.lang.StringBuilder r13 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0072 }
        ...
        L_0x00af:
            ...
            java.lang.String r7 = js.s(r5)     // Catch:{ Exception -> 0x00fd }
            boolean r8 = r1g.p(r7)     // Catch:{ Exception -> 0x00fd }
        ...
        L_0x010f:
            r8 = r11
        L_0x0110:
            eq3 r14 = new eq3     // Catch:{ Exception -> 0x00fd }
            ...
            eq3 r5 = new eq3     // Catch:{ Exception -> 0x00fd }
        ...
        L_0x012a:
            ...
            udd.r(r3, r14)     // Catch:{ Exception -> 0x00fd }
            goto L_0x0137
        L_0x0132:
        ...
        L_0x01b6:
            ...
            udd.r(r3, r0)     // Catch:{ Exception -> 0x0192 }
        ...
        L_0x0214:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xh0.c(java.lang.String):eq3");
    }

    public final e7f d(String str) {
        String str2;
        hi5 V = x87.V(this.a, Uri.parse(str));
        xzc xzc = this.c;
        Bitmap bitmap = (Bitmap) V.e;
        if (bitmap != null) {
            str2 = new File(((mg5) this.b).m(), String.valueOf(System.currentTimeMillis())).getAbsolutePath();
            at7.O(str2, bitmap, xzc);
            bitmap.recycle();
        } else {
            str2 = null;
        }
        ...
        int i = point.x;
        if (i == 0) {
            i = ((Number) ((wia) ((vqc) xzc).n.getValue()).a).intValue();
        }
        int i2 = i;
        int i3 = point.y;
        if (i3 == 0) {
            i3 = ((Number) ((wia) ((vqc) xzc).n.getValue()).b).intValue();
        }
        return new e7f(V.c, str3, i2, i3);
    }
}
