...
public abstract class sqf {
    ...
    static {
        ...
        sxe.p(255, 255, 255, hashMap, "white");
        sxe.p(0, 255, 0, hashMap, "lime");
        sxe.p(0, 255, 255, hashMap, "cyan");
        sxe.p(255, 0, 0, hashMap, "red");
        sxe.p(255, 255, 0, hashMap, "yellow");
        sxe.p(255, 0, 255, hashMap, "magenta");
        sxe.p(0, 0, 255, hashMap, "blue");
        sxe.p(0, 0, 0, hashMap, "black");
        c = Collections.unmodifiableMap(hashMap);
        HashMap hashMap2 = new HashMap();
        sxe.p(255, 255, 255, hashMap2, "bg_white");
        sxe.p(0, 255, 0, hashMap2, "bg_lime");
        sxe.p(0, 255, 255, hashMap2, "bg_cyan");
        sxe.p(255, 0, 0, hashMap2, "bg_red");
        sxe.p(255, 255, 0, hashMap2, "bg_yellow");
        sxe.p(255, 0, 255, hashMap2, "bg_magenta");
        sxe.p(0, 0, 255, hashMap2, "bg_blue");
        sxe.p(0, 0, 0, hashMap2, "bg_black");
        d = Collections.unmodifiableMap(hashMap2);
    }

    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void a(java.lang.String r18, defpackage.nqf r19, java.util.List r20, android.text.SpannableStringBuilder r21, java.util.List r22) {
        /*
            r0 = r18
            r1 = r19
            r2 = r21
        ...
        L_0x0242:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sqf.a(java.lang.String, nqf, java.util.List, android.text.SpannableStringBuilder, java.util.List):void");
    }

    public static ArrayList b(List list, String str, nqf nqf) {
        int i;
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < list.size(); i2++) {
            hqf hqf = (hqf) list.get(i2);
            String str2 = nqf.a;
            if (!hqf.a.isEmpty() || !hqf.b.isEmpty() || !hqf.c.isEmpty() || !hqf.d.isEmpty()) {
                int a2 = hqf.a(hqf.d, hqf.a(hqf.b, hqf.a(hqf.a, 0, 1073741824, str), 2, str2), 4, nqf.c);
                if (a2 != -1) {
                    if (nqf.d.containsAll(hqf.c)) {
                        i = a2 + (hqf.c.size() * 4);
                    }
                }
                i = 0;
    ...
    public static int c(List list, String str, nqf nqf) {
        ArrayList b2 = b(list, str, nqf);
        for (int i = 0; i < b2.size(); i++) {
            int i2 = ((pqf) b2.get(i)).b.p;
            if (i2 != -1) {
                return i2;
            }
        }
    ...
    public static jqf d(String str, Matcher matcher, ija ija, ArrayList arrayList) {
        qqf qqf = new qqf();
        try {
            ...
            qqf.c = f(str, sb.toString(), arrayList);
            return new jqf(qqf.b().a(), qqf.a, qqf.b);
        } catch (NumberFormatException unused) {
            ez3.j0("Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
    ...
    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void e(java.lang.String r18, defpackage.qqf r19) {
        /*
            r0 = r19
        ...
        L_0x0085:
            ...
            defpackage.ez3.j0(r13)     // Catch:{ NumberFormatException -> 0x0173 }
        L_0x008e:
            r13 = r10
            goto L_0x0097
        L_0x0090:
        ...
        L_0x00fb:
            ...
            defpackage.ez3.j0(r5)     // Catch:{ NumberFormatException -> 0x0173 }
            r5 = r16
            goto L_0x010c
        L_0x0107:
            r5 = r10
        ...
        L_0x0112:
            float r5 = defpackage.xqf.b(r14)     // Catch:{ NumberFormatException -> 0x0173 }
        ...
        L_0x018a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sqf.e(java.lang.String, qqf):void");
    }
    ...
    public static android.text.SpannedString f(java.lang.String r16, java.lang.String r17, java.util.List r18) {
        ...
        L_0x0222:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.sqf.f(java.lang.String, java.lang.String, java.util.List):android.text.SpannedString");
    }

    public static void g(String str, qqf qqf) {
        int i = 2;
        ...
        if (indexOf != -1) {
            ...
            switch (c2) {
                ...
                case 3:
                    ...
                    break;
                default:
                    ez3.j0("Invalid anchor value: ".concat(substring));
                    i = Integer.MIN_VALUE;
                    break;
            }
            qqf.g = i;
        ...
        qqf.e = (float) Integer.parseInt(str);
        qqf.f = 1;
    }
}
