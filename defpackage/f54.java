...
public final class f54 implements bf0, bqe {
    public static final e8c n = ws6.p(5400000L, 3300000L, 2000000L, 1300000L, 760000L);
    public static final e8c o = ws6.p(1700000L, 820000L, 450000L, 180000L, 130000L);
    public static final e8c p = ws6.p(2300000L, 1300000L, 1000000L, 820000L, 570000L);
    public static final e8c q = ws6.p(3400000L, 2000000L, 1400000L, 1000000L, 620000L);
    public static final e8c r = ws6.p(7500000L, 5200000L, 3700000L, 1800000L, 1100000L);
    public static final e8c s = ws6.p(3300000L, 1900000L, 1700000L, 1500000L, 1200000L);
    public static f54 t;
    public final zs6 a;
    public final mv4 b = new mv4(4);
    public final wjd c;
    public final y7e d;
    ...
    public f54(Context context, Map map, int i2, y7e y7e, boolean z) {
        ci9 ci9;
        int i3;
        this.a = zs6.b(map);
        this.c = new wjd(i2, 0);
        ...
        if (context != null) {
            ...
            this.i = i3;
            this.l = c(i3);
            d54 d54 = new d54(this);
            CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) ci9.e;
            ...
            copyOnWriteArrayList.add(new WeakReference(d54));
            ((Handler) ci9.d).post(new hg9(ci9, 1, d54));
            return;
        }
        this.i = 0;
        this.l = c(0);
    ...
    public static int[] a(java.lang.String r8) {
        ...
        L_0x114f:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f54.a(java.lang.String):int[]");
    }

    public final void b(f44 f44, Handler handler) {
        f44.getClass();
        mv4 mv4 = this.b;
        mv4.getClass();
        CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) mv4.b;
        Iterator it = copyOnWriteArrayList.iterator();
        while (it.hasNext()) {
            ze0 ze0 = (ze0) it.next();
            if (ze0.b == f44) {
                ze0.c = true;
                copyOnWriteArrayList.remove(ze0);
            }
        }
        copyOnWriteArrayList.add(new ze0(f44, handler));
    }
    ...
    public final long c(int r1) {
        ...
        L_0x0023:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f54.c(int):long");
    }
    ...
    public final void d(int i2, long j2, long j3) {
        if (i2 != 0 || j2 != 0 || j3 != this.m) {
            ...
            while (it.hasNext()) {
                ze0 ze0 = (ze0) it.next();
                if (!ze0.c) {
                    ze0.a.post(new s50(i2, 2, j2, j3, ze0));
                }
            }
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void e(defpackage.xz3 r3, boolean r4, int r5) {
        /*
            r2 = this;
            monitor-enter(r2)
        ...
        L_0x001a:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f54.e(xz3, boolean, int):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void f(defpackage.xz3 r11, boolean r12) {
        /*
            r10 = this;
            monitor-enter(r10)
            r0 = 0
        ...
        L_0x0014:
            ...
            r0 = r1
        L_0x0019:
            swb.h(r0)     // Catch:{ all -> 0x005c }
            y7e r11 = r10.d     // Catch:{ all -> 0x005c }
        ...
        L_0x007c:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f54.f(xz3, boolean):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void g(defpackage.xz3 r2, boolean r3) {
        /*
            r1 = this;
            monitor-enter(r1)
            r0 = 1
        ...
        L_0x002c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f54.g(xz3, boolean):void");
    }
}
