...
public abstract class f38 {
    ...
    public static void a(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (mze.a < 26 && mze.b.equals("R9") && arrayList.size() == 1 && ((o28) arrayList.get(0)).a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                arrayList.add(o28.g("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false));
            }
            Collections.sort(arrayList, new i63(3, new j67(19)));
        }
        int i = mze.a;
        if (i < 21 && arrayList.size() > 1) {
            String str2 = ((o28) arrayList.get(0)).a;
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                Collections.sort(arrayList, new i63(3, new j67(21)));
            }
        }
        if (i < 32 && arrayList.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((o28) arrayList.get(0)).a)) {
            arrayList.add((o28) arrayList.remove(0));
        }
    }

    public static String b(vu5 vu5) {
        Pair d;
        if ("audio/eac3-joc".equals(vu5.A0)) {
            return "audio/eac3";
        }
        if (!"video/dolby-vision".equals(vu5.A0) || (d = d(vu5)) == null) {
            return null;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:352:0x0578, code lost:
        switch(r18) {
            ...
            case one.me.common.drawable.SavedMessagesIconDrawable.SMALL_ICON_SIZE :int: goto L_0x05a3;
    ...
    public static android.util.Pair d(defpackage.vu5 r26) {
        /*
            r0 = r26
        ...
        L_0x0360:
            ...
            java.lang.String r0 = defpackage.b49.d(r0)     // Catch:{ NumberFormatException -> 0x03ba }
        ...
        L_0x07e9:
            return r17
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f38.d(vu5):android.util.Pair");
    }

    public static synchronized List e(String str, boolean z, boolean z2) {
        synchronized (f38.class) {
            try {
                y28 y28 = new y28(str, z, z2);
                HashMap hashMap = b;
                List list = (List) hashMap.get(y28);
                if (list != null) {
                    return list;
                }
                int i = mze.a;
                ArrayList f = f(y28, i >= 21 ? new c38(0, z, z2) : new y76(13));
                if (z && f.isEmpty() && 21 <= i && i <= 23) {
                    f = f(y28, new y76(13));
                    if (!f.isEmpty()) {
                        new StringBuilder(String.valueOf(str).length() + 63 + String.valueOf(((o28) f.get(0)).a).length());
                    }
                }
                a(str, f);
                ws6 j = ws6.j(f);
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.ArrayList f(defpackage.y28 r23, defpackage.a38 r24) {
        /*
            r1 = r23
            r2 = r24
            ...
            int r15 = r24.d()     // Catch:{ Exception -> 0x0130 }
            boolean r13 = r24.e()     // Catch:{ Exception -> 0x0130 }
            r16 = 0
            r12 = r16
        L_0x001b:
            if (r12 >= r15) goto L_0x0147
            android.media.MediaCodecInfo r0 = r2.a(r12)     // Catch:{ Exception -> 0x0130 }
            int r6 = defpackage.mze.a     // Catch:{ Exception -> 0x0130 }
            r7 = 29
        ...
        L_0x0045:
            ...
            boolean r8 = r2.b(r4, r10, r9)     // Catch:{ Exception -> 0x0104 }
            boolean r17 = r2.c(r4, r9)     // Catch:{ Exception -> 0x0104 }
        ...
        L_0x0057:
            ...
            goto L_0x002d
        L_0x005c:
            boolean r7 = r2.b(r3, r10, r9)     // Catch:{ Exception -> 0x0104 }
            boolean r8 = r2.c(r3, r9)     // Catch:{ Exception -> 0x0104 }
            boolean r2 = r1.b
        ...
        L_0x0093:
            ...
            java.lang.String r0 = defpackage.fja.A(r0)     // Catch:{ Exception -> 0x0104 }
        ...
        L_0x00c1:
            ...
            r22 = r13
            r13 = r2
            o28 r0 = defpackage.o28.g(r6, r7, r8, r9, r10, r11, r12, r13)     // Catch:{ Exception -> 0x00db }
        ...
        L_0x0104:
            ...
            r22 = r13
        L_0x010d:
            int r2 = defpackage.mze.a     // Catch:{ Exception -> 0x0130 }
            r6 = 23
        ...
        L_0x0148:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f38.f(y28, a38):java.util.ArrayList");
    }
    ...
    public static boolean g(MediaCodecInfo mediaCodecInfo, String str, boolean z, String str2) {
        ...
        if (i < 18 && "OMX.MTK.AUDIO.DECODER.AAC".equals(str)) {
            String str3 = mze.b;
            if ("a70".equals(str3) || ("Xiaomi".equals(mze.c) && str3.startsWith("HM"))) {
                return false;
            }
        }
        ...
        if (i < 24 && (("OMX.SEC.aac.dec".equals(str) || "OMX.Exynos.AAC.Decoder".equals(str)) && "samsung".equals(mze.c))) {
            String str6 = mze.b;
            if (str6.startsWith("zeroflte") || str6.startsWith("zerolte") || str6.startsWith("zenlte") || "SC-05G".equals(str6) || "marinelteatt".equals(str6) || "404SC".equals(str6) || "SC-04G".equals(str6) || "SCV31".equals(str6)) {
                return false;
            }
        }
        if (i <= 19 && "OMX.SEC.vp8.dec".equals(str) && "samsung".equals(mze.c)) {
            String str7 = mze.b;
            if (str7.startsWith("d2") || str7.startsWith("serrano") || str7.startsWith("jflte") || str7.startsWith("santos") || str7.startsWith("t0")) {
                return false;
            }
        }
        if (i > 19 || !mze.b.startsWith("jflte") || !"OMX.qcom.video.decoder.vp8".equals(str)) {
    ...
    public static int i() {
        ...
        if (c == -1) {
            ...
            if (o28 != null) {
                ...
                i2 = Math.max(i3, mze.a >= 21 ? 345600 : 172800);
            }
            c = i2;
        }
        return c;
