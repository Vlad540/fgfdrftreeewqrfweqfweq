...
public final class p30 {
    ...
    public p30(Context context, Handler handler, g45 g45) {
        AudioManager audioManager = (AudioManager) context.getApplicationContext().getSystemService("audio");
        audioManager.getClass();
        this.b = audioManager;
        this.h = g45;
        this.g = new o30(0, handler, this);
        this.c = 0;
    }
        ...
        switch (this.a) {
            case 0:
                if (this.c != 0) {
                    ...
                    if (i2 >= 26) {
                        ...
                        audioManager.abandonAudioFocus((o30) this.g);
                    }
                    c(0);
                    return;
                }
            ...
            default:
                ...
                if (i3 != 1 && i3 != 0) {
                    ...
                    audioManager2.abandonAudioFocus((o30) this.g);
                    return;
                }
                return;
        }
    ...
    public void b(defpackage.k20 r6) {
        /*
            r5 = this;
            java.lang.Object r0 = r5.i
            k20 r0 = (defpackage.k20) r0
            boolean r0 = defpackage.oze.a(r0, r6)
        ...
        L_0x0036:
            ...
            defpackage.oyb.c(r5, r0)
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p30.b(k20):void");
    }
            ...
            case 0:
                if (this.c != i2) {
                    ...
                    if (this.e != f2) {
                        ...
                        if (g45 != null) {
                            m45 m45 = g45.a;
                            m45.k2(1, 2, Float.valueOf(m45.i1 * m45.M0.e));
                            return;
                        }
                        return;
                    }
            ...
            default:
                if (this.c != i2) {
                    ...
                    if (this.e != f3) {
                        ...
                        if (h45 != null) {
                            n45 n45 = h45.a;
                            n45.n2(1, 2, Float.valueOf(n45.l1 * n45.R0.e));
                            return;
                        }
                        return;
                    }
    ...
    public final int d(int r8, boolean r9) {
        ...
        L_0x012e:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p30.d(int, boolean):int");
    }

    public p30(Context context, Handler handler, h45 h45) {
        AudioManager audioManager = (AudioManager) context.getApplicationContext().getSystemService("audio");
        audioManager.getClass();
        this.b = audioManager;
        this.h = h45;
        this.g = new o30(1, handler, this);
        this.c = 0;
    }
}
