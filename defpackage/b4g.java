...
public final /* synthetic */ class b4g implements Runnable {
    ...
    public /* synthetic */ b4g(FirebaseInstanceIdReceiver firebaseInstanceIdReceiver, Intent intent, Context context, boolean z, BroadcastReceiver.PendingResult pendingResult) {
            ...
            if (intent2 != null) {
                ...
                synchronized (FirebaseInstanceIdReceiver.class) {
                    ...
                    if (executor == null) {
                        ...
                        ThreadPoolExecutor threadPoolExecutor2 = new ThreadPoolExecutor(1, 1, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), new zf9("pscm-ack-executor", 0));
                        threadPoolExecutor.allowCoreThreadTimeOut(true);
                        executor = Executors.unconfigurableExecutorService(threadPoolExecutor);
                        FirebaseInstanceIdReceiver.b = new SoftReference(executor);
                    }
                }
                executor.execute(new ue3(context, h13, countDownLatch));
                try {
                    i2 = ((Integer) gwf.a(new afc(context, 1).E(intent))).intValue();
