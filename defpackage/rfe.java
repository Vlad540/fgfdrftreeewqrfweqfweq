...
public final class rfe extends b4 {
    public final TextInputLayout d;

    public rfe(TextInputLayout textInputLayout) {
    ...
    public final void d(View view, l4 l4Var) {
        ...
        boolean z4 = !textInputLayout.J1;
        boolean z5 = !TextUtils.isEmpty(error);
        if (!z5 && TextUtils.isEmpty(counterOverflowDescription)) {
            z2 = false;
        }
        String charSequence = z3 ? hint.toString() : BuildConfig.FLAVOR;
        hpd hpd = textInputLayout.b;
        AppCompatTextView appCompatTextView = hpd.b;
        if (appCompatTextView.getVisibility() == 0) {
            accessibilityNodeInfo.setLabelFor(appCompatTextView);
            accessibilityNodeInfo.setTraversalAfter(appCompatTextView);
        } else {
            accessibilityNodeInfo.setTraversalAfter(hpd.o);
        }
        if (z) {
        ...
        AppCompatTextView appCompatTextView2 = textInputLayout.B0.y;
