...
public final class wx1 {
    ...
    public /* synthetic */ wx1(byte[] bArr, int i, int i2, byte b2) {
        this.a = i2;
        this.b = bArr;
        this.e = i;
    }
    ...
    public void a() {
        ...
        L_0x0055:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wx1.a():void");
    }
    ...
    public wx1(int i, int i2, int i3, byte[] bArr) {
        this.a = i3;
        switch (i3) {
            case 4:
                this.b = bArr;
