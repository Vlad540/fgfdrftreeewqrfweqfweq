...
public abstract class ek {
    ...
    public static void a(Class cls, HashMap hashMap, HashMap hashMap2) {
        for (Method method : cls.getDeclaredMethods()) {
            if (!method.isBridge()) {
                if (method.isAnnotationPresent(a1e.class)) {
                    ...
                    if (parameterTypes.length == 1) {
                        ...
                        throw new IllegalArgumentException(wn6.j(sb, parameterTypes.length, " arguments.  Methods must require a single argument."));
                    }
                } else if (method.isAnnotationPresent(w4b.class)) {
                    Class[] parameterTypes2 = method.getParameterTypes();
                    if (parameterTypes2.length != 0) {
                        StringBuilder sb2 = new StringBuilder("Method ");
                        sb2.append(method);
                        sb2.append("has @Produce annotation but requires ");
                        throw new IllegalArgumentException(wn6.j(sb2, parameterTypes2.length, " arguments.  Methods must require zero arguments."));
