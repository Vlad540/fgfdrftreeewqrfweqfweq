...
public final class g54 implements cf0, cqe {
    public static final e8c n = ws6.p(4300000L, 3200000L, 2400000L, 1700000L, 860000L);
    public static final e8c o = ws6.p(1500000L, 980000L, 750000L, 520000L, 290000L);
    public static final e8c p = ws6.p(2000000L, 1300000L, 1000000L, 860000L, 610000L);
    public static final e8c q = ws6.p(2500000L, 1700000L, 1200000L, 970000L, 680000L);
    public static final e8c r = ws6.p(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
    public static final e8c s = ws6.p(2700000L, 2000000L, 1600000L, 1300000L, 1000000L);
    public static g54 t;
    public final zs6 a;
    public final ea6 b = new ea6(3);
    public final z7e c;
    ...
    public g54(Context context, HashMap hashMap, int i2, z7e z7e, boolean z) {
        this.a = zs6.b(hashMap);
        this.e = new wjd(i2, 1);
        this.c = z7e;
        this.d = z;
        if (context != null) {
            di9 h2 = di9.h(context);
            int i3 = h2.i();
            this.m = i3;
            this.k = b(i3);
            ...
            copyOnWriteArrayList.add(new WeakReference(e54));
            ((Handler) h2.b).post(new hg9(h2, 2, e54));
            return;
        }
        this.m = 0;
        this.k = b(0);
    ...
    public static int[] a(java.lang.String r8) {
        ...
        L_0x1186:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g54.a(java.lang.String):int[]");
    }
    ...
    public final long b(int r1) {
        ...
        L_0x0023:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g54.b(int):long");
    }
    ...
    public final void c(int i2, long j2, long j3) {
        if (i2 != 0 || j2 != 0 || j3 != this.l) {
            ...
            while (it.hasNext()) {
                af0 af0 = (af0) it.next();
                if (!af0.c) {
                    af0.a.post(new s50(i2, 3, j2, j3, af0));
                }
            }
        }
    }
