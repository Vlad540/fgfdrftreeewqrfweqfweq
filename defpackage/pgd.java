...
public final class pgd extends wv0 {
    public static final Pattern Z = Pattern.compile("^(.+)\\.(\\d+)\\.(\\d+)\\.v1\\.exo$", 32);
    public static final Pattern w0 = Pattern.compile("^(.+)\\.(\\d+)\\.(\\d+)\\.v2\\.exo$", 32);
    public static final Pattern x0 = Pattern.compile("^(\\d+)\\.(\\d+)\\.(\\d+)\\.v3\\.exo$", 32);
    ...
    public static defpackage.pgd b(java.io.File r16, long r17, long r19, mif r21) {
        /*
            r0 = r21
        ...
        L_0x0042:
            ...
            r11.<init>(r9)
            java.util.regex.Pattern r12 = defpackage.oze.j
        ...
        L_0x013d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.pgd.b(java.io.File, long, long, mif):pgd");
    }
    ...
    public static File c(File file, int i, long j, long j2) {
        ...
        sb.append(j);
        sb.append(".");
        return new File(file, wn6.k(sb, j2, ".v3.exo"));
    }
}
