...
public abstract class pe3 extends View {
    ...
    public pe3(Context context, AttributeSet attributeSet) {
    ...
    public final void a(java.lang.String r6) {
        ...
        L_0x0064:
            ...
            java.lang.Class<lpb> r1 = defpackage.lpb.class
        ...
        L_0x0080:
            ...
            java.util.HashMap r1 = r5.y0
            r1.put(r0, r6)
            r5.b(r3)
        L_0x008e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.pe3.a(java.lang.String):void");
    }
        ...
        if (str != null && str.length() != 0 && this.c != null) {
            ...
            if (constraintLayout != null) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if ((layoutParams instanceof re3) && trim.equals(((re3) layoutParams).Y) && childAt.getId() != -1) {
                        b(childAt.getId());
                    }
                }
            }
    ...
    public void h(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == gwb.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.w0 = string;
                    setIds(string);
                } else if (index == gwb.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    public void i(ff3 ff3, boolean z) {
    }
    ...
    public final void k() {
        if (this.o != null) {
            ...
            if (layoutParams instanceof re3) {
                ((re3) layoutParams).p0 = this.o;
            }
        }
    }
