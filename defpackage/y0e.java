...
public final class y0e extends ahd {
    public static final Pattern D0 = Pattern.compile("\\s*((?:(\\d+):)?(\\d+):(\\d+)(?:,(\\d+))?)\\s*-->\\s*((?:(\\d+):)?(\\d+):(\\d+)(?:,(\\d+))?)\\s*");
    ...
    public final defpackage.g1e b(int r30, byte[] r31, boolean r32) {
        /*
            r29 = this;
            r0 = r29
        ...
        L_0x005b:
            int r5 = r5 + 2
            r2[r10] = r11
            java.lang.StringBuilder r7 = r0.B0
            r7.setLength(r4)
        ...
        L_0x007e:
            ...
            r11.<init>(r10)
            java.util.regex.Pattern r12 = E0
        ...
        L_0x025a:
            ...
            goto L_0x0257
        L_0x0266:
            tw3[] r0 = new defpackage.tw3[r0]
            java.lang.Object[] r0 = r1.toArray(r0)
            tw3[] r0 = (defpackage.tw3[]) r0
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.y0e.b(int, byte[], boolean):g1e");
    }
}
