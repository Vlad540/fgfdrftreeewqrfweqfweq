...
public final class r74 implements g75 {
    ...
    static {
        g78.a("media3.extractor");
    }

    public r74(jz3 jz3, long j, long j2) {
        this.b = jz3;
        this.o = j;
        this.c = j2;
    }
    ...
    public final void c(int i) {
        ...
        byte[] bArr = this.X;
        if (i2 > bArr.length) {
            this.X = Arrays.copyOf(this.X, oze.j(bArr.length * 2, 65536 + i2, i2 + 524288));
        }
    }
