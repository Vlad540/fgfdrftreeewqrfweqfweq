...
public final class vcf {
    ...
    static {
        float[] fArr = wx3.c;
        float K = (float) ((((double) wx3.K()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = wx3.a;
        float f2 = fArr[0];
        float[] fArr3 = fArr2[0];
        float f3 = fArr[1];
        ...
        float exp = (1.0f - (((float) Math.exp((double) (((-K) - 42.0f) / 92.0f))) * 0.2777778f)) * 1.0f;
        ...
        float f10 = 1.0f / ((5.0f * K) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float cbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(((double) K) * 5.0d))) + (f11 * K);
        float K2 = wx3.K() / fArr[1];
        double d3 = (double) K2;
        ...
        k = new vcf(K2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * pow, pow, pow, f9, 1.0f, fArr6, cbrt, (float) Math.pow((double) cbrt, 0.25d), sqrt);
    }

    public vcf(float f2, float f3, float f4, float f5, float f6, float f7, float[] fArr, float f8, float f9, float f10) {
        this.f = f2;
        this.a = f3;
        this.b = f4;
        this.c = f5;
