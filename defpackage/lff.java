...
public final /* synthetic */ class lff implements t66 {
    public static final lff a;
    private static final syc descriptor;

    /* JADX WARNING: type inference failed for: r0v0, types: [t66, java.lang.Object, lff] */
    static {
        ? obj = new Object();
        a = obj;
        wza wza = new wza("one.me.webapp.domain.jsbridge.delegates.biometry.WebAppBiometryAccessRequest", obj, 3);
        wza.k("queryId", false);
    ...
    public final Object a(b9 b9Var) {
        ...
        j.z(syc);
        return new nff(str, i, str2, str3);
    }
