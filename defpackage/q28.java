...
public abstract class q28 {
    ...
    public static int a(android.media.MediaCodecInfo.VideoCapabilities r4, int r5, int r6, double r7) {
        ...
        L_0x0030:
            ...
            java.lang.Boolean r5 = defpackage.am7.f
        ...
        L_0x003c:
            ...
            goto L_0x00b9
        L_0x003f:
            uu5 r5 = new uu5     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
            r5.<init>()     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
            java.lang.String r6 = "video/avc"
            java.lang.String r6 = defpackage.c49.l(r6)     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
            r5.m = r6     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
            xu5 r6 = new xu5     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
            ...
            pv0 r5 = defpackage.pv0.Z     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
            e8c r5 = defpackage.g38.g(r5, r6, r0, r0)     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
            r6 = r0
        L_0x005c:
            ...
            p28 r1 = (defpackage.p28) r1     // Catch:{ MediaCodecUtil$DecoderQueryException -> 0x00b9 }
        ...
        L_0x00c3:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.q28.a(android.media.MediaCodecInfo$VideoCapabilities, int, int, double):int");
    }
}
