...
public final class s44 {
    ...
    public s44(xu5 xu5, int i2, int i3, int i4, int i5, int i6, int i7, int i8, f50 f50, boolean z, boolean z2, boolean z3) {
        this.a = xu5;
        this.b = i2;
        this.c = i3;
        this.d = i4;
    ...
    public static AudioAttributes c(k20 k20, boolean z) {
        return z ? new AudioAttributes.Builder().setContentType(3).setFlags(16).setUsage(1).build() : (AudioAttributes) k20.b().b;
    }

    public final AudioTrack a(k20 k20, int i2) {
        int i3 = this.c;
        try {
            AudioTrack b2 = b(k20, i2);
    ...
    public final android.media.AudioTrack b(defpackage.k20 r13, int r14) {
        /*
            r12 = this;
            ...
            android.media.AudioFormat r2 = defpackage.oze.s(r8, r10, r9)
        ...
        L_0x0094:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.s44.b(k20, int):android.media.AudioTrack");
    }
}
