...
public final class l34 {
    ...
    public void b(RecyclerView recyclerView) {
        ...
        if (i >= 0) {
            ...
            if (interpolator == null || this.e >= 1) {
                int i2 = this.e;
                if (i2 >= 1) {
                    recyclerView.t1.c(this.c, this.d, i2, interpolator);
                    this.b = false;
                    return;
                }
    ...
    public synchronized void c(int r2) {
        ...
        L_0x002e:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l34.c(int):void");
    }
    ...
    public synchronized void d() {
        ...
        synchronized (this) {
            switch (i) {
                case 0:
                    int max = Math.max(0, mze.g(this.d, this.c) - this.e);
                    int i2 = this.f;
                    if (max < i2) {
                        Arrays.fill((wc[]) this.g, max, i2, (Object) null);
                        this.f = max;
                        return;
                    }
                    return;
                default:
                    int max2 = Math.max(0, oze.g(this.d, this.c) - this.e);
                    int i3 = this.f;
                    if (max2 < i3) {
                        Arrays.fill((xc[]) this.g, max2, i3, (Object) null);
                        this.f = max2;
                        return;
                    }
                    return;
