...
public final class fif extends l5e implements i26 {
    public int X;
    public /* synthetic */ Object Y;
    public final /* synthetic */ gif Z;
    public final /* synthetic */ phf w0;
    public final /* synthetic */ sif x0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public fif(gif gif, phf phf, sif sif, Continuation continuation) {
    ...
    public final Continuation n(Object obj, Continuation continuation) {
        fif fif = new fif(this.Z, this.w0, this.x0, continuation);
        fif.Y = obj;
        return fif;
    }
