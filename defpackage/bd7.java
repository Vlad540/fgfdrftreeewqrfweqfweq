...
public abstract class bd7 extends ViewGroup {
    ...
    public bd7(Context context, AttributeSet attributeSet, int i) {
        ...
        ydc D = ydc.D(context, attributeSet, nwb.LinearLayoutCompat, i, 0);
        int[] iArr = nwb.LinearLayoutCompat;
        WeakHashMap weakHashMap = eaf.a;
        z9f.d(this, context, iArr, attributeSet, (TypedArray) D.c, i, 0);
        int i2 = nwb.LinearLayoutCompat_android_orientation;
        TypedArray typedArray = (TypedArray) D.c;
        int i3 = typedArray.getInt(i2, -1);
        if (i3 >= 0) {
            setOrientation(i3);
        }
        int i4 = typedArray.getInt(nwb.LinearLayoutCompat_android_gravity, -1);
        if (i4 >= 0) {
            setGravity(i4);
        }
        boolean z = typedArray.getBoolean(nwb.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = typedArray.getFloat(nwb.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = typedArray.getInt(nwb.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = typedArray.getBoolean(nwb.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(D.y(nwb.LinearLayoutCompat_divider));
        this.mShowDividers = typedArray.getInt(nwb.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = typedArray.getDimensionPixelSize(nwb.LinearLayoutCompat_dividerPadding, 0);
        D.E();
    }

    public boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return layoutParams instanceof ad7;
    }
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < virtualChildCount; i3++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i3))) {
                ad7 ad7 = (ad7) virtualChildAt.getLayoutParams();
                drawVerticalDivider(canvas, z ? virtualChildAt.getRight() + ad7.rightMargin : (virtualChildAt.getLeft() - ad7.leftMargin) - this.mDividerWidth);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            if (virtualChildAt2 != null) {
                ad7 ad72 = (ad7) virtualChildAt2.getLayoutParams();
                if (z) {
                    left = virtualChildAt2.getLeft() - ad72.leftMargin;
                    i2 = this.mDividerWidth;
                } else {
                    i = virtualChildAt2.getRight() + ad72.rightMargin;
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < virtualChildCount; i++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i))) {
                drawHorizontalDivider(canvas, (virtualChildAt.getTop() - ((ad7) virtualChildAt.getLayoutParams()).topMargin) - this.mDividerHeight);
            }
        }
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            View virtualChildAt2 = getVirtualChildAt(virtualChildCount - 1);
            drawHorizontalDivider(canvas, virtualChildAt2 == null ? (getHeight() - getPaddingBottom()) - this.mDividerHeight : virtualChildAt2.getBottom() + ((ad7) virtualChildAt2.getLayoutParams()).bottomMargin);
        }
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            if (baseline != -1) {
                ...
                return i3 + ((ad7) childAt.getLayoutParams()).topMargin + baseline;
    ...
    public void layoutHorizontal(int r23, int r24, int r25, int r26) {
        ...
        L_0x0132:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bd7.layoutHorizontal(int, int, int, int):void");
    }
    ...
    public void layoutVertical(int r12, int r13, int r14, int r15) {
        ...
        L_0x00b9:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bd7.layoutVertical(int, int, int, int):void");
    }
    ...
    public void measureHorizontal(int r40, int r41) {
        ...
        L_0x0562:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bd7.measureHorizontal(int, int):void");
    }
    ...
    public void measureVertical(int r30, int r31) {
        ...
        L_0x03ad:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bd7.measureVertical(int, int):void");
    }
    ...
    /* JADX WARNING: type inference failed for: r2v3, types: [ad7, android.widget.LinearLayout$LayoutParams] */
    /* JADX WARNING: type inference failed for: r2v4, types: [ad7, android.widget.LinearLayout$LayoutParams] */
    public ad7 generateDefaultLayoutParams() {
    ...
    public ad7 generateLayoutParams(AttributeSet attributeSet) {
        return new LinearLayout.LayoutParams(getContext(), attributeSet);
    }

    /* JADX WARNING: type inference failed for: r0v3, types: [ad7, android.widget.LinearLayout$LayoutParams] */
    /* JADX WARNING: type inference failed for: r0v4, types: [ad7, android.widget.LinearLayout$LayoutParams] */
    /* JADX WARNING: type inference failed for: r0v5, types: [ad7, android.widget.LinearLayout$LayoutParams] */
    public ad7 generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        if (layoutParams instanceof ad7) {
            return new LinearLayout.LayoutParams((ad7) layoutParams);
        }
