...
public final class d00 extends Drawable {
    public Drawable a;
    public boolean b;
    public int c = a24.X(((float) 56) * dh4.c().getDisplayMetrics().density);
    ...
    public d00() {
        float f2 = dh4.c().getDisplayMetrics().density * 2.0f;
        this.g = f2;
        this.i = 270;
        this.m = new RectF();
    ...
    public final void draw(android.graphics.Canvas r19) {
        ...
        L_0x0194:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.d00.draw(android.graphics.Canvas):void");
    }
        ...
        if (f2 == -0.1f) {
            ...
            if (a() || i2 < this.f || i2 == 10000) {
                ...
                if (valueAnimator2 == null) {
                    ...
                    valueAnimator3.addUpdateListener(new c00(0, (Object) this));
    ...
    public final void setBounds(Rect rect) {
        ...
        if (!this.b && rect.width() > 0 && rect.width() < a24.X(((float) 56) * dh4.c().getDisplayMetrics().density)) {
            this.c = rect.width();
        }
    }
    ...
    public final void setBounds(int i2, int i3, int i4, int i5) {
        ...
        if (!this.b && getBounds().width() > 0 && getBounds().width() < a24.X(((float) 56) * dh4.c().getDisplayMetrics().density)) {
