...
public final class cif extends l5e implements i26 {
    public int X;
    public /* synthetic */ Object Y;
    public final /* synthetic */ gif Z;
    public final /* synthetic */ phf w0;
    public final /* synthetic */ nff x0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public cif(nff nff, phf phf, gif gif, Continuation continuation) {
    ...
    public final Continuation n(Object obj, Continuation continuation) {
        cif cif = new cif(this.x0, this.w0, this.Z, continuation);
        cif.Y = obj;
        return cif;
    }
