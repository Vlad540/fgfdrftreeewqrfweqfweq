...
public final class w3 implements e75 {
    public final u3 a = new u3((String) null, 0, 1);
    public final ija b = new ija(16384);
    public boolean c;
    ...
    public final int g(g75 g75, le4 le4) {
        ija ija = this.b;
        int read = ((r74) g75).read(ija.a, 0, 16384);
        if (read == -1) {
            return -1;
        }
        ija.G(0);
