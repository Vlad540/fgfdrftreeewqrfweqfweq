...
public final class k6 extends Drawable {
    ...
    public k6(ActionBarContainer actionBarContainer) {
    ...
    public final void draw(Canvas canvas) {
        switch (this.a) {
            case 0:
                ...
                if (actionBarContainer.y0) {
                    Drawable drawable = actionBarContainer.x0;
                    if (drawable != null) {
                ...
                Drawable drawable3 = actionBarContainer.w0;
                if (drawable3 != null && actionBarContainer.z0) {
                    drawable3.draw(canvas);
                    return;
                }
                return;
            default:
                LedSeekBar ledSeekBar = this.b;
        ...
        switch (this.a) {
            case 0:
                ...
                if (!actionBarContainer.y0) {
                    ...
                    return;
                } else if (actionBarContainer.x0 != null) {
    ...
    public k6(LedSeekBar ledSeekBar) {
        this.b = ledSeekBar;
    }
}
