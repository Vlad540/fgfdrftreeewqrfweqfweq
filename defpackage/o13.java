...
public final class o13 {
    ...
    public o13(byte[] bArr, int i, int i2) {
    ...
    public static int d(int i, int i2, Object obj) {
        switch (i2) {
            ...
            case 10:
                return ((gr8) obj).getSerializedSize() + (m(i) * 2);
            case 11:
                return i(i, (gr8) obj);
            case 12:
                return b(i, (byte[]) obj);
            ...
            default:
                throw new IllegalArgumentException(wn6.h(i2, "Unknown type: "));
        }
    }
    ...
    public static int i(int i, gr8 gr8) {
        int m = m(i);
                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (55296 <= charAt2 && charAt2 <= 57343) {
                            if (Character.codePointAt(charSequence, i2) >= 65536) {
                                ...
                                throw new IllegalArgumentException(wn6.h(i2, "Unpaired surrogate at index "));
                            }
                        }
                    }
                    i2++;
    ...
    public final void u(int i, int i2, Object obj) {
        switch (i2) {
            ...
            case 18:
                ...
                return;
            default:
                throw new IOException(wn6.h(i2, "Unknown type: "));
        }
    }
    ...
    public final void y(int i, gr8 gr8) {
        F(i, 2);
        C(gr8.getCachedSize());
        gr8.writeTo(this);
    }
