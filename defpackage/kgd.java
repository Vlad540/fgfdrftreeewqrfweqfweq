...
public class kgd {
    ...
    public final int c(int i, Object obj) {
        ...
        int h = e07.h(i2, i, this.a);
        if (h < 0 || hhd.f(obj, this.b[h << 1])) {
            return h;
        }
        int i3 = h + 1;
        while (i3 < i2 && this.a[i3] == i) {
            if (hhd.f(obj, this.b[i3 << 1])) {
                return i3;
            }
            i3++;
        }
        ...
        try {
            if (obj instanceof kgd) {
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    Object f = f(i2);
                    Object i3 = i(i2);
                    Object obj2 = kgd.get(f);
                    if (i3 == null) {
                        if (obj2 != null || !kgd.containsKey(f)) {
                            return false;
                        }
    ...
    public final Object g(int i) {
        ...
        if (i2 <= 1) {
            ...
            if (iArr.length <= 8 || i2 >= iArr.length / 3) {
                if (i < i4) {
                    int i6 = i + 1;
                    cs.P(i, i6, i2, iArr, iArr);
                    Object[] objArr2 = this.b;
                    cs.Q(i3, i6 << 1, i2 << 1, objArr2, objArr2);
                }
                ...
                if (i2 == this.c) {
                    if (i > 0) {
                        cs.P(0, 0, i, iArr, this.a);
                        cs.Q(0, 0, i3, objArr, this.b);
                    }
                    if (i < i4) {
                        int i8 = i + 1;
                        cs.P(i, i8, i2, iArr, this.a);
                        cs.Q(i3, i8 << 1, i2 << 1, objArr, this.b);
                    }
                } else {
                    throw new ConcurrentModificationException();
                }
    ...
    public final Object put(Object obj, Object obj2) {
        ...
        if (i3 < i) {
            int[] iArr2 = this.a;
            int i5 = i3 + 1;
            cs.P(i5, i3, i, iArr2, iArr2);
            Object[] objArr2 = this.b;
            cs.Q(i5 << 1, i3 << 1, this.c << 1, objArr2, objArr2);
        }
        int i6 = this.c;
        if (i == i6) {
            int[] iArr3 = this.a;
