...
public final class jf6 {
    ...
    public jf6(Context context, String str) {
    ...
    public final synchronized java.util.ArrayList c() {
        ...
        L_0x0014:
            ...
            n90 r3 = new n90     // Catch:{ all -> 0x0058 }
        ...
        L_0x0074:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.jf6.c():java.util.ArrayList");
    }
    ...
    public final synchronized void f(java.lang.String r5) {
        ...
        L_0x0041:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.jf6.f(java.lang.String):void");
    }
    ...
    public final synchronized boolean g(long r6) {
        ...
        L_0x004a:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.jf6.g(long):boolean");
    }

    public final synchronized void h(long j, String str) {
        String d = d(j);
        if (this.a.getString("last-used-date", BuildConfig.FLAVOR).equals(d)) {
            String e = e(d);
            if (e != null) {
                if (!e.equals(str)) {
                    i(str, d);
