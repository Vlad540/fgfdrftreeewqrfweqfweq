...
public abstract class yr9 {
    ...
    public static BigDecimal a(char[] cArr, int i, int i2) {
        try {
            ...
            throw new NumberFormatException(wn6.i("Value \"", new String(cArr, i, i2), "\" can not be represented as BigDecimal"));
        }
    }
    ...
    public static int b(char[] r2, int r3, int r4) {
        ...
        L_0x0061:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.yr9.b(char[], int, int):int");
    }
