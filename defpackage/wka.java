...
public final class wka implements VideoEncoderFactory, iy7 {
    ...
    public wka(EglBase.Context context, boolean z, xwb xwb) {
        this.a = new HardwareVideoEncoderFactory(context, false, false);
        this.c = z ? new yka(this, xwb) : null;
        this.o = xwb;
    }

    /* JADX WARNING: type inference failed for: r3v7, types: [tyf, java.lang.Runnable] */
    ...
    public final org.webrtc.VideoEncoder createEncoder(org.webrtc.VideoCodecInfo r7) {
        ...
        L_0x007c:
            ...
            myf r7 = (defpackage.myf) r7
            zla r7 = (defpackage.zla) r7
            r7.getClass()
            rla r2 = new rla
            r3 = 0
            r2.<init>(r7, r3)
        ...
        L_0x00ad:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wka.createEncoder(org.webrtc.VideoCodecInfo):org.webrtc.VideoEncoder");
    }
