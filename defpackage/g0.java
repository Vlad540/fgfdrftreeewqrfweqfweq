...
public abstract class g0 {
    ...
    public final void i() {
        ...
        while (it.hasNext()) {
            ...
            ((Executor) pair.second).execute(new f0(this, z, (zz3) pair.first, n));
        }
    }
    ...
    public final boolean k(float f2) {
        ...
        if (z) {
            ...
            while (it.hasNext()) {
                Pair pair = (Pair) it.next();
                ((Executor) pair.second).execute(new p36((Object) this, (Object) (zz3) pair.first, false, 1));
            }
        }
        return z;
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void m(defpackage.zz3 r5, java.util.concurrent.Executor r6) {
        /*
            r4 = this;
            r6.getClass()
            monitor-enter(r4)
        ...
        L_0x004e:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g0.m(zz3, java.util.concurrent.Executor):void");
    }
