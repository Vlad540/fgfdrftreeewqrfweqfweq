...
public final class qu0 {
    ...
    public qu0(int i2) {
        ...
        this.d = true;
        this.e = true;
        this.b = new AtomicReference(new pu0(64, 4, new int[512], new String[128], 448, 512));
    }
    ...
    public final int b(int i2) {
        ...
        throw new IllegalStateException(wn6.j(sb, this.g >> 3, " slots -- suspect a DoS attack based on hash collisions. You can disable the check via `JsonFactory.Feature.FAIL_ON_SYMBOL_HASH_OVERFLOW`"));
    }
    ...
    public final int c(int i2) {
        ...
        if (i5 > 65536) {
            ...
            if (i9 != i4) {
                throw new IllegalStateException(me4.g("Failed rehash(): old count=", i4, i9, ", copyCount="));
            }
        }
        int a2 = a(i2);
        int[] iArr3 = this.f;
    ...
    public final boolean e(int r7, int r8, int[] r9) {
        ...
        L_0x007b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qu0.e(int, int, int[]):boolean");
    }
    ...
    public final String m(int i2, int[] iArr) {
        if (i2 < 4) {
            return i2 != 1 ? i2 != 2 ? i2 != 3 ? BuildConfig.FLAVOR : l(iArr[0], iArr[1], iArr[2]) : k(iArr[0], iArr[1]) : j(iArr[0]);
        }
        int i3 = i(i2, iArr);
        int a2 = a(i3);
        int[] iArr2 = this.f;
    ...
    public final String toString() {
        ...
        return String.format("[%s: size=%d, hashSize=%d, %d/%d/%d/%d pri/sec/ter/spill (=%s), total:%d]", new Object[]{qu0.class.getName(), Integer.valueOf(this.k), Integer.valueOf(this.g), Integer.valueOf(i4), Integer.valueOf(i7), Integer.valueOf(i11), Integer.valueOf(d2), Integer.valueOf(i4 + i7 + i11 + d2), Integer.valueOf(i3)});
    }

    public qu0(qu0 qu0, boolean z, int i2, boolean z2, pu0 pu0) {
        this.a = qu0;
        this.c = i2;
        this.d = z;
        this.e = z2;
