...
public class kxa {
    public static volatile kxa a;
    public static final Logger b = Logger.getLogger(qw9.class.getName());

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v1, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v18, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v20, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v23, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v24, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v26, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v27, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v30, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v31, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v34, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v35, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v37, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v42, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v44, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v46, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v47, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v48, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v49, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v50, resolved type: kxa} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v51, resolved type: kxa} */
    ...
    static {
        /*
            ...
            java.util.Map r0 = defpackage.vd.b
        ...
        L_0x0012:
            ...
            java.util.concurrent.CopyOnWriteArraySet r5 = defpackage.vd.a
        ...
        L_0x004f:
            r4.setLevel(r3)
            wd r3 = defpackage.wd.a
            r4.addHandler(r3)
            goto L_0x0012
        L_0x0058:
            boolean r0 = defpackage.id.d
        ...
        L_0x00f6:
            ...
            e37 r0 = new e37     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x0134 }
            r6 = r0
        ...
        L_0x013d:
            a = r0
            java.lang.Class<qw9> r0 = defpackage.qw9.class
            java.lang.String r0 = r0.getName()
            java.util.logging.Logger r0 = java.util.logging.Logger.getLogger(r0)
            b = r0
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.kxa.<clinit>():void");
    }
    ...
    public n06 b(X509TrustManager x509TrustManager) {
        return new oj0(c(x509TrustManager));
    }

    public gse c(X509TrustManager x509TrustManager) {
        X509Certificate[] acceptedIssuers = x509TrustManager.getAcceptedIssuers();
        return new vj0((X509Certificate[]) Arrays.copyOf(acceptedIssuers, acceptedIssuers.length));
    }
