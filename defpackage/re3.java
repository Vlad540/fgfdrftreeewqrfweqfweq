...
public final class re3 extends ViewGroup.MarginLayoutParams {
    ...
    public final void a() {
        ...
        if (this.c != -1.0f || this.a != -1 || this.b != -1) {
            ...
            this.a0 = true;
            this.b0 = true;
            if (!(this.p0 instanceof bd6)) {
                this.p0 = new bd6();
            }
            ((bd6) this.p0).S(this.V);
        }
    }
    ...
    public final void resolveLayoutDirection(int r11) {
        ...
        L_0x0102:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.re3.resolveLayoutDirection(int):void");
    }
}
