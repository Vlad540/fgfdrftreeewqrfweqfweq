...
public abstract class v0g {
    ...
    public v0g(a aVar, int i, Bundle bundle) {
        this.f = aVar;
    ...
    public final /* bridge */ void a() {
        ...
        L_0x002c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.v0g.a():void");
    }

    public abstract void b(nd3 nd3);
    ...
    public final void d() {
        ...
        synchronized (this.c.z0) {
            this.c.z0.remove(this);
        }
    }
}
