...
public abstract class oze {
    ...
    public static final String[] m = {"alb", "sq", "arm", "hy", "baq", "eu", "bur", "my", "tib", "bo", "chi", "zh", "cze", "cs", "dut", "nl", "ger", "de", "gre", "el", "fre", "fr", "geo", "ka", "ice", "is", "mac", "mk", "mao", "mi", "may", "ms", "per", "fa", "rum", "ro", "scc", "hbs-srp", "slo", "sk", "wel", "cy", HasExtraData.KEY_ID, "ms-ind", "iw", "he", "heb", "he", "ji", "yi", "arb", "ar-arb", "in", "ms-ind", "ind", "ms-ind", "nb", "no-nob", "nob", "no-nob", "nn", "no-nno", "nno", "no-nno", "tw", "ak-twi", "twi", "ak-twi", "bs", "hbs-bos", "bos", "hbs-bos", "hr", "hbs-hrv", "hrv", "hbs-hrv", "sr", "hbs-srp", "srp", "hbs-srp", "cmn", "zh-cmn", "hak", "zh-hak", "nan", "zh-nan", "hsn", "zh-hsn"};
    ...
    public static String G(String str) {
        try {
            ...
            ez3.B("Failed to read system property ".concat(str), e2);
            return null;
        }
    }
    ...
    public static String H(int i2) {
        switch (i2) {
            ...
            default:
                return i2 >= 10000 ? rf0.f(i2, "custom (", ")") : "?";
        }
    }
    ...
    public static boolean I(defpackage.kya r4) {
        /*
            r0 = 0
        ...
        L_0x002f:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oze.I(kya):boolean");
    }
    ...
    public static int J(Uri uri, String str) {
        ...
        if (str == null) {
            ...
            if (scheme != null && fja.e("rtsp", scheme)) {
                return 3;
            }
            ...
            if (lastPathSegment != null) {
                ...
                if (lastIndexOf >= 0) {
                    String A = fja.A(lastPathSegment.substring(lastIndexOf + 1));
                    A.getClass();
                    switch (A.hashCode()) {
                        case 104579:
                            if (A.equals("ism")) {
    ...
    public static boolean M(Context context) {
        ...
        if (i2 >= 29 && context.getApplicationInfo().targetSdkVersion >= 29) {
            if (i2 == 30) {
                String str = d;
                if (fja.e(str, "moto g(20)") || fja.e(str, "rmx3231")) {
                    return true;
                }
            }
            return false;
    ...
    public static boolean O() {
        String A = fja.A(b);
        return A.contains("emulator") || A.contains("emu64a") || A.contains("emu64x") || A.contains("generic");
    }
    ...
    public static String T(String str) {
        ...
        if (str4 != null) {
            StringBuilder l2 = hr1.l(str4);
            l2.append(A.substring(str2.length()));
            A = l2.toString();
            str2 = str4;
        }
        ...
        while (true) {
            ...
            if (A.startsWith(strArr2[i2])) {
                return strArr2[i2 + 1] + A.substring(strArr2[i2].length());
            }
            i2 += 2;
        }
    }
    ...
    public static void Z(long[] jArr, long j2) {
        ...
        if (i2 >= 0 && j2 % 1000000 == 0) {
            long j3 = d8.j(j2, 1000000, RoundingMode.UNNECESSARY);
            while (i3 < jArr.length) {
                jArr[i3] = d8.j(jArr[i3], j3, roundingMode);
                i3++;
            }
            ...
            for (int i4 = 0; i4 < jArr.length; i4++) {
                ...
                if (j4 != 0) {
                    ...
                    if (i5 >= 0 && j2 % j4 == 0) {
                        jArr[i4] = d8.j(1000000, d8.j(j2, j4, RoundingMode.UNNECESSARY), roundingMode);
                    } else if (i5 >= 0 || j4 % j2 != 0) {
                        jArr[i4] = b0(j4, 1000000, j2, roundingMode);
                    } else {
                        jArr[i4] = d8.C(1000000, d8.j(j4, j2, RoundingMode.UNNECESSARY));
                    }
                }
            }
        } else {
            long j5 = d8.j(1000000, j2, RoundingMode.UNNECESSARY);
            while (i3 < jArr.length) {
                jArr[i3] = d8.C(jArr[i3], j5);
                i3++;
            }
        }
    }
    ...
    public static long a0(long j2, long j3, long j4, RoundingMode roundingMode) {
        ...
        if (i2 >= 0 && j4 % j3 == 0) {
            return d8.j(j2, d8.j(j4, j3, RoundingMode.UNNECESSARY), roundingMode);
        }
        if (i2 < 0 && j3 % j4 == 0) {
            return d8.C(j2, d8.j(j3, j4, RoundingMode.UNNECESSARY));
        }
        int i3 = (j4 > j2 ? 1 : (j4 == j2 ? 0 : -1));
        return (i3 < 0 || j4 % j2 != 0) ? (i3 >= 0 || j2 % j4 != 0) ? b0(j2, j3, j4, roundingMode) : d8.C(j3, d8.j(j2, j4, RoundingMode.UNNECESSARY)) : d8.j(j3, d8.j(j4, j2, RoundingMode.UNNECESSARY), roundingMode);
    }
    ...
    public static int b(long[] r4, long r5, boolean r7) {
        ...
        L_0x001a:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oze.b(long[], long, boolean):int");
    }
    ...
    public static long b0(long r9, long r11, long r13, java.math.RoundingMode r15) {
        /*
            long r0 = defpackage.d8.C(r9, r11)
            ...
            if (r4 == 0) goto L_0x0018
            long r9 = defpackage.d8.j(r0, r13, r15)
            return r9
        L_0x0018:
            long r0 = java.lang.Math.abs(r11)
            long r7 = java.lang.Math.abs(r13)
            long r0 = defpackage.d8.n(r0, r7)
            java.math.RoundingMode r4 = java.math.RoundingMode.UNNECESSARY
            long r11 = defpackage.d8.j(r11, r0, r4)
            long r13 = defpackage.d8.j(r13, r0, r4)
            long r0 = java.lang.Math.abs(r9)
            long r7 = java.lang.Math.abs(r13)
            long r0 = defpackage.d8.n(r0, r7)
            long r9 = defpackage.d8.j(r9, r0, r4)
            long r13 = defpackage.d8.j(r13, r0, r4)
            long r0 = defpackage.d8.C(r9, r11)
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
        ...
        L_0x00ac:
            ...
            goto L_0x00e8
        L_0x00b1:
            boolean r0 = defpackage.qj4.a(r9)
        ...
        L_0x0123:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oze.b0(long, long, long, java.math.RoundingMode):long");
    }

    public static int c(lq7 lq7, long j2) {
        int i2 = lq7.b - 1;
        int i3 = 0;
        while (i3 <= i2) {
            int i4 = (i3 + i2) >>> 1;
    ...
    public static boolean c0(kya kya, boolean z) {
        if (kya == null || !kya.u() || kya.getPlaybackState() == 1 || kya.getPlaybackState() == 4) {
            return true;
        }
        return z && kya.v0() != 0;
    }
    ...
    public static int e(int[] r3, int r4, boolean r5, boolean r6) {
        ...
        L_0x0020:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oze.e(int[], int, boolean, boolean):int");
    }
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [a4d, k1, java.lang.Object] */
    public static a4d g0(ch7 ch7, zt ztVar) {
        ? obj = new Object();
        zbe zbe = new zbe(obj, 5, ch7);
        lh4 lh4 = lh4.a;
        obj.c(zbe, lh4);
        ch7.c(new ncd(ch7, obj, ztVar, 9), lh4);
        return obj;
    }
    ...
    public static Handler p(fi4 fi4) {
        return new Handler(w(), fi4);
    }
