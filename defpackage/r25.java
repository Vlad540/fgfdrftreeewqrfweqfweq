...
public final class r25 {
    ...
    public r25(int i, byte[] bArr, int i2) {
        this(-1, bArr, i, i2);
    }

    public static r25 a(String str) {
        byte[] bytes = str.concat("\u0000").getBytes(v25.Z);
        return new r25(2, bytes, bytes.length);
    }

    public static r25 b(long j, ByteOrder byteOrder) {
        return c(new long[]{j}, byteOrder);
    }

    public static r25 c(long[] jArr, ByteOrder byteOrder) {
        ByteBuffer wrap = ByteBuffer.wrap(new byte[(v25.Q[4] * jArr.length)]);
        wrap.order(byteOrder);
        for (long j : jArr) {
            wrap.putInt((int) j);
        }
        return new r25(4, wrap.array(), jArr.length);
    }

    public static r25 d(t25[] t25Arr, ByteOrder byteOrder) {
        ByteBuffer wrap = ByteBuffer.wrap(new byte[(v25.Q[5] * t25Arr.length)]);
        wrap.order(byteOrder);
        for (t25 t25 : t25Arr) {
            wrap.putInt((int) t25.a);
            wrap.putInt((int) t25.b);
        }
        return new r25(5, wrap.array(), t25Arr.length);
    }

    public static r25 e(int i, ByteOrder byteOrder) {
        return f(new int[]{i}, byteOrder);
    }

    public static r25 f(int[] iArr, ByteOrder byteOrder) {
        ByteBuffer wrap = ByteBuffer.wrap(new byte[(v25.Q[3] * iArr.length)]);
        wrap.order(byteOrder);
        for (int i : iArr) {
            wrap.putShort((short) i);
        }
        return new r25(3, wrap.array(), iArr.length);
    }
    ...
    public final double g(ByteOrder byteOrder) {
        ...
        if (j == null) {
            ...
            if (j instanceof long[]) {
                ...
                throw new NumberFormatException("There are more than one component");
            } else if (j instanceof t25[]) {
                t25[] t25Arr = (t25[]) j;
                if (t25Arr.length == 1) {
                    t25 t25 = t25Arr[0];
                    return ((double) t25.a) / ((double) t25.b);
                }
                throw new NumberFormatException("There are more than one component");
            } else {
    ...
    public final String i(ByteOrder byteOrder) {
        ...
        if (j instanceof long[]) {
            ...
            t25[] t25Arr = (t25[]) j;
            while (i < t25Arr.length) {
                sb.append(t25Arr[i].a);
                sb.append('/');
                sb.append(t25Arr[i].b);
                i++;
                if (i != t25Arr.length) {
                    sb.append(",");
                }
    ...
    /* JADX WARNING: type inference failed for: r12v12, types: [t25[], java.io.Serializable] */
    ...
    /* JADX WARNING: type inference failed for: r12v15, types: [t25[], java.io.Serializable] */
    ...
    public final java.io.Serializable j(java.nio.ByteOrder r12) {
        /*
            ...
            byte[] r2 = r11.d
            r3 = 0
            q25 r4 = new q25     // Catch:{ IOException -> 0x011a, all -> 0x0118 }
        ...
        L_0x0040:
            return r12
        L_0x0041:
            t25[] r12 = new defpackage.t25[r11]     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
        L_0x0043:
            ...
            t25 r2 = new t25     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
        ...
        L_0x00ba:
            return r12
        L_0x00bb:
            byte[] r12 = defpackage.v25.R     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
            int r12 = r12.length     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
            if (r11 < r12) goto L_0x00d0
            r12 = r0
        L_0x00c1:
            byte[] r5 = defpackage.v25.R     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
        ...
        L_0x010d:
            ...
            java.nio.charset.Charset r12 = defpackage.v25.Z     // Catch:{ IOException -> 0x0122, all -> 0x0028 }
        ...
        L_0x0127:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.r25.j(java.nio.ByteOrder):java.io.Serializable");
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder("(");
        sb.append(v25.P[this.a]);
        sb.append(", data length:");
        return wn6.j(sb, this.d.length, ")");
    }

    public r25(long j, byte[] bArr, int i, int i2) {
        this.a = i;
        this.b = i2;
        this.c = j;
        this.d = bArr;
