...
public final class p28 {
    ...
    public p28(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z, boolean z2, boolean z3) {
        str.getClass();
        this.a = str;
        this.b = str2;
        this.c = str3;
    ...
    public static boolean a(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d2) {
        ...
        Point point = new Point(oze.g(i, widthAlignment) * widthAlignment, oze.g(i2, heightAlignment) * heightAlignment);
        int i3 = point.x;
        int i4 = point.y;
    ...
    public static defpackage.p28 h(java.lang.String r8, java.lang.String r9, java.lang.String r10, android.media.MediaCodecInfo.CodecCapabilities r11, boolean r12, boolean r13, boolean r14, boolean r15) {
        /*
            p28 r13 = new p28
            r14 = 0
            r0 = 1
            ...
            java.lang.String r1 = defpackage.oze.d
        ...
        L_0x005c:
            ...
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p28.h(java.lang.String, java.lang.String, java.lang.String, android.media.MediaCodecInfo$CodecCapabilities, boolean, boolean, boolean, boolean):p28");
    }

    public final q24 b(xu5 xu5, xu5 xu52) {
        int i = !oze.a(xu5.n, xu52.n) ? 8 : 0;
        if (this.h) {
            if (xu5.w != xu52.w) {
                i |= LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY;
            }
            if (!this.e && !(xu5.t == xu52.t && xu5.u == xu52.u)) {
                i |= 512;
            }
            z23 z23 = xu5.A;
            boolean f2 = z23.f(z23);
            z23 z232 = xu52.A;
            if ((!f2 || !z23.f(z232)) && !oze.a(z23, z232)) {
                i |= 2048;
            }
            if (oze.d.startsWith("SM-T230") && "OMX.MARVELL.VIDEO.HW.CODA7542DECODER".equals(this.a) && !xu5.c(xu52)) {
                i |= 2;
            }
            if (i == 0) {
                return new q24(this.a, xu5, xu52, xu5.c(xu52) ? 3 : 2, 0);
            }
        } else {
            if (xu5.B != xu52.B) {
                i |= 4096;
            ...
            if (i == 0 && "audio/mp4a-latm".equals(str)) {
                ...
                if (!(d2 == null || d3 == null)) {
                    ...
                    if (intValue == 42 && intValue2 == 42) {
                        return new q24(this.a, xu5, xu52, 3, 0);
                    }
                }
            }
            if (!xu5.c(xu52)) {
            ...
            if (i == 0) {
                return new q24(this.a, xu5, xu52, 1, 0);
            }
        }
        return new q24(this.a, xu5, xu52, 0, i);
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean c(defpackage.xu5 r13, boolean r14) {
        /*
            r12 = this;
            android.util.Pair r0 = defpackage.g38.d(r13)
            r1 = 1
        ...
        L_0x00e3:
            ...
            java.lang.String r10 = defpackage.oze.b
        ...
        L_0x0102:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p28.c(xu5, boolean):boolean");
    }

    public final boolean d(xu5 xu5) {
        int i;
        String str = xu5.n;
        String str2 = this.b;
        boolean z = true;
        if (!(str2.equals(str) || str2.equals(g38.b(xu5))) || !c(xu5, true)) {
            return false;
        }
        if (this.h) {
            int i2 = xu5.t;
        ...
        if (codecCapabilities == null) {
            ...
            if (audioCapabilities2 == null) {
                ...
                if (maxInputChannelCount <= 1 && ((i3 < 26 || maxInputChannelCount <= 0) && !"audio/mpeg".equals(str2) && !"audio/3gpp".equals(str2) && !"audio/amr-wb".equals(str2) && !"audio/mp4a-latm".equals(str2) && !"audio/vorbis".equals(str2) && !"audio/opus".equals(str2) && !"audio/raw".equals(str2) && !"audio/flac".equals(str2) && !"audio/g711-alaw".equals(str2) && !"audio/g711-mlaw".equals(str2) && !"audio/gsm".equals(str2))) {
                    ...
                    ez3.j0("AssumedMaxChannelAdjustment: " + this.a + ", [" + maxInputChannelCount + " to " + i6 + "]");
    ...
    public final boolean e(xu5 xu5) {
        if (this.h) {
            return this.e;
        }
        Pair d2 = g38.d(xu5);
    ...
    public final boolean f(int r9, int r10, double r11) {
        ...
        L_0x0017:
            ...
            java.lang.Boolean r2 = defpackage.am7.f
            if (r2 == 0) goto L_0x002f
            boolean r2 = r2.booleanValue()
            if (r2 == 0) goto L_0x002f
            goto L_0x0034
        L_0x002f:
            int r2 = defpackage.q28.a(r1, r9, r10, r11)
            goto L_0x0035
        L_0x0034:
            r2 = r0
        L_0x0035:
        ...
        L_0x0039:
            ...
            java.lang.StringBuilder r9 = rf0.i(r1, r9, r5, r10, r4)
            r9.append(r11)
        ...
        L_0x0070:
            ...
            java.lang.StringBuilder r9 = rf0.i(r0, r9, r5, r10, r4)
            r9.append(r11)
            java.lang.String r9 = r9.toString()
            java.lang.String r10 = "AssumedSupport ["
            java.lang.String r11 = "] ["
            java.lang.String r12 = ", "
            java.lang.StringBuilder r9 = c3d.j(r10, r9, r11, r3, r12)
            java.lang.String r8 = r8.b
            r9.append(r8)
            r9.append(r11)
            java.lang.String r8 = defpackage.oze.e
            r9.append(r8)
            java.lang.String r8 = "]"
            r9.append(r8)
        ...
        L_0x00b2:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.p28.f(int, int, double):boolean");
    }

    public final void g(String str) {
        StringBuilder m = hr1.m("NoSupport [", str, "] [");
        m.append(this.a);
        m.append(", ");
        m.append(this.b);
        m.append("] [");
