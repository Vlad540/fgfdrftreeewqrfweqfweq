...
public final class f3b {
    ...
    public final Size b() {
        return hqe.c(this.c) ? new Size(this.b.height(), this.b.width()) : new Size(this.b.width(), this.b.height());
    }
    ...
    public final android.graphics.Matrix c(android.util.Size r8, int r9) {
        /*
            ...
            r1 = 1
            boolean r0 = defpackage.hqe.d(r8, r1, r0)
            r2 = 0
        ...
        L_0x0070:
            i3b r6 = defpackage.i3b.FIT_CENTER
            if (r3 == r6) goto L_0x0084
            i3b r6 = defpackage.i3b.FIT_START
            if (r3 == r6) goto L_0x0084
            i3b r6 = defpackage.i3b.FIT_END
        ...
        L_0x00a7:
            ...
            int r0 = r7.c
            r1 = 0
            android.graphics.Matrix r8 = defpackage.hqe.a(r8, r9, r0, r1)
            boolean r9 = r7.f
            if (r9 == 0) goto L_0x00ec
            boolean r9 = r7.g
            if (r9 == 0) goto L_0x00ec
            int r9 = r7.c
            boolean r9 = defpackage.hqe.c(r9)
        ...
        L_0x00ec:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.f3b.c(android.util.Size, int):android.graphics.Matrix");
    }

    public final Matrix d() {
        e07.p((String) null, f());
        RectF rectF = new RectF(0.0f, 0.0f, (float) this.a.getWidth(), (float) this.a.getHeight());
        return hqe.a(rectF, rectF, !this.g ? this.c : -z3d.O(this.e), false);
    }
