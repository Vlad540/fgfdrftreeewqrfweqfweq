...
public final class xw7 implements d75 {
    ...
    public static final byte[] c0 = "Format: Start, End, ReadOrder, Layer, Style, Name, MarginL, MarginR, MarginV, Effect, Text".getBytes(f22.c);
    ...
    public xw7(int i2) {
        c74 c74 = new c74(0);
        this.a = c74;
        c74.g = new mv4(18, this);
        this.d = (i2 & 1) == 0;
        this.b = new yze(0, false);
        this.c = new SparseArray();
        this.g = new yze(4);
        this.h = new yze(ByteBuffer.allocate(4).putInt(-1).array());
        this.i = new yze(4);
        this.e = new yze(kjd.l);
        this.f = new yze(4);
        this.j = new yze(3, false);
        this.k = new yze(3, false);
        this.l = new yze(8);
        this.m = new yze(3, false);
        this.n = new yze(3, false);
        this.L = new int[1];
    }

    public static byte[] e(long j2, String str, long j3) {
        swb.e(j2 != -9223372036854775807L);
    ...
    public final void c(defpackage.vw7 r18, long r19, int r21, int r22, int r23) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L_0x00ee:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xw7.c(vw7, long, int, int, int):void");
    }
    ...
    public final void d(long j2, long j3) {
        ...
        while (true) {
            ...
            if (i2 < sparseArray.size()) {
                fse fse = ((vw7) sparseArray.valueAt(i2)).T;
                if (fse != null) {
                    fse.b = false;
                    fse.c = 0;
                }
    ...
    public final void f(q74 q74, int i2) {
        yze yze = this.g;
        if (yze.c < i2) {
            byte[] bArr = yze.a;
            if (bArr.length < i2) {
                yze.d(Math.max(bArr.length * 2, i2));
            }
            byte[] bArr2 = yze.a;
            int i3 = yze.c;
            q74.i(bArr2, i3, i2 - i3, false);
            yze.G(i2);
        }
    }
    ...
    public final boolean h(f75 f75) {
        ...
        og0.b = 4;
        for (long w2 = yze.w(); w2 != 440786851; w2 = ((w2 << 8) & -256) | ((long) (yze.a[0] & 255))) {
            int i5 = og0.b + 1;
            og0.b = i5;
            if (i5 == i4) {
                return false;
        ...
        while (true) {
            int i6 = (((long) og0.b) > (j4 + x3) ? 1 : (((long) og0.b) == (j4 + x3) ? 0 : -1));
            if (i6 >= 0) {
                return i6 == 0;
            }
            if (og0.x(q74) == Long.MIN_VALUE || x2 < 0 || x2 > 2147483647L) {
                return false;
            }
            if (i2 != 0) {
                int x4 = (int) (x2 = og0.x(q74));
                q74.b(x4, false);
                og0.b += x4;
            }
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v54, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v55, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v60, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v63, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v64, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v67, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v90, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v91, resolved type: e8c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r5v92, resolved type: e8c} */
    /* JADX WARNING: type inference failed for: r2v7, types: [vw7, java.lang.Object] */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:196:0x03fa, code lost:
        switch(r9) {
            ...
            case one.me.common.drawable.SavedMessagesIconDrawable.SMALL_ICON_SIZE :int: goto L_0x040c;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:301:0x0622, code lost:
        switch(r13) {
            ...
            case one.me.common.drawable.SavedMessagesIconDrawable.SMALL_ICON_SIZE :int: goto L_0x072d;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:316:0x06b8, code lost:
        r38 = r2;
        r39 = r3;
        r2 = defpackage.rf6.a(new defpackage.yze(r1.a(r5)));
        r1.Y = r2.b;
        r12 = "video/hevc";
        r3 = r2.a;
        r2 = r2.d;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:340:0x0764, code lost:
        ...
        r3 = r1.k;
        r3 = defpackage.d8.x(new defpackage.wx1(r3, r3.length, 1, (byte) 0), false);
        r1.Q = r3.a;
        r1.O = r3.b;
        r12 = "audio/mp4a-latm";
        r40 = r0;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:464:0x09e8, code lost:
        r2 = defpackage.ee.c(new defpackage.yze(r13));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:471:0x0a00, code lost:
        r2 = r2 | r13;
        r13 = new defpackage.tu5();
        r19 = defpackage.b49.h(r12);
        r41 = r4;
        r4 = g0;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:475:0x0a23, code lost:
        if (defpackage.b49.j(r12) == false) goto L_0x0bac;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:517:0x0b1d, code lost:
        r10 = new defpackage.y23(r1.y, r1.A, r1.z, r9);
     */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final int i(defpackage.f75 r43, le4 r44) {
        /*
            r42 = this;
            r0 = r42
            r1 = r44
        ...
        L_0x01a7:
            ...
            wn4 r6 = new wn4
            un4 r7 = new un4
            java.util.UUID r8 = defpackage.vu0.a
            java.lang.String r9 = "video/webm"
            byte[] r5 = r5.b
            r10 = 0
            r7.<init>(r8, r10, r9, r5)
            un4[] r5 = new defpackage.un4[]{r7}
            r7 = 1
            r6.<init>(r10, r7, r5)
            r1.l = r6
            goto L_0x0144
        ...
        L_0x0a00:
            ...
            tu5 r13 = new tu5
            r13.<init>()
            boolean r19 = defpackage.b49.h(r12)
            r41 = r4
            java.util.Map r4 = g0
            ...
            goto L_0x0bde
        L_0x0a1f:
            boolean r0 = defpackage.b49.j(r12)
        ...
        L_0x0cbe:
            ...
            r1.m(r4, r5, r8)
            byte r9 = r5[r4]
            int r9 = defpackage.yze.e(r9)
            r10 = -1
            if (r9 == r10) goto L_0x0cf7
            if (r9 > r8) goto L_0x0cf7
            long r12 = defpackage.yze.a(r9, r5, r4)
            int r4 = (int) r12
        ...
        L_0x1124:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xw7.i(f75, le4):int");
    }
    ...
    public final long k(long j2) {
        ...
        if (j3 != -9223372036854775807L) {
            return mze.J(j2, j3, 1000);
        }
        throw ParserException.a((RuntimeException) null, "Can't scale timecode prior to timecodeScale being set.");
    }

    public final int l(q74 q74, vw7 vw7, int i2) {
        int i3;
        int i4;
        int i5;
        if ("S_TEXT/UTF8".equals(vw7.b)) {
            m(q74, b0, i2);
            int i6 = this.S;
            j();
            return i6;
        } else if ("S_TEXT/ASS".equals(vw7.b)) {
            m(q74, d0, i2);
            int i7 = this.S;
            j();
            return i7;
        } else if ("S_TEXT/WEBVTT".equals(vw7.b)) {
            m(q74, e0, i2);
            int i8 = this.S;
            j();
            return i8;
            ...
            int i15 = i2 + yze.c;
            if (!"V_MPEG4/ISO/AVC".equals(vw7.b) && !"V_MPEGH/ISO/HEVC".equals(vw7.b)) {
                if (vw7.T != null) {
                    if (yze.c != 0) {
                        z3 = false;
                    }
                ...
                while (this.R < i15) {
                    int i20 = this.T;
                    if (i20 == 0) {
                        int min = Math.min(i18, yze.c());
                        q74.i(bArr4, i19 + min, i18 - min, false);
                        if (min > 0) {
                            yze.g(i19, bArr4, min);
                        }
                        this.R += i18;
    ...
    public final void m(q74 q74, byte[] bArr, int i2) {
        ...
        q74.i(yze.a, bArr.length, i2, false);
        yze.H(0);
        yze.G(length);
    }
