...
public final class ovf extends AsyncTask {
    ...
    static {
        ...
        t = sparseArray;
        sparseArray.put(17, new wu5(17, 144, 24, 0, "3gp"));
        sparseArray.put(36, new wu5(36, 240, 32, 0, "3gp"));
        sparseArray.put(5, new wu5(5, 240, 64, 0, "flv"));
        sparseArray.put(43, new wu5(43, 360, 128, 0, "webm"));
        sparseArray.put(18, new wu5(18, 360, 96, 0, "mp4"));
        sparseArray.put(22, new wu5(22, 720, 192, 0, "mp4"));
        sparseArray.put(160, new wu5(160, 144, "mp4"));
        sparseArray.put(133, new wu5(133, 240, "mp4"));
        sparseArray.put(134, new wu5(134, 360, "mp4"));
        sparseArray.put(135, new wu5(135, 480, "mp4"));
        sparseArray.put(136, new wu5(136, 720, "mp4"));
        sparseArray.put(137, new wu5(137, 1080, "mp4"));
        sparseArray.put(264, new wu5(264, 1440, "mp4"));
        sparseArray.put(266, new wu5(266, 2160, "mp4"));
        sparseArray.put(298, new wu5(298, 720, (Object) null, "mp4"));
        sparseArray.put(299, new wu5(299, 1080, (Object) null, "mp4"));
        sparseArray.put(140, new wu5(140, "m4a", 128, 0));
        sparseArray.put(141, new wu5(141, "m4a", 256, 0));
        sparseArray.put(256, new wu5(256, "m4a", 192, 0));
        sparseArray.put(258, new wu5(258, "m4a", 384, 0));
        sparseArray.put(278, new wu5(278, 144, "webm"));
        sparseArray.put(242, new wu5(242, 240, "webm"));
        sparseArray.put(243, new wu5(243, 360, "webm"));
        sparseArray.put(244, new wu5(244, 480, "webm"));
        sparseArray.put(247, new wu5(247, 720, "webm"));
        sparseArray.put(248, new wu5(248, 1080, "webm"));
        sparseArray.put(271, new wu5(271, 1440, "webm"));
        sparseArray.put(313, new wu5(313, 2160, "webm"));
        sparseArray.put(HttpStatus.SC_MOVED_TEMPORARILY, new wu5((int) HttpStatus.SC_MOVED_TEMPORARILY, 720, (Object) null, "webm"));
        sparseArray.put(308, new wu5(308, 1440, (Object) null, "webm"));
        sparseArray.put(HttpStatus.SC_SEE_OTHER, new wu5((int) HttpStatus.SC_SEE_OTHER, 1080, (Object) null, "webm"));
        sparseArray.put(315, new wu5(315, 2160, (Object) null, "webm"));
        sparseArray.put(171, new wu5(171, "webm", 128, 0));
        sparseArray.put(249, new wu5(249, "webm", 48, 0));
        sparseArray.put(250, new wu5(250, "webm", 64, 0));
        sparseArray.put(251, new wu5(251, "webm", 160, 0));
        sparseArray.put(91, new wu5(91, 144, 48));
        sparseArray.put(92, new wu5(92, 240, 48));
        sparseArray.put(93, new wu5(93, 360, 128));
        sparseArray.put(94, new wu5(94, 480, 128));
        sparseArray.put(95, new wu5(95, 720, 256));
        sparseArray.put(96, new wu5(96, 1080, 256));
    }
    ...
    public final void a(SparseArray sparseArray) {
        ...
        if (context != null) {
            StringBuilder sb = new StringBuilder(wn6.l(new StringBuilder(), h, " function decipher("));
            sb.append("){return ");
            ...
            sb.append("};decipher();");
            new Handler(Looper.getMainLooper()).post(new ue3(this, context, sb));
        }
    }
    ...
    public final android.util.SparseArray b() {
        ...
        L_0x01f8:
            ...
            java.lang.String r6 = defpackage.wn6.l(r6, r7, r2)
            r0.<init>(r6)
        ...
        L_0x03a3:
            ...
            java.lang.StringBuilder r6 = hr1.l(r9)
        ...
        L_0x04dc:
            ...
            java.lang.String r2 = defpackage.wn6.l(r3, r6, r2)
            r0.<init>(r2)
        ...
        L_0x057b:
            ...
            qvf r2 = (defpackage.qvf) r2
            java.lang.String r2 = r2.b
            java.lang.String r3 = "&sig="
            java.lang.StringBuilder r2 = defpackage.me4.n(r2, r3)
            r3 = r0[r10]
            r2.append(r3)
        ...
        L_0x05d8:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ovf.b():android.util.SparseArray");
    }
