...
public final class qld implements k50 {
    public int b;
    public float c = 1.0f;
    public float d = 1.0f;
    public h50 e;
    ...
    public final boolean d() {
        ...
        L_0x0014:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qld.d():boolean");
    }
    ...
    public final void flush() {
        if (isActive()) {
            ...
            this.h = h502;
            if (this.i) {
                this.j = new old(h50.a, h50.b, this.c, this.d, h502.a, 1);
            } else {
                old old = this.j;
                if (old != null) {
                    old.l = 0;
    ...
    public final long g(long j2) {
        ...
        old old = this.j;
        old.getClass();
        long j4 = j3 - ((long) ((old.l * old.c) * 2));
        int i2 = this.h.a;
        int i3 = this.g.a;
        if (i2 == i3) {
            return oze.a0(j2, this.o, j4, RoundingMode.FLOOR);
        }
        return oze.a0(j2, this.o * ((long) i3), j4 * ((long) i2), RoundingMode.FLOOR);
    }
