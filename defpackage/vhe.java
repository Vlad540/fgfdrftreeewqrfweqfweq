...
public abstract class vhe {
    ...
    public static void a(Context context, View view) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(nwb.AppCompatTheme);
        try {
    ...
    public static int b(Context context, int i) {
        ...
        int c2 = c(context, i);
        return j33.h(c2, Math.round(((float) Color.alpha(c2)) * f2));
    }
    ...
    public static ColorStateList d(Context context, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, iArr);
        try {
            if (!obtainStyledAttributes.hasValue(0) || (resourceId = obtainStyledAttributes.getResourceId(0, 0)) == 0 || (colorStateList = d8.r(context, resourceId)) == null) {
