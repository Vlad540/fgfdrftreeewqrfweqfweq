...
public final class n13 {
    ...
    public n13(byte[] bArr, int i, int i2) {
        this.a = bArr;
        this.b = i;
        this.c = i2 + i;
        this.e = i;
    ...
    public final Serializable k(int i) {
        switch (i) {
            ...
            default:
                throw new IllegalArgumentException(wn6.h(i, "Unknown type "));
        }
    }
    ...
    public final String r() {
        ...
        int i2 = this.e;
        if (p > i - i2 || p <= 0) {
            return new String(m(p), tz6.a);
        }
        String str = new String(this.a, i2, p, tz6.a);
        this.e += p;
        return str;
    }
    ...
    public final void t(int i) {
        ...
        int i3 = this.b;
        if (i > i2 - i3) {
            StringBuilder m = me4.m(i, "Position ", " is beyond current ");
            m.append(this.e - i3);
            throw new IllegalArgumentException(m.toString());
        } else if (i >= 0) {
            this.e = i3 + i;
        } else {
            throw new IllegalArgumentException(wn6.h(i, "Bad position "));
        }
    }
