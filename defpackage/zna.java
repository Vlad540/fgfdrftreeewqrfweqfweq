...
public final class zna implements x4f {
    ...
    public zna(int i2, int i3, int i4, int i5, int i6, int i7, boolean z) {
        this.c = i2;
        this.d = i3;
        this.e = i4;
        this.f = i5;
    ...
    public SurfaceTextureHelper.FrameGeometry a(Matrix matrix, int i2, int i3) {
        ...
        if (frameGeometry != null && frameGeometry.width == i2 && frameGeometry.height == i3 && hhd.f(matrix3, matrix)) {
