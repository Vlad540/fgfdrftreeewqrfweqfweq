...
public abstract class mxa {
    public static void a(int i, int i2) {
        boolean z = false;
        ez3.k("width must be > 0", i > 0);
        if (i2 > 0) {
            z = true;
        }
        ez3.k("height must be > 0", z);
    }

    /* JADX WARNING: Removed duplicated region for block: B:29:0x0074  */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x00f9  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final defpackage.t54 b(android.graphics.Bitmap r10, int r11, int r12, int r13, int r14, android.graphics.Matrix r15) {
        /*
            r9 = this;
            java.lang.String r0 = "Source bitmap cannot be null"
            defpackage.ez3.n(r10, r0)
            r0 = 0
            r1 = 1
        ...
        L_0x013d:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.mxa.b(android.graphics.Bitmap, int, int, int, int, android.graphics.Matrix):t54");
    }

    public abstract e13 c(int i, int i2, Bitmap.Config config);
}
