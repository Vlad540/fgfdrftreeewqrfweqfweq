...
public abstract class QrCodeGenerator {
    public static final mk9 a = njb.a;
    ...
    static {
        ...
        try {
            ...
            a.getClass();
            udd.s("QrCodeGenerator", "Failed to load native library qrcode", th);
            z = false;
        }
        b = z;
    }
        ...
        if (nativeGenerateQR != null) {
            try {
                ...
                try {
                    ...
                    udd.s(QrCodeGenerator.class.getName(), "encodeQR: failed", th);
                    return bitmap4;
                }
            } catch (Throwable th2) {
                th = th2;
