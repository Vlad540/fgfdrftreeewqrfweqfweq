...
public final class RLottieFactory {
    ...
    public static final class Config {
        ...
        public Config(Way way2) {
            this(way2, false, false, false, false, 30, (x54) null);
        }
        ...
        public Config(Way way2, boolean z) {
            this(way2, z, false, false, false, 28, (x54) null);
        }

        public Config(Way way2, boolean z, boolean z2) {
            this(way2, z, z2, false, false, 24, (x54) null);
        }

        public Config(Way way2, boolean z, boolean z2, boolean z3) {
            this(way2, z, z2, z3, false, 16, (x54) null);
        }
        ...
        public /* synthetic */ Config(Way way2, boolean z, boolean z2, boolean z3, boolean z4, int i, x54 x54) {
    ...
    public static abstract class Way {
        ...
        public static abstract class Builder<B> {
            ...
            public final void m16setHeight(int i) {
                this.height = i;
            }

            /* renamed from: setLimitFps  reason: collision with other method in class */
            public final void m17setLimitFps(boolean z) {
                this.limitFps = z;
            }
            ...
            public final void m18setWidth(int i) {
                this.width = i;
            }
        ...
        public /* synthetic */ Way(int i, int i2, boolean z, x54 x54) {
            this(i, i2, z);
        }
        ...
        public static final class Asset extends Way {
            ...
            /* JADX INFO: this call moved to the top of the method (can break code semantics) */
            public /* synthetic */ Asset(Context context2, String str, String str2, int i, int i2, boolean z, int i3, x54 x54) {
        ...
        public static final class File extends Way {
            ...
            /* JADX INFO: this call moved to the top of the method (can break code semantics) */
            public /* synthetic */ File(java.io.File file2, int i, int i2, boolean z, int i3, x54 x54) {
        ...
        public static final class Json extends Way {
            ...
            /* JADX INFO: this call moved to the top of the method (can break code semantics) */
            public /* synthetic */ Json(String str, String str2, int i, int i2, boolean z, int i3, x54 x54) {
        ...
        public static final class RawRes extends Way {
            ...
            @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0006\u001a\u00020\u00002\b\b\u0001\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007J\u0015\u0010\n\u001a\u00020\u00002\u0006\u0010\t\u001a\u00020\b¢\u0006\u0004\b\n\u0010\u000bJ\r\u0010\r\u001a\u00020\f¢\u0006\u0004\b\r\u0010\u000eR+\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u000f\u001a\u00020\u00048B@BX\u0002¢\u0006\u0012\n\u0004\b\u0010\u0010\u0011\u001a\u0004\b\u0012\u0010\u0013\"\u0004\b\u0006\u0010\u0014R\u0016\u0010\t\u001a\u00020\b8\u0002@\u0002X.¢\u0006\u0006\n\u0004\b\t\u0010\u0015¨\u0006\u0016"}, d2 = {"Lone/me/rlottie/RLottieFactory$Way$RawRes$Builder;", "Lone/me/rlottie/RLottieFactory$Way$Builder;", "<init>", "()V", "", "rawResId", "setRawResId", "(I)Lone/me/rlottie/RLottieFactory$Way$RawRes$Builder;", "", "cacheName", "setCacheName", "(Ljava/lang/String;)Lone/me/rlottie/RLottieFactory$Way$RawRes$Builder;", "Lone/me/rlottie/RLottieFactory$Way$RawRes;", "build", "()Lone/me/rlottie/RLottieFactory$Way$RawRes;", "<set-?>", "rawResId$delegate", "Lp0c;", "getRawResId", "()I", "(I)V", "Ljava/lang/String;", "rlottie_release"}, k = 1, mv = {2, 0, 0})
            public static final class Builder extends Builder<Builder> {
                static final /* synthetic */ k77[] $$delegatedProperties;
                private String cacheName;
                private final p0c rawResId$delegate = new lv1(24, false);

                static {
                    k77 hc9 = new hc9(Builder.class, "rawResId", "getRawResId()I");
                    m7c.a.getClass();
                    $$delegatedProperties = new k77[]{hc9};
                }
                ...
                public final Builder m19setRawResId(int i) {
                    setRawResId(i);
                    return this;
                }
            }
            ...
            /* JADX INFO: this call moved to the top of the method (can break code semantics) */
            public /* synthetic */ RawRes(int i, String str, int i2, int i3, boolean z, int i4, x54 x54) {
        ...
        public static final class Url extends Way {
            ...
            /* JADX INFO: this call moved to the top of the method (can break code semantics) */
            public /* synthetic */ Url(String str, boolean z, int i, int i2, boolean z2, int i3, x54 x54) {
    ...
    public static final RLottieDrawable createByFile(File file, boolean z, int i, int i2, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(file, i, i2, z ? new on0() : null, z3);
        rLottieDrawable.m1 = z;
    ...
    public static final RLottieDrawable createByJsonString(String str, String str2, boolean z, boolean z2, int i, int i2, boolean z3, boolean z4, boolean z5) {
        ...
        rLottieDrawable.X0 = z3;
        rLottieDrawable.m1 = z5;
        boolean z6 = z2;
        rLottieDrawable.setAutoRepeat(INSTANCE.autoRepeatModeByBoolean(z2));
        boolean z7 = z4;
        rLottieDrawable.setAllowDecodeSingleFrame(z4);
    ...
    public static final RLottieDrawable createByAsset(Context context, String str, String str2, int i, int i2, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        try {
            String str4 = lg9.a;
            String str5 = str;
            str3 = lg9.c(context.getAssets().open(str));
    ...
    public static final RLottieDrawable createByUrl(String str, int i, int i2, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6) {
        ...
        rLottieDrawable.E1 = str2;
        rLottieDrawable.X0 = z;
        rLottieDrawable.H1 = str2;
        rLottieDrawable.m1 = z6;
        boolean z7 = z2;
        rLottieDrawable.setAutoRepeat(INSTANCE.autoRepeatModeByBoolean(z2));
        boolean z8 = z4;
        rLottieDrawable.setAllowDecodeSingleFrame(z4);
        ...
        boolean z9 = z3;
        kg9.a(str, 1, z3).e(rLottieDrawable);
        return rLottieDrawable;
    }
}
