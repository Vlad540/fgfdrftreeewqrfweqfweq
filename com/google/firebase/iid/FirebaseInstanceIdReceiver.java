...
public final class FirebaseInstanceIdReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (intent != null) {
            ...
            synchronized (FirebaseInstanceIdReceiver.class) {
                try {
                    ...
                    if (executorService2 == null) {
                        executorService2 = Executors.unconfigurableExecutorService(Executors.newCachedThreadPool(new zf9("firebase-iid-executor", 0)));
            ...
            executorService.execute(new b4g(this, intent, context, isOrderedBroadcast, goAsync));
        }
    }
}
