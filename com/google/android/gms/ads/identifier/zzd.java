...
public final class zzd {
    ...
    private final see zzd;
    private final AtomicLong zze = new AtomicLong(-1);

    /* JADX WARNING: type inference failed for: r0v2, types: [la6, see] */
    private zzd(Context context, String str) {
        this.zzd = new la6(context, l0g.z0, (nk) new tee("ads_identifier:api"), ka6.c);
    }
    ...
    public static void zzb(zzd zzd2, long j, Exception exc) {
        ...
        if ((exc instanceof ApiException) && (nd3 = ((ApiException) exc).a.o) != null && nd3.b == 24) {
            zzd2.zze.set(j);
        }
    }
    ...
    public final synchronized void zzc(int r19, int r20, long r21, long r23, int r25) {
        ...
        L_0x002b:
            see r0 = r1.zzd     // Catch:{ all -> 0x0069 }
            if (r0 != 0) goto L_0x0030
            goto L_0x006b
        L_0x0030:
            ree r4 = new ree     // Catch:{ all -> 0x0069 }
            t39 r17 = new t39     // Catch:{ all -> 0x0069 }
            r8 = 0
            r13 = 0
            r14 = 0
            r15 = 0
            ...
            t39[] r5 = new defpackage.t39[]{r17}     // Catch:{ all -> 0x0069 }
            java.util.List r5 = java.util.Arrays.asList(r5)     // Catch:{ all -> 0x0069 }
            r6 = 0
            r4.<init>(r6, r5)     // Catch:{ all -> 0x0069 }
            l0g r0 = (defpackage.l0g) r0     // Catch:{ all -> 0x0069 }
            n6g r0 = r0.d(r4)     // Catch:{ all -> 0x0069 }
            ...
            c27 r2 = defpackage.cee.a     // Catch:{ all -> 0x0069 }
