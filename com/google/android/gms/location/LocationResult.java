...
public final class LocationResult extends o3 implements ReflectedParcelable {
    public static final Parcelable.Creator<LocationResult> CREATOR = new udf(21);
    ...
    public final String toString() {
        ...
        DecimalFormat decimalFormat = g1g.a;
        ...
        for (Location location : list) {
            ...
            if (location == null) {
                ...
                if (location.hasAltitude()) {
                    ...
                    if (cm7.f(location)) {
                        sb.append("±");
                        sb.append(decimalFormat3.format((double) cm7.c(location)));
                    }
                    sb.append("m");
                }
                if (location.hasSpeed()) {
                    ...
                    if (cm7.e(location)) {
                        sb.append("±");
                        sb.append(decimalFormat3.format((double) cm7.b(location)));
                    }
                    sb.append("m/s");
                }
                if (location.hasBearing()) {
                    ...
                    if (cm7.d(location)) {
                        sb.append("±");
                        sb.append(decimalFormat3.format((double) cm7.a(location)));
                    }
                    sb.append("°");
                }
                ...
                if (millis >= 0) {
                    str = g3g.a.format(new Date(millis));
                } else {
                    SimpleDateFormat simpleDateFormat = g3g.a;
