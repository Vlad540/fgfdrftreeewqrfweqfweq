...
public final class AspectRatioFrameLayout extends FrameLayout {
    ...
    public AspectRatioFrameLayout(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, vvb.AspectRatioFrameLayout, 0, 0);
            try {
                this.c = obtainStyledAttributes.getInt(vvb.AspectRatioFrameLayout_resize_mode, 0);
            } finally {
    ...
    public void setAspectRatioListener(ks ksVar) {
    }
