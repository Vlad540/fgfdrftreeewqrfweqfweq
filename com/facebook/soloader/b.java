...
public final class b extends ild implements b6c {
    ...
    public static String h(String str) {
        ...
        StringBuilder n = me4.n(str, "!/lib/");
        n.append(supportedAbis[0]);
        return n.toString();
    }
        ...
        if (SoLoader.b != null) {
            ...
            while (it.hasNext()) {
                ...
                if (!TextUtils.isEmpty(str2) && set != null && set.contains(str)) {
                            ...
                            while (entries.hasMoreElements()) {
                                ...
                                if (zipEntry != null) {
                                    if (zipEntry.getName().endsWith("/" + str)) {
                                        ct4 = new ct4(zipFile, zipEntry);
                                        for (String str3 : d.a(str, ct4)) {
                                            if (!str3.startsWith("/")) {
                                                e(str2, str, str3);
                                            }
                                        }
                    ...
                    try {
                        i |= 4;
                        SoLoader.b.S(i, str2 + File.separator + str);
                        return 1;
