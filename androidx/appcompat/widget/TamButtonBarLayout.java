...
public final class TamButtonBarLayout extends LinearLayout {
    ...
    public TamButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, nwb.ButtonBarLayout);
        int[] iArr = nwb.ButtonBarLayout;
        WeakHashMap weakHashMap = eaf.a;
        z9f.d(this, context, iArr, attributeSet, obtainStyledAttributes, 0, 0);
        this.a = obtainStyledAttributes.getBoolean(nwb.ButtonBarLayout_allowStacking, true);
    ...
    private final void setStacked(boolean z) {
        ...
        if (!z || this.a) {
            ...
            View findViewById = findViewById(pob.spacer);
