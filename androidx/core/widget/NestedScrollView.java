...
public class NestedScrollView extends FrameLayout implements ih9, eh9, opc {
    public static final float T0 = ((float) (Math.log(0.78d) / Math.log(0.9d)));
    public static final cw7 U0 = new cw7(3);
    public static final int[] V0 = {16843130};
    ...
    public final gh9 Q0;
    public float R0;
    public final yg4 S0 = new yg4(getContext(), new nfc(21, (Object) this));
    ...
    public NestedScrollView(android.content.Context r7, android.util.AttributeSet r8) {
        /*
            r6 = this;
            int r0 = defpackage.slb.nestedScrollViewStyle
            r6.<init>(r7, r8, r0)
            ...
            nfc r3 = new nfc
            r4 = 21
            r3.<init>((int) r4, (java.lang.Object) r6)
            yg4 r4 = new yg4
            ...
            android.widget.EdgeEffect r5 = defpackage.kr4.a(r7, r8)
            goto L_0x0047
        L_0x0042:
        ...
        L_0x0047:
            ...
            android.widget.EdgeEffect r3 = defpackage.kr4.a(r7, r8)
            goto L_0x0055
        L_0x0050:
    ...
    public final void computeScroll() {
        ...
        L_0x0009:
            ...
            android.widget.EdgeEffect r3 = r14.x0
            android.widget.EdgeEffect r4 = r14.w0
    ...
    public final boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return this.Q0.e(i, i2, i3, i4, iArr, 0, (int[]) null);
    }
    ...
    public final void n(View view, int i, int i2, int[] iArr, int i3) {
        this.Q0.c(i, i2, i3, iArr, (int[]) null);
    }
    ...
    public final void o(int i, int i2, int[] iArr) {
        ...
        this.Q0.d(scrollY2, i - scrollY2, i2, iArr);
    }
    ...
    public final boolean onGenericMotionEvent(android.view.MotionEvent r26) {
        ...
        L_0x0083:
            ...
            int r2 = defpackage.haf.b(r5, r2, r4, r7)
        L_0x00a3:
            r7 = 0
            goto L_0x00da
        L_0x00a5:
        ...
        L_0x00da:
            ...
            int r2 = defpackage.haf.a(r5, r2, r4, r7)
        L_0x00ea:
            r3 = 1
            goto L_0x0128
        L_0x00ec:
        ...
        L_0x014f:
            ...
            hs1 r3 = r0.d
            r3.getClass()
            java.util.Map r3 = defpackage.u0f.a
            r2.addMovement(r1)
            int r3 = android.os.Build.VERSION.SDK_INT
        ...
        L_0x01b9:
            ...
            java.util.Map r5 = defpackage.u0f.a
            java.lang.Object r5 = r5.get(r2)
            v0f r5 = (defpackage.v0f) r5
        ...
        L_0x02b7:
            ...
            r4 = r23
            float r1 = defpackage.t0f.a(r2, r4)
            goto L_0x02e8
        L_0x02c4:
            r4 = r23
        ...
        L_0x02cd:
            ...
            goto L_0x02e8
        L_0x02d5:
            java.util.Map r1 = defpackage.u0f.a
            java.lang.Object r1 = r1.get(r2)
            v0f r1 = (defpackage.v0f) r1
            ...
            if (i != 1) {
                if (i == 2) {
                    ...
                    if (!(i2 == -1 || (findPointerIndex = motionEvent.findPointerIndex(i2)) == -1)) {
                        ...
                        if (Math.abs(y - this.y0) > this.G0 && (2 & getNestedScrollAxes()) == 0) {
                            this.C0 = true;
                            this.y0 = y;
                            if (this.D0 == null) {
    ...
    public final void onNestedPreScroll(View view, int i, int i2, int[] iArr) {
        this.Q0.c(i, i2, 0, iArr, (int[]) null);
    }
    ...
    public final void onRestoreInstanceState(Parcelable parcelable) {
        if (!(parcelable instanceof dh9)) {
            super.onRestoreInstanceState(parcelable);
            return;
        }
        dh9 dh9 = (dh9) parcelable;
        super.onRestoreInstanceState(dh9.getSuperState());
        this.O0 = dh9;
        requestLayout();
    }

    /* JADX WARNING: type inference failed for: r1v0, types: [android.view.View$BaseSavedState, android.os.Parcelable, dh9] */
        ...
        if (actionMasked != 0) {
            ...
            if (actionMasked == 1) {
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (pa2.p(edgeEffect2) != 0.0f) {
                        float f3 = -pa2.D(edgeEffect2, -height, x);
                        if (pa2.p(edgeEffect2) == 0.0f) {
                            edgeEffect2.onRelease();
                        }
                        f = f3;
                    } else if (pa2.p(edgeEffect) != 0.0f) {
                        float D = pa2.D(edgeEffect, height, 1.0f - x);
                        if (pa2.p(edgeEffect) == 0.0f) {
                    ...
                    int i4 = i3 - round;
                    if (!this.C0 && Math.abs(i4) > this.G0) {
                        ViewParent parent2 = getParent();
                        if (parent2 != null) {
                            parent2.requestDisallowInterceptTouchEvent(true);
                        }
                        this.C0 = true;
                        i4 = i4 > 0 ? i4 - this.G0 : i4 + this.G0;
                    }
                    if (this.C0) {
                ...
                if (this.C0 && getChildCount() > 0 && this.o.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    postInvalidateOnAnimation();
                }
                this.J0 = -1;
                this.C0 = false;
                ...
                this.y0 = (int) motionEvent2.getY(actionIndex);
                this.J0 = motionEvent2.getPointerId(actionIndex);
            } else if (actionMasked == 6) {
                p(motionEvent);
                this.y0 = (int) motionEvent2.getY(motionEvent2.findPointerIndex(this.J0));
            }
    ...
    public final void p(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.J0) {
            ...
            this.y0 = (int) motionEvent.getY(i);
    ...
    public void setOnScrollChangeListener(bh9 bh9) {
    }
    ...
    public final int t(int i, int i2, int i3, boolean z) {
        ...
        boolean c2 = this.Q0.c(0, i, i3, this.L0, this.K0);
        int[] iArr = this.L0;
        int[] iArr2 = this.K0;
        if (c2) {
            i5 = i - iArr[1];
        ...
        boolean z4 = q(i5, 0, scrollY, scrollRange) && !this.Q0.g(i7);
        int scrollY2 = getScrollY() - scrollY;
        iArr[1] = 0;
        int i8 = scrollRange;
        this.Q0.e(0, scrollY2, 0, i5 - scrollY2, this.K0, i3, iArr);
        int i9 = i4 + iArr2[1];
        int i10 = i5 - iArr[1];
        int i11 = scrollY + i10;
        EdgeEffect edgeEffect = this.x0;
        ...
        if (i11 < 0) {
            if (z3) {
                pa2.D(edgeEffect2, ((float) (-i10)) / ((float) getHeight()), ((float) i6) / ((float) getWidth()));
                if (!edgeEffect.isFinished()) {
                    edgeEffect.onRelease();
                }
            }
        } else if (i11 > i8 && z3) {
            pa2.D(edgeEffect, ((float) i10) / ((float) getHeight()), 1.0f - (((float) i6) / ((float) getWidth())));
            if (!edgeEffect2.isFinished()) {
                edgeEffect2.onRelease();
            }
        }
        ...
        if (z2 && i7 == 0 && (velocityTracker = this.D0) != null) {
            velocityTracker.clear();
        }
        if (i7 == 1) {
            a(i7);
    ...
    public final boolean u(EdgeEffect edgeEffect, int i) {
        ...
        float p = pa2.p(edgeEffect) * ((float) getHeight());
    ...
    public final boolean x(MotionEvent motionEvent) {
        ...
        EdgeEffect edgeEffect = this.w0;
        if (pa2.p(edgeEffect) != 0.0f) {
            pa2.D(edgeEffect, 0.0f, motionEvent.getX() / ((float) getWidth()));
            z = true;
        } else {
            z = false;
        }
        ...
        pa2.D(edgeEffect2, 0.0f, 1.0f - (motionEvent.getX() / ((float) getWidth())));
        return true;
    }
