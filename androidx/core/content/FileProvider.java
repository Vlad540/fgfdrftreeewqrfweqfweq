...
public class FileProvider extends ContentProvider {
    ...
    public static af5 c(int i, Context context, String str) {
        af5 af5;
        HashMap hashMap = Z;
        synchronized (hashMap) {
            try {
                af5 = (af5) hashMap.get(str);
                if (af5 == null) {
                    af5 = e(i, context, str);
                    hashMap.put(str, af5);
                }
    ...
    public static Uri d(Context context, File file, String str) {
        af5 c2 = c(0, context, str);
        try {
            String canonicalPath = file.getCanonicalPath();
            Map.Entry entry = null;
            for (Map.Entry entry2 : c2.b.entrySet()) {
                String path = ((File) entry2.getValue()).getPath();
                if (af5.a(canonicalPath, path) && (entry == null || path.length() > ((File) entry.getValue()).getPath().length())) {
                    entry = entry2;
                }
            }
            if (entry != null) {
            ...
            throw new IllegalArgumentException(rf0.h("Failed to find configured root that contains ", canonicalPath));
        } catch (IOException unused) {
            throw new IllegalArgumentException("Failed to resolve canonical path for " + file);
        }
    }

    public static af5 e(int i, Context context, String str) {
        af5 af5 = new af5(str);
        ...
        if (resolveContentProvider != null) {
                    ...
                    if (next == 2) {
                        ...
                        if (file != null) {
                            ...
                            if (!TextUtils.isEmpty(attributeValue)) {
                                try {
                                    af5.b.put(attributeValue, file.getCanonicalFile());
                                } catch (IOException e) {
            ...
            throw new IllegalArgumentException(rf0.h("Couldn't find meta-data for provider with authority ", str));
        }
    }
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) {
        ...
        if ("r".equals(str)) {
            ...
            throw new IllegalArgumentException(rf0.h("Invalid mode: ", str));
        }
