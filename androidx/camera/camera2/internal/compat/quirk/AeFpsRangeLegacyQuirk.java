...
public class AeFpsRangeLegacyQuirk implements zkb {
    public final Range a;

    public AeFpsRangeLegacyQuirk(et1 et1) {
        Range[] rangeArr = (Range[]) et1.a(CameraCharacteristics.CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES);
        Range range = null;
