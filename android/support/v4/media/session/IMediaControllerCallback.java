    ...
    public static abstract class Stub extends Binder implements IMediaControllerCallback {
        ...
        public static class Proxy implements IMediaControllerCallback {
            ...
            public void onSessionReady() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IMediaControllerCallback.DESCRIPTOR);
                    this.mRemote.transact(Stub.TRANSACTION_onSessionReady, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void onShuffleModeChanged(int i) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(IMediaControllerCallback.DESCRIPTOR);
                    obtain.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_onShuffleModeChanged, obtain, (Parcel) null, 1);
                } finally {
                    obtain.recycle();
                }
            }
