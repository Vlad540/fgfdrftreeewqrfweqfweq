...
public final class VideoInfoTextView extends AppCompatTextView {
    ...
    /* JADX WARNING: type inference failed for: r6v0, types: [android.widget.TextView, ru.ok.messages.views.widgets.VideoInfoTextView, android.view.View] */
    ...
    public VideoInfoTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        setTextColor(wce.t);
        setTextSize(0, (float) getContext().getResources().getDimensionPixelSize(yhc.c));
        float f = (float) 4;
        float f2 = (float) 2;
