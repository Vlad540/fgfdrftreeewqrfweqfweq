...
public class ConversationParams {
    ...
    public static final h67 PARSER = new no3(7);
    ...
    public static RateCallData parseRateCallData(JSONObject jSONObject) throws JSONException {
        ...
        if (optJSONArray != null) {
            ...
            for (int i = 0; i < optJSONArray.length(); i++) {
                ...
                arrayList2.add(new Question(jSONObject2.getInt(ApiProtocol.KEY_ID), jSONObject2.getString("text")));
            }
    ...
    public String toString() {
        ...
        sb.append("', locReg='");
        return wn6.l(sb, this.locReg, "'}");
    }

    /* access modifiers changed from: private */
    public static ConversationParams parseCallParams(m67 m67) throws IOException, JsonTypeMismatchException {
        return parseCallParams(gwf.D(m67));
    }
}
