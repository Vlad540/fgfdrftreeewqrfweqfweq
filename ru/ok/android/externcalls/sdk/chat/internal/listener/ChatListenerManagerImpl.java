...
public final class ChatListenerManagerImpl implements ChatListenerManager, m11 {
    ...
    public void onNewMessage(fv6 fv6) {
        Iterator<ChatManagerListener> it = this.listeners.iterator();
        while (it.hasNext()) {
            it.next().onNewMessage(InboundMessageMapper.INSTANCE.fromInternal(fv6, this.participantStore));
        }
    }
