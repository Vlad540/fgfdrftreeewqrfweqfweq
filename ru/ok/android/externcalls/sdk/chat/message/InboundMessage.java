...
public final class InboundMessage {
    ...
    public boolean equals(Object obj) {
        ...
        return hhd.f(this.senderId, inboundMessage.senderId) && hhd.f(this.text, inboundMessage.text) && this.isDirect == inboundMessage.isDirect;
    }
    ...
    public int hashCode() {
        ...
        return Boolean.hashCode(this.isDirect) + me4.d((participantId == null ? 0 : participantId.hashCode()) * 31, 31, this.text);
    }
