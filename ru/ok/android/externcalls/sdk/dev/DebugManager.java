...
public interface DebugManager {
    ...
    void registerStatListener(xrd xrd, int i, TimeUnit timeUnit);

    void removeStatListener(xrd xrd);

    void report(tqd tqd, String str);
