...
public final class RateManagerImpl implements RateManager, dg1 {
    ...
    public RateManagerImpl(xwb xwb, RttRateHintConfig rttRateHintConfig) {
        this.log = xwb;
        this.rttTrigger = new RttRateHintTrigger(xwb, rttRateHintConfig, new RateManagerImpl$rttTrigger$1(this));
    ...
    public final void addRateHint(RateHint rateHint) {
        ...
        xwb xwb = this.log;
        xwb.log(LOG_TAG, "addRateHint " + rateHint);
    }
    ...
    public final void logHints() {
        ...
        xwb.log(LOG_TAG, "rateHints = " + rateHints2 + ", shouldRateConversation=" + shouldRateConversation);
    }

    public void onRtcStats(zwb zwb) {
        this.rttTrigger.onRtcStats(zwb);
    }
}
