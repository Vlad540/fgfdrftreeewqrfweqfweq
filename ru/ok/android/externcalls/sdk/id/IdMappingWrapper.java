...
public class IdMappingWrapper {
    ...
    private final LinkedHashMap<ParticipantId, ge1> externalToInternal;
    private final LinkedHashMap<ge1, ParticipantId> internalToExternal;
    private final xwb log;
    private boolean wasRead = false;

    private IdMappingWrapper(Context context, xwb xwb) {
        this.log = xwb;
    ...
    private synchronized void ensureMappingNotOutdated(ge1 ge1) {
        ensureMappingNotOutdated(this.internalToExternal.get(ge1));
    }

    public static IdMappingWrapper get(Context context, xwb xwb) {
        if (DEFAULT == null) {
            synchronized (IdMappingWrapper.class) {
                try {
                    if (DEFAULT == null) {
                        DEFAULT = new IdMappingWrapper(context.getApplicationContext(), xwb);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    private synchronized void read() throws java.io.IOException {
        ...
        L_0x0014:
            ...
            ge1 r6 = defpackage.ge1.a(r1)     // Catch:{ NumberFormatException -> 0x0048 }
            java.util.LinkedHashMap<ru.ok.android.externcalls.sdk.id.ParticipantId, ge1> r7 = r8.externalToInternal     // Catch:{ NumberFormatException -> 0x0048 }
            r7.put(r3, r6)     // Catch:{ NumberFormatException -> 0x0048 }
            java.util.LinkedHashMap<ge1, ru.ok.android.externcalls.sdk.id.ParticipantId> r7 = r8.internalToExternal     // Catch:{ NumberFormatException -> 0x0048 }
        ...
        L_0x0046:
            ...
            goto L_0x007b
        L_0x0048:
            xwb r3 = r8.log     // Catch:{ all -> 0x0046 }
        ...
        L_0x0069:
            ...
            xwb r0 = r8.log     // Catch:{ all -> 0x0046 }
            ...
            if (file != null) {
                ...
                try {
                    for (ParticipantId next : getMappingKeysForWritingToDisk()) {
                        ge1 ge1 = this.externalToInternal.get(next);
                        if (ge1 != null) {
                            bufferedWriter.write(next.toStringValue());
                            bufferedWriter.write(9);
                            bufferedWriter.write(ge1.c());
    ...
    public synchronized void addMapping(ParticipantId participantId, ge1 ge1) {
        try {
            if (this.internalToExternal.get(ge1) == null) {
                this.changed = true;
            }
            this.internalToExternal.put(ge1, participantId);
            this.externalToInternal.put(participantId, ge1);
    ...
    public synchronized ge1 getByExternal(ParticipantId participantId) {
        if (!this.wasRead) {
            return null;
        }
    ...
    public synchronized ParticipantId getByInternal(ge1 ge1) {
        if (!this.wasRead) {
            return null;
        }
        ensureMappingNotOutdated(ge1);
        return this.internalToExternal.get(ge1);
    }
    ...
    public void scheduleReadCacheFromDisk() {
        cnc.b().b(new cp6(this, 1));
    }

    public void scheduleWriteCacheToDisk() {
        cnc.b().b(new cp6(this, 0));
    }
