...
public final class LocalParticipantId {
    ...
    public static final class Companion {
        ...
        public final LocalParticipantId nextId() {
            return new LocalParticipantId(LocalParticipantId.sequence.getAndIncrement(), (x54) null);
        }
    ...
    public /* synthetic */ LocalParticipantId(int i, x54 x54) {
        this(i);
    }
    ...
    public String toString() {
        return rf0.f(this.id, "LocalParticipantId(id=", ")");
    }
