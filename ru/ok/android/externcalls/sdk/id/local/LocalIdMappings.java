...
public final class LocalIdMappings {
    ...
    private final HashMap<ge1, LocalParticipantId> internalToLocalIdMap = new HashMap<>();
    ...
    public final void addMappings(ConversationParticipant conversationParticipant) {
        ...
        if (!(callParticipant == null || (ge1 = callParticipant.a) == null)) {
            this.internalToLocalIdMap.put(ge1, localParticipantIdExt);
    ...
    public final Set<LocalParticipantId> getAllLocalIds(ge1 ge1) {
        Set<LocalParticipantId> set = this.internalIdToLocalIdsMap.get(ge1.a);
        return set == null ? qw4.a : set;
    }

    public final LocalParticipantId getAnyLocalId(ge1 ge1) {
        Set set = this.internalIdToLocalIdsMap.get(ge1.a);
        if (set != null) {
            return (LocalParticipantId) o23.W(set);
        }
        return null;
    }

    public final LocalParticipantId getLocalId(ge1 ge1) {
        return this.internalToLocalIdMap.get(ge1);
    }
    ...
    public final void removedMappings(ConversationParticipant conversationParticipant) {
        ...
        ke1 callParticipant = conversationParticipant.getCallParticipant();
        if (!(callParticipant == null || (ge1 = callParticipant.a) == null)) {
            this.internalToLocalIdMap.remove(ge1);
            LongSparseArray<Set<LocalParticipantId>> longSparseArray = this.internalIdToLocalIdsMap;
            long j = ge1.a;
            Set set = longSparseArray.get(j);
            if (set != null) {
