...
public interface ConversationEndReason {
    ...
    public static final class Error implements ConversationEndReason {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof Error) && hhd.f(this.throwable, ((Error) obj).throwable);
        }
    ...
    public static final class ObsoleteClient implements ConversationEndReason {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof ObsoleteClient) && hhd.f(this.explanationHtml, ((ObsoleteClient) obj).explanationHtml);
        }
        ...
        public String toString() {
            return wn6.i("ObsoleteClient(explanationHtml=", this.explanationHtml, ")");
        }
    }
