...
public interface ConversationEventsListener extends RecordEventListener {
    ...
    public static class CallEndInfo {
        ...
        public final fe6 reason;

        public CallEndInfo(fe6 fe6, Set<HangupHint> set, String str) {
            this.reason = fe6;
            this.hints = set;
    ...
    void onStateChanged(ConversationParticipant conversationParticipant, ie1 ie1) {
    }
