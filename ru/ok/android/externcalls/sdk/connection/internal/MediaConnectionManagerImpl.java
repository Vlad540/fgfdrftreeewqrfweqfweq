...
public final class MediaConnectionManagerImpl implements MediaConnectionManager, sk1, bne {
    ...
    private final Runnable disconnectRunnable = new m38(this, 0);
    private final Handler handler = new Handler(Looper.getMainLooper());
    private final s16 isConversationEnded;
    ...
    private final Runnable noDataRunnable = new m38(this, 1);
    ...
    public MediaConnectionManagerImpl(xwb xwb, s16 s16, MediaConnectionSettings mediaConnectionSettings) {
        this.log = xwb;
        this.isConversationEnded = s16;
    ...
    private final void reportNewStateIfNeeded() {
        ...
        if (state2 != state) {
            ...
            xwb.log(LOG_TAG, "new state: " + state + " isIceConnected=" + z + " isDataConnected=" + z2);
    ...
    public void onMediaDataReceived(long j) {
        ...
        if (z != z2) {
            xwb xwb = this.log;
            xwb.log(LOG_TAG, "isDataConnected=" + z2 + " timeSinceBytesReceivedMs=" + j);
        }
        reportNewStateIfNeeded();
    ...
    public void onTopologyUpdated(ane ane, ane ane2) {
        xwb xwb = this.log;
        xwb.log(LOG_TAG, "topology changed: oldTopology=" + ane + " newTopology=" + ane2);
    }
