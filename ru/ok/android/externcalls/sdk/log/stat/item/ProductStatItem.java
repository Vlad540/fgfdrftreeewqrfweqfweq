...
public final class ProductStatItem implements StatItem {
    ...
    public static final class Builder implements StatItem.Builder {
        ...
        private Map<String, String> custom = iw4.a;
        ...
        public ProductStatItem build() {
            return new ProductStatItem(this.collector, this.type, this.operation, this.timestamp, this.custom, (x54) null);
        }
    }

    public /* synthetic */ ProductStatItem(String str, int i, String str2, long j, Map map, x54 x54) {
