...
public interface StereoRoomManagerListener {
    ...
    public static final class HandStatusUpdated {
        ...
        public boolean equals(Object obj) {
            ...
            return this.totalCount == handStatusUpdated.totalCount && hhd.f(this.raisedHands, handStatusUpdated.raisedHands);
        }
    ...
    public static final class ListenersUpdated {
        ...
        public boolean equals(Object obj) {
            ...
            return this.totalCount == listenersUpdated.totalCount && hhd.f(this.addedParticipantIds, listenersUpdated.addedParticipantIds) && hhd.f(this.removedParticipantIds, listenersUpdated.removedParticipantIds);
        }
        ...
        public int hashCode() {
            return this.removedParticipantIds.hashCode() + c3d.f(this.addedParticipantIds, Integer.hashCode(this.totalCount) * 31, 31);
        }
