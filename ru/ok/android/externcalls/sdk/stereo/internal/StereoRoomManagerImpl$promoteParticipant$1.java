...
public final class StereoRoomManagerImpl$promoteParticipant$1 extends b97 implements u16 {
    final /* synthetic */ u16 $onError;
    final /* synthetic */ s16 $onSuccess;
    final /* synthetic */ StereoRoomManagerImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public StereoRoomManagerImpl$promoteParticipant$1(StereoRoomManagerImpl stereoRoomManagerImpl, s16 s16, u16 u16) {
        super(1);
    ...
    public final void invoke(ge1 ge1) {
        this.this$0.commandExecutor.promoteParticipant(new StereoRoomCommandExecutor.PromoteParticipantParams(ge1, true), this.$onSuccess, this.$onError);
    }
}
