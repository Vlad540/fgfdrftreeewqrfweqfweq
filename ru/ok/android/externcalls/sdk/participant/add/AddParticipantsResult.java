...
public final class AddParticipantsResult {
    ...
    public boolean equals(Object obj) {
        ...
        return hhd.f(this.addedIds, addParticipantsResult.addedIds) && hhd.f(this.accepted, addParticipantsResult.accepted) && hhd.f(this.rejectedParticipantsIds, addParticipantsResult.rejectedParticipantsIds) && hhd.f(this.bannedParticipantIds, addParticipantsResult.bannedParticipantIds);
    }
