...
public abstract class FeatureRoles {
    ...
    public static final class Companion {
        ...
        public final EnabledForRoles createDisabledForAll() {
            return new EnabledForRoles(qw4.a);
        }
    ...
    public static final class EnabledForRoles extends FeatureRoles {
        ...
        public final Set<je1> component1() {
            return this.roles;
        }

        public final EnabledForRoles copy(Set<? extends je1> set) {
        ...
        public boolean equals(Object obj) {
            ...
            return (obj instanceof EnabledForRoles) && hhd.f(this.roles, ((EnabledForRoles) obj).roles);
        }

        public final Set<je1> getRoles() {
            return this.roles;
        }
    ...
    public /* synthetic */ FeatureRoles(x54 x54) {
        this();
    }
}
