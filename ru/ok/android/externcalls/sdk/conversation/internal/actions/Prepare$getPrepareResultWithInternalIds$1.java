...
public final class Prepare$getPrepareResultWithInternalIds$1<T1, T2, T3, R> implements l26 {
    ...
    public final Prepare.PrepareResult apply(ega ega, Set<ParticipantId> set, jue jue) {
        ...
        return new Prepare.PrepareResult(conversationParams, o23.w0(o23.T(set)));
    }
}
