...
public final class Prepare implements Action<PrepareParams, PrepareResult> {
    ...
    public interface PrepareParams extends ActionParams {
        ...
        public static final class C0000Prepare implements PrepareParams {
            public static final C0000Prepare INSTANCE = new C0000Prepare();

            private C0000Prepare() {
            }
        }
        ...
        public static final class PrepareJoin implements PrepareParams {
            ...
            public boolean equals(Object obj) {
                ...
                return hhd.f(this.initialJoinLink, prepareJoin.initialJoinLink) && hhd.f(this.anonToken, prepareJoin.anonToken);
            }
            ...
            public String toString() {
                return c3d.i("PrepareJoin(initialJoinLink=", this.initialJoinLink, ", anonToken=", this.anonToken, ")");
            }
        }
    }
    ...
    public static final class PrepareResult implements ActionResult {
        ...
        public boolean equals(Object obj) {
            ...
            return hhd.f(this.conversationParams, prepareResult.conversationParams) && hhd.f(this.unresolvedParticipantIds, prepareResult.unresolvedParticipantIds);
        }
    ...
    public Prepare(OkApiService okApiService2, ct3 ct3, ConversationParams conversationParams, InternalIdsResolver internalIdsResolver2, ExternalIdsResolver externalIdsResolver2, StartCallApiParams startCallApiParams2, PeerIdGenerator peerIdGenerator2, ConversationPreparedStat conversationPreparedStat, boolean z, boolean z2, xwb xwb, fe1 fe1) {
    ...
    private final dhd executeSimple() {
        return prepareImpl(false, new Prepare$executeSimple$1(this));
    }

    private final dhd executeWithJoinLink(String str, String str2) {
        return prepareImpl(true, new Prepare$executeWithJoinLink$1(this, str, str2));
    }

    private final dhd getPrepareResult(boolean z, s16 s16) {
        return (!this.callParams.B.j || (!this.isCaller && !z)) ? getPrepareResultWithInternalIds(s16) : getPrepareResultWithoutInternalIds(s16);
    }

    private final dhd getPrepareResultWithInternalIds(s16 s16) {
        dhd dhd = (dhd) s16.invoke();
        dhd retryForApiCall = retryForApiCall(this.internalIdsResolver.resolveIdsAndGetFailed());
        ExternalIdsResolver externalIdsResolver2 = this.externalIdsResolver;
        v63 resolveIds = externalIdsResolver2.resolveIds(externalIdsResolver2.collectExternalIdResolutionCandidates());
        jue jue = jue.a;
        resolveIds.getClass();
        dhd retryForApiCall2 = retryForApiCall(new o73(resolveIds, 0, jue));
        ...
        Objects.requireNonNull(dhd, "source1 is null");
        ...
        return new o73(new dhd[]{dhd, retryForApiCall, retryForApiCall2}, 6, new mb1(12, prepare$getPrepareResultWithInternalIds$1));
    }

    private final dhd getPrepareResultWithoutInternalIds(s16 s16) {
        return ((dhd) s16.invoke()).h(Prepare$getPrepareResultWithoutInternalIds$1.INSTANCE);
    }

    private final dhd prepareImpl(boolean z, s16 s16) {
        return new o73(getPrepareResult(z, s16).i(de.a()), 5, new Prepare$prepareImpl$1(this));
    }

    /* access modifiers changed from: private */
    public final <T> dhd retryForApiCall(dhd dhd) {
        return this.isAnswer ? RetryKt.retryApiCallForIncoming(dhd, this.callParams.B.h, this.log) : RetryKt.retryApiCallForOutgoing(dhd, this.callParams.B.h, this.log);
    }

    public dhd execute(PrepareParams prepareParams) {
        if (prepareParams instanceof PrepareParams.C0000Prepare) {
