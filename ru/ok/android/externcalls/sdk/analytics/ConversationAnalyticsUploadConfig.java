...
public final class ConversationAnalyticsUploadConfig {
    ...
    public int hashCode() {
        int d = c3d.d(this.maxLocalFileCount, c3d.d(this.maxEventCount, Integer.hashCode(this.maxLocalFileSizeKb) * 31, 31), 31);
        Long l = this.timeToUploadNextFileMs;
        return Boolean.hashCode(this.disableUploadWhenCallIsActiveProvider) + th2.f((d + (l == null ? 0 : l.hashCode())) * 31, 31, this.compressContent);
    }
    ...
    public String toString() {
        ...
        StringBuilder i4 = rf0.i("ConversationAnalyticsUploadConfig(maxLocalFileSizeKb=", i, ", maxEventCount=", i2, ", maxLocalFileCount=");
        i4.append(i3);
        i4.append(", timeToUploadNextFileMs=");
        i4.append(l);
        i4.append(", compressContent=");
        i4.append(z);
        i4.append(", disableUploadWhenCallIsActiveProvider=");
        i4.append(z2);
        i4.append(")");
        return i4.toString();
    }
    ...
    public /* synthetic */ ConversationAnalyticsUploadConfig(int i, int i2, int i3, Long l, boolean z, boolean z2, int i4, x54 x54) {
