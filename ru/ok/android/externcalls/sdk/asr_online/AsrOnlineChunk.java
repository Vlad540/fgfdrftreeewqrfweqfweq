...
public final class AsrOnlineChunk {
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001f\u0010\u000b\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0000¢\u0006\u0004\b\t\u0010\n¨\u0006\f"}, d2 = {"Lru/ok/android/externcalls/sdk/asr_online/AsrOnlineChunk$Companion;", "", "<init>", "()V", "Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;", "store", "Lvs;", "asrRecvDataPackage", "Lru/ok/android/externcalls/sdk/asr_online/AsrOnlineChunk;", "chunkFromPackage$calls_sdk_release", "(Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Lvs;)Lru/ok/android/externcalls/sdk/asr_online/AsrOnlineChunk;", "chunkFromPackage", "calls-sdk_release"}, k = 1, mv = {1, 9, 0})
    public static final class Companion {
        private Companion() {
        }

        public final AsrOnlineChunk chunkFromPackage$calls_sdk_release(ParticipantStore participantStore, vs vsVar) {
            ParticipantId participantId = null;
            ge1 ge1 = vsVar.a;
            ConversationParticipant byInternal = ge1 != null ? participantStore.getByInternal(ge1) : null;
            if (byInternal != null) {
                participantId = byInternal.getExternalId();
            }
            return new AsrOnlineChunk(participantId, vsVar.b);
        }
    ...
    public boolean equals(Object obj) {
        ...
        return hhd.f(this.participantId, asrOnlineChunk.participantId) && hhd.f(this.text, asrOnlineChunk.text);
    }
