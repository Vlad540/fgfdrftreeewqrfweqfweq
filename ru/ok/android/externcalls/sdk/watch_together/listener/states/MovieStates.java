...
public final class MovieStates {
    ...
    public final Map<w69, MovieState> component1() {
        return this.states;
    }

    public final MovieStates copy(Map<w69, MovieState> map) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof MovieStates) && hhd.f(this.states, ((MovieStates) obj).states);
    }

    public final Map<w69, MovieState> getStates() {
        return this.states;
    }
    ...
    public String toString() {
        Map<w69, MovieState> map = this.states;
