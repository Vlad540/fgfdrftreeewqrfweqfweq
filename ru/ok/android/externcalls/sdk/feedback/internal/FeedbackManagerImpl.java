...
public final class FeedbackManagerImpl implements FeedbackManager, FeedbackCommandsExecutor, FeedbackListenerManager {
    ...
    public void sendFeedback(String str, u16 u16, s16 s16) {
        this.commandExecutor.sendFeedback(str, u16, s16);
    }
    ...
    public void sendFeedback(String str, ParticipantFeedbackSource participantFeedbackSource, u16 u16, s16 s16) {
        this.commandExecutor.sendFeedback(str, u16, s16);
        this.listenerManager.ownFeedbackSent(str, participantFeedbackSource);
    }
}
