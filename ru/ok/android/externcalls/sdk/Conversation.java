...
public interface Conversation {
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\bf\u0018\u00002\u00020\u0001J\u001d\u0010\u0006\u001a\u00020\u00052\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002H'¢\u0006\u0004\b\u0006\u0010\u0007ø\u0001\u0000\u0002\u0006\n\u0004\b!0\u0001¨\u0006\bÀ\u0006\u0001"}, d2 = {"Lru/ok/android/externcalls/sdk/Conversation$ChatHistoryCallback;", "", "", "Lofd;", "data", "Ljue;", "onResponse", "([Lofd;)V", "calls-sdk_release"}, k = 1, mv = {1, 9, 0})
    public interface ChatHistoryCallback {
        void onResponse(ofd[] ofdArr);
    }
    ...
    static /* synthetic */ void addParticipant$default(Conversation conversation, ParticipantId participantId, Boolean bool, boolean z, pf3 pf3, int i, Object obj) {
        if (obj == null) {
            if ((i & 4) != 0) {
                z = false;
            }
            ...
            conversation.addParticipant(participantId, bool, z, pf3);
            return;
        }
    ...
    static /* synthetic */ void addParticipants$default(Conversation conversation, Collection collection, Boolean bool, boolean z, u16 u16, u16 u162, int i, Object obj) {
        if (obj == null) {
            if ((i & 4) != 0) {
                z = false;
            }
            boolean z2 = z;
            if ((i & 8) != 0) {
                u16 = Conversation$addParticipants$1.INSTANCE;
            }
            u16 u163 = u16;
            if ((i & 16) != 0) {
                u162 = null;
            }
            conversation.addParticipants(collection, bool, z2, u163, u162);
            return;
        }
    ...
    static /* synthetic */ void setAnonJoinForbidden$default(Conversation conversation, boolean z, pf3 pf3, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                pf3 = null;
            }
            conversation.setAnonJoinForbidden(z, pf3);
            return;
        }
    ...
    static /* synthetic */ void setFeedbackEnabled$default(Conversation conversation, boolean z, pf3 pf3, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                pf3 = null;
            }
            conversation.setFeedbackEnabled(z, pf3);
            return;
        }
    ...
    static /* synthetic */ void setWaitingRoomEnabled$default(Conversation conversation, boolean z, pf3 pf3, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                pf3 = null;
            }
            conversation.setWaitingRoomEnabled(z, pf3);
            return;
        }
    ...
    void addParticipant(String str, boolean z, pf3 pf3);

    void addParticipant(ParticipantId participantId, Boolean bool, boolean z, pf3 pf3);

    void addParticipantByLink(String str, Runnable runnable, pf3 pf3);

    void addParticipants(Collection<ParticipantId> collection, Boolean bool, boolean z, u16 u16, u16 u162);

    void changeMyState(Map<String, String> map);

    void changeMyState(Map<String, String> map, lfd lfd);

    void connect();

    void createJoinLink(pf3 pf3, pf3 pf32);
    ...
    j50 getAudioLevel(ConversationParticipant conversationParticipant);
    ...
    qf8 getParticipantMediaStat(ConversationParticipant conversationParticipant);
    ...
    void grantRoles(ParticipantId participantId, boolean z, je1... je1Arr);
    ...
    void removeJoinLink(Runnable runnable, pf3 pf3);
    ...
    void setAnonJoinForbidden(boolean z, pf3 pf3);

    void setAudioCaptureEnabled(boolean z);

    void setCallOptionEnabled(fx0 fx0, boolean z, pf3 pf3);

    void setFeedbackEnabled(boolean z);

    void setFeedbackEnabled(boolean z, pf3 pf3);

    void setMuteState(ParticipantId participantId, boolean z);

    void setWaitingRoomEnabled(boolean z);

    void setWaitingRoomEnabled(boolean z, pf3 pf3);
}
