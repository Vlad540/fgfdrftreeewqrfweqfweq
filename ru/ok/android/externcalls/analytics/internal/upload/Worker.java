...
public final class Worker {
    ...
    public Worker(Provider<Looper> provider, Provider<File> provider2, Lock lock, String str, boolean z) {
        ...
        this.handler = new Handler((Looper) provider.get(), new Callback(this, 0));
    ...
    public void handleUploadSilenceTimeout() {
        this.logger.d(LOG_TAG, us8.j(CallAnalyticsConfigStorage.INSTANCE.getUpload().getSilenceToUploadMillis(), "trigger | time since last log item exceeded ", "ms"));
        startUpload();
    }
