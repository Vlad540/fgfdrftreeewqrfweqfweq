...
public class UploadService extends jjc {
    ...
    public static void startUpload(String str) {
        ...
        r37.enqueueWork(w, cls, CallAnalyticsConfigStorage.INSTANCE.getUpload().getUploadJobId(), new Intent().setAction(ACTION_UPLOAD).setData(Uri.fromParts(SCHEME, str, (String) null)).setClass(w, cls));
    }
