...
public abstract class AbstractUploader implements Uploader {
    ...
    /* access modifiers changed from: private */
    public static final String sdkVersionString = "125.1.0.48.1";
    ...
    public static final class Companion {
        ...
        public final String getApplicationVersionParams() {
            ...
            if (num != null) {
                ...
                PackageInfo packageInfo2 = ek8.w().getPackageManager().getPackageInfo(ek8.w().getPackageName(), 0);
    ...
    private final void executeApiMethod(uk ukVar, String str, oq0 oq0) throws IOException, ApiException {
        Companion companion = Companion;
        try {
            ukVar.a(new CallAnalyticsApiRequest(str, companion.getPlatformParam(), companion.getApplicationVersionParams(), SDK_TYPE_STRING, sdkVersionString, 1, oq0, CallAnalyticsConfigStorage.INSTANCE.getLogger()));
    ...
    public final File ensureStorageIsOfCorrectType(boolean z) {
        File file = (File) this.storage.get();
    ...
    public final <T> T withLock(s16 s16) {
        try {
            this.lock.lock();
            return s16.invoke();
        } finally {
