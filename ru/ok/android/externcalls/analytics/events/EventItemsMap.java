...
public final class EventItemsMap {
    ...
    public final EventItemsMap set(String str, String str2) {
        if (str2 != null) {
            this.items.put(str, EventItemValue.StringValue.m54boximpl(EventItemValue.StringValue.m55constructorimpl(str2)));
        }
        return this;
    }
    ...
    public final EventItemsMap set(String str, Integer num) {
        if (num != null) {
            this.items.put(str, EventItemValue.IntValue.m40boximpl(EventItemValue.IntValue.m41constructorimpl(num.intValue())));
        }
        return this;
    }
    ...
    public final EventItemsMap set(String str, Long l) {
        if (l != null) {
            this.items.put(str, EventItemValue.LongValue.m47boximpl(EventItemValue.LongValue.m48constructorimpl(l.longValue())));
        }
        return this;
    }
    ...
    public final EventItemsMap set(String str, Float f) {
        if (f != null) {
            this.items.put(str, EventItemValue.FloatValue.m33boximpl(EventItemValue.FloatValue.m34constructorimpl(f.floatValue())));
        }
        return this;
    }
}
