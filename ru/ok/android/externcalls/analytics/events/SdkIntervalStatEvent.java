...
public final class SdkIntervalStatEvent extends CallAnalyticsEvent {
    ...
    public static final class Builder {
        ...
        public final SdkIntervalStatEvent build() {
            return new SdkIntervalStatEvent(ju7.W(this.map.getItems()));
        }
    ...
    public String toString() {
        return me4.j("SdkIntervalStatEvent apiMethod=", getApiMethodName(), " ", o23.c0(getItems().entrySet(), ", ", (String) null, (String) null, SdkIntervalStatEvent$toString$1.INSTANCE, 30));
    }
}
