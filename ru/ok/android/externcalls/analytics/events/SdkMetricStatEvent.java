...
public final class SdkMetricStatEvent extends CallAnalyticsEvent {
    ...
    public static final class Builder {
        ...
        public final SdkMetricStatEvent build() {
            return new SdkMetricStatEvent(ju7.W(this.map.getItems()));
        }
    ...
    public String toString() {
        return me4.j("SdkMetricStatEvent apiMethod=", getApiMethodName(), " ", o23.c0(getItems().entrySet(), ", ", (String) null, (String) null, SdkMetricStatEvent$toString$1.INSTANCE, 30));
    }
}
