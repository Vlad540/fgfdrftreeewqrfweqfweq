...
public class XiaomiHomeBadger implements Badger {
    ...
    private void tryNewMiuiBadge(Context context, int i) throws ShortcutBadgeException {
        ...
        if (this.resolveInfo != null) {
            ...
            Notification build = new Notification.Builder(context).setContentTitle(BuildConfig.FLAVOR).setContentText(BuildConfig.FLAVOR).setSmallIcon(this.resolveInfo.getIconResource()).build();
            try {
    ...
    public void executeBadge(android.content.Context r5, android.content.ComponentName r6, int r7) throws me.leolin.shortcutbadger.ShortcutBadgeException {
        ...
        L_0x0061:
            ...
            r1.putExtra(r0, r6)
            me.leolin.shortcutbadger.util.BroadcastHelper.sendIntentExplicitly(r5, r1)     // Catch:{ ShortcutBadgeException -> 0x006d }
        L_0x006d:
